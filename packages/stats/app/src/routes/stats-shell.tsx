import opennovelWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/MarsQiu007/openNovel",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "opennovel:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://opennovel.ai/">
            <strong>{i18n.t("header.tryOpenNovel")}</strong>
          </a>
          <button
...
function OpenNovelMark() {
  return (
    <svg data-slot="opennovel-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://opennovel.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://opennovel.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@opennovel.ai", label: i18n.t("footer.contact") },
    { href: "https://opennovel.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/opennovel", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://opennovel.ai" aria-label={i18n.t("footer.homeAria")}>
          <OpenNovelMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={opennovelWordmarkDark} alt="OpenNovel" />
          <button
