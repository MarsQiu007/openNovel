export const dict = {
  "app.title": "Rankingi użycia modeli AI | OpenNovel Data",
  "app.description":
    "Przeglądaj użycie OpenNovel Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny OpenNovel Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę OpenNovel na GitHub",
  "header.github": "GitHub",
  "header.tryOpenNovel": "Wypróbuj OpenNovel",
  ...
  "footer.homeAria": "Strona główna OpenNovel",
  ...
  "home.topModelsDescription": "Użycie modeli w OpenNovel Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy OpenNovel Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | OpenNovel Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w OpenNovel Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia OpenNovel.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w OpenNovel",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia OpenNovel",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów OpenNovel z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | OpenNovel Data",
  "model.description":
    "Zobacz dane użycia {{model}} w OpenNovel Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie OpenNovel Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu OpenNovel Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu OpenNovel Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia OpenNovel Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny OpenNovel Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia OpenNovel Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów OpenNovel Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy OpenNovel Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji OpenNovel Go.",
  ...
  "model.geoDescription": "Tokeny modelu OpenNovel Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne OpenNovel Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów OpenNovel Go.",
