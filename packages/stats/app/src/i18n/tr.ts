export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | OpenNovel Data",
  "app.description":
    "OpenNovel Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde OpenNovel Data logosu",
  ...
  "header.githubAria": "GitHub'da OpenNovel'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOpenNovel": "OpenNovel'u dene",
  ...
  "footer.homeAria": "OpenNovel ana sayfası",
  ...
  "home.topModelsDescription": "OpenNovel Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz OpenNovel Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | OpenNovel Data",
  "lab.description":
    "OpenNovel Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son OpenNovel kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "OpenNovel'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son OpenNovel kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük OpenNovel token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | OpenNovel Data",
  "model.description":
    "{{model}} için OpenNovel Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda OpenNovel Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki OpenNovel Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki OpenNovel Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde OpenNovel Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son OpenNovel Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz OpenNovel Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük OpenNovel Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz OpenNovel Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama OpenNovel Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan OpenNovel Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen OpenNovel Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son OpenNovel Go token hacmine göre yakındaki modeller.",
