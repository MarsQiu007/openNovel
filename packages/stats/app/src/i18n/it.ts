export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | OpenNovel Data",
  "app.description":
    "Esplora l'utilizzo di OpenNovel Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo OpenNovel Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a OpenNovel su GitHub",
  "header.github": "GitHub",
  "header.tryOpenNovel": "Prova OpenNovel",
  ...
  "footer.homeAria": "Home OpenNovel",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in OpenNovel Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di OpenNovel Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | OpenNovel Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in OpenNovel Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di OpenNovel.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in OpenNovel",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di OpenNovel",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token OpenNovel negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | OpenNovel Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in OpenNovel Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di OpenNovel Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo OpenNovel Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo OpenNovel Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di OpenNovel Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di OpenNovel Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di OpenNovel Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token OpenNovel Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di OpenNovel Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione OpenNovel Go.",
  ...
  "model.geoDescription": "Token del modello OpenNovel Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica OpenNovel Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token OpenNovel Go.",
