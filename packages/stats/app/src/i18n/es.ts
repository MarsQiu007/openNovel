export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | OpenNovel Data",
  "app.description":
    "Explora el uso de OpenNovel Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de OpenNovel Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a OpenNovel en GitHub",
  "header.github": "GitHub",
  "header.tryOpenNovel": "Probar OpenNovel",
  ...
  "footer.homeAria": "Inicio de OpenNovel",
  ...
  "modal.title": "Boletín de OpenNovel",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en OpenNovel Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de OpenNovel Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | OpenNovel Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en OpenNovel Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de OpenNovel.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en OpenNovel",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de OpenNovel",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de OpenNovel durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | OpenNovel Data",
  "model.description":
    "Consulta datos de uso de {{model}} en OpenNovel Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de OpenNovel Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de OpenNovel Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de OpenNovel Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de OpenNovel Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de OpenNovel Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de OpenNovel Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de OpenNovel Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de OpenNovel Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de OpenNovel Go.",
  ...
  "model.geoDescription": "Tokens del modelo de OpenNovel Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de OpenNovel Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de OpenNovel Go.",
