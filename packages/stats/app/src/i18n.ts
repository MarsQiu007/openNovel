...
const en = {
  "app.title": "AI Model Usage Rankings | OpenNovel Data",
  "app.description":
    "Explore OpenNovel Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "OpenNovel Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star OpenNovel on GitHub",
  "header.github": "GitHub",
  "header.tryOpenNovel": "Try OpenNovel",
  ...
  "footer.homeAria": "OpenNovel home",
  ...
  "home.topModelsDescription": "Usage of models across OpenNovel Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique OpenNovel Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | OpenNovel Data",
  "lab.description":
    "Compare {{lab}} models used in OpenNovel Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent OpenNovel usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in OpenNovel",
  ...
  "lab.shareOfUsage": "{{share}} of recent OpenNovel usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | OpenNovel Data",
  "model.description":
    "View {{model}} OpenNovel Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. OpenNovel Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's OpenNovel Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's OpenNovel Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No OpenNovel Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no OpenNovel Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "OpenNovel Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No OpenNovel Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent OpenNovel Go token volume.",
