...
import { AccountStateTable, AccountTable } from "@opennovel-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/AccountRepo") {}
