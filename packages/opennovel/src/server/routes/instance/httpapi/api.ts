...
import { makeApi } from "@opennovel-ai/protocol/api"
import { LocationMiddleware } from "@opennovel-ai/server/location"
import { SessionLocationMiddleware } from "@opennovel-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("opennovel-root")
...
export const InstanceHttpApi = HttpApi.make("opennovel-instance")
...
export const OpenNovelHttpApi = HttpApi.make("opennovel")
