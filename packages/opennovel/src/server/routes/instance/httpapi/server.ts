...
import * as Observability from "@opennovel-ai/core/observability"
...
import { SettingOrganizationLayer } from "@/setting-organization"
...
import { ProjectCopy } from "@opennovel-ai/core/project/copy"
...
import * as SessionExecutionLocal from "@opennovel-ai/core/session/execution/local"
import { lazy } from "@/util/lazy"
import { CorsConfig, isAllowedCorsOrigin, type CorsOptions } from "@opennovel-ai/server/cors"
import { serveUIEffect } from "@/server/shared/ui"
import { ServerAuth } from "@/server/auth"
import { InstanceHttpApi, RootHttpApi } from "./api"
import { Api } from "@opennovel-ai/server/api"
...
import { handlers } from "@opennovel-ai/server/handlers"
import { buildLocationServiceMap, LocationServiceMap } from "@opennovel-ai/core/location-services"
import { layer as locationLayer } from "@opennovel-ai/server/location"
import { sessionLocationLayer } from "@opennovel-ai/server/middleware/session-location"
import { PtyEnvironment } from "@opennovel-ai/server/pty-environment"
import { schemaErrorLayer as v2SchemaErrorLayer } from "@opennovel-ai/server/middleware/schema-error"
import { workspaceHandlers } from "./handlers/workspace"
import { instanceContextLayer } from "./middleware/instance-context"
import { novelReaderRoute } from "./novel-reader"
import { workspaceRoutingLayer } from "./middleware/workspace-routing"
import { disposeMiddleware } from "./lifecycle"
import { memoMap } from "@opennovel-ai/core/effect/memo-map"
...
const serverRoutes = HttpApiBuilder.layer(Api).pipe(
  ...
  Layer.provide(SettingOrganizationLayer),
...
export function createRoutes(
  ...
  return Layer.mergeAll(
    ...
    serverRoutes,
    docRoute,
    novelReaderRoute.pipe(Layer.provide(authOnlyRouterLayer)),
    uiRoute,
  ).pipe(
    Layer.provide([
      errorLayer,
