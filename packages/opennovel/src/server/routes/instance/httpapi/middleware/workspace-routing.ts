...
>()("@opennovel/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@opennovel/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENNOVEL_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENNOVEL_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-opennovel-directory"] || process.cwd()
}
