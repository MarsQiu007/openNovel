...
import { OpenNovelHttpApi } from "./api"
...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for opennovel serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(OpenNovelHttpApi)
...
export const PublicApi = OpenNovelHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "opennovel",
    version: "1.0.0",
    description: "opennovel api",
