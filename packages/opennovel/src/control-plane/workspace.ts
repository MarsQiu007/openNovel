...
import { EventSequenceTable, EventTable } from "@opennovel-ai/core/event/sql"
...
import { WorkspaceEvent } from "@opennovel-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENNOVEL_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENNOVEL_WORKSPACE_ID: config.id,
        OPENNOVEL_EXPERIMENTAL_WORKSPACES: "true",
