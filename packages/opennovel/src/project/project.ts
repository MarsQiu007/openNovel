...
import { ProjectDirectoryTable, ProjectTable } from "@opennovel-ai/core/project/sql"
import { ProjectDirectories } from "@opennovel-ai/core/project/directories"
...
import { which } from "@opennovel-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OPENNOVEL_FAKE_VCS)
