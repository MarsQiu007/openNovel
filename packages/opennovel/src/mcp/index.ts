...
import { McpEvent } from "@opennovel-ai/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/opennovel/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/opennovel/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/opennovel/issues/2308
    roots: {},
    // https://github.com/anomalyco/opennovel/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "opennovel", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: opennovel mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
