 ...
 *   "@opennovel/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENNOVEL_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENNOVEL_SERVER_USERNAME").pipe(Config.withDefault("opennovel")),
 *   },
 * ) {}
 *
