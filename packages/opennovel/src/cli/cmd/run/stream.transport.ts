...
import type { Event, GlobalEvent, OpenNovelClient } from "@opennovel-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@opennovel/RunStreamTransport") {}
