...
import { normalizePromptContent } from "@opennovel-ai/tui/editor"
...
import { OPENNOVEL_BASE_MODE, useBindings } from "@opennovel-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close OpenNovel" } satisfies SlashOption,
    ]
