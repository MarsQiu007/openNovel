...
//
// The saved variant persists across sessions in ~/.local/state/opennovel/model.json
...
class Service extends Context.Service<Service, VariantService>()("@opennovel/RunVariant") {}
