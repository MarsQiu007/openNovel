...
import { openEditor } from "@opennovel-ai/tui/editor"
import { registerOpenNovelKeymap } from "@opennovel-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOpenNovelKeymap(keymap, renderer, input.tuiConfig)
