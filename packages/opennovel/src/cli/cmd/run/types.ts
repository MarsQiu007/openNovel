// Shared type vocabulary for the direct interactive mode (`opennovel --mini`).
//
...
import type { OpenNovelClient, PermissionRequest, QuestionRequest, ToolPart } from "@opennovel-ai/sdk/v2"
import type { TuiConfig } from "@opennovel-ai/tui/config"
...
type PromptModel = Parameters<OpenNovelClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<OpenNovelClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<OpenNovelClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<OpenNovelClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<OpenNovelClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<OpenNovelClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<OpenNovelClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<OpenNovelClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<OpenNovelClient["question"]["reject"]>[0]
