...
export const ModelsCommand = effectCmd({
  ...
  handler: Effect.fn("Cli.models")(function* (args) {
    ...
    const ids = Object.keys(providers).sort((a, b) => {
      const aIsOpenNovel = a.startsWith("opennovel") || a.startsWith("opencode")
      const bIsOpenNovel = b.startsWith("opennovel") || b.startsWith("opencode")
      if (aIsOpenNovel && !bIsOpenNovel) return -1
      if (!aIsOpenNovel && bIsOpenNovel) return 1
