...
import type { AssistantMessage as OpenNovelAssistantMessage, Message } from "@opennovel-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@opennovel-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<OpenNovelAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OpenNovelAssistantMessage, "role"> &
  Partial<Pick<OpenNovelAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@opennovel/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@opennovel/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@opennovel/ACPUsage") {}
