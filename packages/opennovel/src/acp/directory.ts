...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@opennovel/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@opennovel/ACPDirectory") {}
