...
import { Slug } from "@opennovel-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@opennovel-ai/llm"
...
import { locationServiceMapLayer } from "@opennovel-ai/core/location-services"
...
import { PartTable, SessionTable } from "@opennovel-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@opennovel-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".opennovel", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/Session") {}
