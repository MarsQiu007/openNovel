import type { JsonSchema, LLMRequest, ProviderMetadata } from "@opennovel-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@opennovel-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @opennovel-ai/llm request objects from opennovel's session/AI SDK-shaped data.
  return LLM.request({
