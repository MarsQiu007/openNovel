import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@opennovel-ai/llm"
...
// Move this extraction into @opennovel-ai/llm when Copilot is handled by the native runtime.
