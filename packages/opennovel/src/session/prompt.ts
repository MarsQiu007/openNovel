...
import { MAX_STEPS_PROMPT } from "@opennovel-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@opennovel-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/SessionPrompt") {}
