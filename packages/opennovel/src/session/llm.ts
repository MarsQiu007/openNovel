...
import { llmClient } from "@opennovel-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@opennovel-ai/llm"
import { LLMClient } from "@opennovel-ai/llm/route"
import type { LLMClientService } from "@opennovel-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via opennovel's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @opennovel-ai/llm. It
