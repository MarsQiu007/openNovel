...
import { buildPrompt } from "@opennovel-ai/core/session/compaction"
import { SessionCompactionEvent } from "@opennovel-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/SessionCompaction") {}
