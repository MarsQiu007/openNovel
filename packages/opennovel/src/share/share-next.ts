...
import type * as SDK from "@opennovel-ai/sdk/v2"
...
import { SessionShareTable } from "@opennovel-ai/core/share/sql"
...
const disabled = process.env["OPENNOVEL_DISABLE_SHARE"] === "true" || process.env["OPENNOVEL_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/ShareNext") {}
