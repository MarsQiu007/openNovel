...
export class Service extends Context.Service<Service, Interface>()("@opennovel/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OPENNOVEL_PHOTON_WASM_PATH?: string }).__OPENNOVEL_PHOTON_WASM_PATH =
