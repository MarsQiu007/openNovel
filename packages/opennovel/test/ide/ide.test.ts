...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENNOVEL_CALLER", () => {
    process.env["OPENNOVEL_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENNOVEL_CALLER", () => {
    process.env["OPENNOVEL_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENNOVEL_CALLER", () => {
    process.env["OPENNOVEL_CALLER"] = "unknown"
