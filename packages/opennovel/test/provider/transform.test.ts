      ...
      { role: "assistant", content: text("assistant string") },
      {
        ...
        content: [
          ...
          { type: "reasoning", text: text("assistant reasoning") },
          {
            ...
            toolCallId: "call-1",
            toolName: "Read",
            input: { filePath: ".opennovel/tool/emoji.ts" },
          },
          {
            type: "tool-result",
            toolCallId: "call-2",
...
describe("ProviderTransform.message - strip openai metadata when store=false", () => {
  ...
  test("preserves metadata using providerID key when store is false", () => {
    const opennovelModel = {
      ...openaiModel,
      providerID: "opennovel",
      api: {
        id: "opennovel-test",
        url: "https://api.opennovel.ai",
        npm: "@ai-sdk/openai-compatible",
      },
    }
    const msgs = [
    ...
    const result = ProviderTransform.message(msgs, opennovelModel, { store: false }) as any[]

    expect(result[0].content[0].providerOptions?.opennovel?.itemId).toBe("msg_123")
    expect(result[0].content[0].providerOptions?.opennovel?.otherOption).toBe("value")
  })
  ...
  test("preserves itemId across all providerOptions keys", () => {
    ...
    const msgs = [
      {
        ...
        providerOptions: {
          ...
          opennovel: { itemId: "msg_opennovel" },
        ...
        content: [
          {
            ...
            providerOptions: {
              ...
              opennovel: { itemId: "msg_opennovel_part" },
    ...
    expect(result[0].providerOptions?.opennovel?.itemId).toBe("msg_opennovel")
    expect(result[0].providerOptions?.extra?.itemId).toBe("msg_extra")
    expect(result[0].content[0].providerOptions?.openai?.itemId).toBe("msg_openai_part")
    expect(result[0].content[0].providerOptions?.opennovel?.itemId).toBe("msg_opennovel_part")
