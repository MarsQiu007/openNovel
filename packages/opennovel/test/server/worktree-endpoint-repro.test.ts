...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      OPENNOVEL_EXPERIMENTAL_WORKSPACES: Flag.OPENNOVEL_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.OPENNOVEL_EXPERIMENTAL_WORKSPACES = original.OPENNOVEL_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
