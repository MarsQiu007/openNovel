...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips opennovel-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-opennovel-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-opennovel-directory")).toBeNull()
      expect(result.get("x-opennovel-workspace")).toBeNull()
