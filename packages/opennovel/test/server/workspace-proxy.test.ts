...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips opennovel-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-opennovel-directory"]).toBeUndefined()
      expect(forwarded["x-opennovel-workspace"]).toBeUndefined()
