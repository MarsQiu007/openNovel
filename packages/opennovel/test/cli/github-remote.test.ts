...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opennovel.git")).toEqual({ owner: "sst", repo: "opennovel" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opennovel")).toEqual({ owner: "sst", repo: "opennovel" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opennovel.git")).toEqual({ owner: "sst", repo: "opennovel" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opennovel")).toEqual({ owner: "sst", repo: "opennovel" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opennovel.git")).toEqual({ owner: "sst", repo: "opennovel" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opennovel")).toEqual({ owner: "sst", repo: "opennovel" })
})
