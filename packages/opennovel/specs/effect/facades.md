...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/opennovel`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy opennovel service removed
