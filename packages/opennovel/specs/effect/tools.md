...
Practical reference for the current tool-migration state in `packages/opennovel`.
...
Tool tests should use the existing Effect helpers in `packages/opennovel/test/lib/effect.ts`:
