import { ServerConnection, useServer, useSettings, useTabs } from "@opennovel-ai/app"
...
export function DesktopFirstLaunchOnboarding(props: { initialUrl: string; onLoaded: () => void }) {
  ...
  async function runFirstLaunchOnboarding() {
    try {
      ...
      // Land on the home bookshelf; only register the project so it shows up there.
      console.info("[desktop-onboarding] opening first launch project", { directory })
