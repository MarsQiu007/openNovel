export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenNovel",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من OpenNovel، هل ترغب في تثبيته وإعادة تشغيله؟",
