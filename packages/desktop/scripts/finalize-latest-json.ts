...
const releaseId = process.env.OPENNOVEL_RELEASE
if (!releaseId) throw new Error("OPENNOVEL_RELEASE is required")

const version = process.env.OPENNOVEL_VERSION
if (!version) throw new Error("OPENNOVEL_VERSION is required")
...
const macxTarGz = "opennovel-desktop-mac-x64.app.tar.gz"
const macaTarGz = "opennovel-desktop-mac-arm64.app.tar.gz"
