...
const entries: readonly ManualEditDirectoryEntry[] = [
  ...
  { endpoint: "novel.create-execution-round", entity: "execution_round", fields: ["content"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
  { endpoint: "novel.create-setting-annotation", entity: "setting_annotation", fields: ["content"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
  { endpoint: "novel.update-setting-annotation", entity: "setting_annotation", fields: ["content", "resolved"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
  { endpoint: "novel.delete-setting-annotation", entity: "setting_annotation", fields: ["*"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
  { endpoint: "novel.create-setting-annotation-round", entity: "setting_annotation_round", fields: ["content"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
  { endpoint: "novel.update-setting-annotation-round", entity: "setting_annotation_round", fields: ["content"], category: "workflow_fact", aiPerception: "flow_only", sync: "none" },
