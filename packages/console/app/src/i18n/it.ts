...
export const dict = {
  ...
  "notFound.title": "Non trovato | opennovel",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di opennovel",
  "notFound.logoDarkAlt": "logo scuro di opennovel",
  ...
  "app.meta.description": "OpenNovel - L'agente di programmazione open source.",

  "home.title": "OpenNovel | L'agente di coding IA open source",

  "temp.title": "opennovel | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da opennovel",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "OpenNovel TUI con il tema tokyonight",
  "temp.screenshot.alt": "OpenNovel TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di opennovel",
  "temp.logoDarkAlt": "logo scuro di opennovel",
  ...
  "home.what.title": "Che cos'è OpenNovel?",
  "home.what.body": "OpenNovel è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, OpenNovel è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "OpenNovel non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è OpenNovel?",
  "home.faq.a1":
    "OpenNovel è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso OpenNovel?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare OpenNovel?",
  "home.faq.a3.p1":
    "Non necessariamente: OpenNovel include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, OpenNovel funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con OpenNovel?",
  "home.faq.a4.p1":
    "Sì, OpenNovel supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare OpenNovel solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! OpenNovel ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa OpenNovel?",
  "home.faq.a6":
    "OpenNovel è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "OpenNovel è open source?",
  "home.faq.a8.p1": "Sì, OpenNovel è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che OpenNovel ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "OpenNovel Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che OpenNovel ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è OpenNovel Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro OpenNovel.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più OpenNovel può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, OpenNovel aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con OpenNovel, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti OpenNovel.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con OpenNovel, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "OpenNovel Go | Modelli di coding a basso costo per tutti",
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza OpenNovel a quante più persone possibile. OpenNovel Go è un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con OpenNovel o qualsiasi agente.",
  ...
  "go.faq.q1": "Che cos'è OpenNovel Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} è terminata. Puoi continuare a usare il modello abbonandoti a OpenNovel Go - {{link}}",

  "black.meta.title": "OpenNovel Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento OpenNovel Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "OpenNovel Black | Prezzi",
  ...
  "black.workspace.title": "OpenNovel Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a OpenNovel Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di OpenNovel Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con opennovel quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona opennovel",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia opennovel ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi opennovel.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API opennovel Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a OpenNovel Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano OpenNovel Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano OpenNovel Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a OpenNovel Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "OpenNovel Go" come provider nella tua configurazione opennovel per utilizzare i modelli Go.',
  ...
  "workspace.lite.black.message":
    "Attualmente sei abbonato a OpenNovel Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace è già abbonato a OpenNovel Go. Solo un membro per workspace può abbonarsi.",
  "workspace.lite.promo.description":
    "OpenNovel Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica OpenNovel per macOS, Windows e Linux",
  "download.hero.title": "Scarica OpenNovel Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare OpenNovel a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", OpenNovel funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "OpenNovel è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre OpenNovel funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in OpenNovel.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "OpenNovel | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta OpenNovel per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "OpenNovel opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è OpenNovel Enterprise?",
  "enterprise.faq.a1":
    "OpenNovel Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con OpenNovel Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. OpenNovel per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con OpenNovel Enterprise?",
  "enterprise.faq.a4":
    "Sì. OpenNovel non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "OpenNovel | Brand",
  "brand.meta.description": "Linee guida del brand OpenNovel",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand OpenNovel.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "OpenNovel | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog OpenNovel",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a OpenNovel",
