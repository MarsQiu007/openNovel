      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://opennovel.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>opennovel.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g opennovel-ai")}>
                <code>
                  npm i -g <strong>opennovel-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g opennovel-ai")}>
                <code>
                  bun add -g <strong>opennovel-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/opennovel")}>
                <code>
                  brew install <strong>anomalyco/tap/opennovel</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S opennovel")}>
                <code>
                  paru -S <strong>opennovel</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask opennovel-desktop")}>
                <code>
                  brew install --cask <strong>opennovel-desktop</strong>
                </code>
                <CopyStatus />
              </button>
