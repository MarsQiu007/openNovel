...
import compareVideo from "../../asset/lander/opennovel-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/opennovel-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="opennovel:auth" content={loggedin() ? "true" : "false"} />
