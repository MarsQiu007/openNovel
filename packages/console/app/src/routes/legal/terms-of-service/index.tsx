...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>OpenNovel | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="OpenNovel terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to OpenNovel. Please read on to learn the rules and restrictions that govern your use of
                OpenNovel&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("OpenNovel," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://opennovel.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opennovel">What is OpenNovel?</h2>
              <p>
                OpenNovel is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the OpenNovel Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, OpenNovel enables you to
              ...
              <p>
                ...
                our site located at opennovel.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                OpenNovel takes the privacy of its users very seriously. For the current OpenNovel Privacy Policy,
                please click here{" "}
                <a href="https://opennovel.ai/legal/privacy-policy">https://opennovel.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using OpenNovel?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by OpenNovel;
                </li>
                <li>
              ...
              <p>
                If you use OpenNovel with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                OpenNovel. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                OpenNovel has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opennovel-ever-change-the-services">Will OpenNovel ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://opennovel.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://opennovel.ai/auth">https://opennovel.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://opennovel.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                OpenNovel is also free to terminate (or suspend access to) your use of the Services for any reason in
                our discretion, including your breach of these Terms. OpenNovel has the sole right to decide whether you
              ...
              <p>
                OpenNovel and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (OpenNovel and all such
                parties together, the "OpenNovel Parties") make no representations or warranties concerning the
                Services, including without limitation regarding any Content contained in or accessed through the
                Services, and the OpenNovel Parties will not be responsible or liable for the accuracy, copyright
                ...
                any way related to your participation in, the Services. The OpenNovel Parties make no representations or
                warranties regarding suggestions or recommendations of services or products offered or purchased through
                or in connection with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY OPENNOVEL (AND ITS
              ...
              <p>
                ...
                OPENNOVEL PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO OPENNOVEL IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the OpenNovel Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without OpenNovel's prior written
              ...
              <p>
                ...
                disputes and claims with OpenNovel and limits the manner in which you can seek relief from OpenNovel.
                Both you and OpenNovel acknowledge and agree that for the purposes of any dispute arising out of or
                relating to the subject matter of these Terms, OpenNovel's officers, directors, employees and
              ...
              <p>
                The Rules will govern payment of all arbitration fees. OpenNovel will pay all arbitration fees for
                claims less than seventy-five thousand ($75,000) dollars. OpenNovel will not seek its attorneys' fees
              ...
              <p>
                Either you or OpenNovel may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND OPENNOVEL WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and OpenNovel are instead choosing to have claims and disputes resolved by
                ...
                you and OpenNovel over whether to vacate or enforce an arbitration award, YOU AND OPENNOVEL WAIVE ALL
              ...
              <p>
                ...
                OpenNovel is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or OpenNovel to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and OpenNovel agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the OpenNovel may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and OpenNovel agree that
                these Terms are the complete and exclusive statement of the mutual understanding between you and
                OpenNovel, and that these Terms supersede and cancel all previous written and oral agreements,
                communications and other understandings relating to the subject matter of these Terms. You hereby
                acknowledge and agree that you are not an employee, agent, partner, or joint venture of OpenNovel, and
                you do not have any authority of any kind to bind OpenNovel in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and
                OpenNovel agree there are no third-party beneficiaries intended under these Terms.
              </p>
            </article>
          </section>
        </div>
