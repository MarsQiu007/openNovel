    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">opennovel.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>opennovel-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>opennovel-ai</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>opennovel</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>opennovel-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/opennovel">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/MarsQiu007/openNovel">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://opennovel.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
