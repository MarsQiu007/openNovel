...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@opennovel-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@opennovel-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-opennovel-tutorial": "1" },
    query: { debug: "1" },
  },
})
