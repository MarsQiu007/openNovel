...
> current private `@opennovel-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@opennovel-ai/ai`
...
- Secondary audience: OpenNovel and other durable agent runtimes
...
import { LLM } from "@opennovel-ai/ai"
import { OpenAI } from "@opennovel-ai/ai/providers/openai"
...
```ts
import { Message } from "@opennovel-ai/ai"
...
import { LLM, Tool } from "@opennovel-ai/ai"
...
OpenNovel and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@opennovel-ai/ai/promise"
import { OpenAI } from "@opennovel-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@opennovel-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@opennovel-ai/ai/provider"
...
@opennovel-ai/ai/promise
  Promise/AsyncIterable LLM facade

@opennovel-ai/ai/schema
  serializable domain schemas

@opennovel-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@opennovel-ai/ai/providers/openai
@opennovel-ai/ai/providers/anthropic
@opennovel-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@opennovel-ai/llm`                     | `@opennovel-ai/ai`                                          |
...
OpenNovel should migrate to `generateTurn` / `streamTurn`, preserving its durable
