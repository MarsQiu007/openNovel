...
Schema-first LLM core for opennovel. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@opennovel-ai/llm"
import { OpenAI } from "@opennovel-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@opennovel-ai/llm/providers"
