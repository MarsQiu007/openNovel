...
export const TypeId: TypeId = "~@opennovel-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@opennovel-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@opennovel-ai/effect-sqlite-node/NodeSqliteClient")
