...
const STORAGE_KEYS = {
  THEME_ID: "opennovel-theme-id",
  COLOR_SCHEME: "opennovel-color-scheme",
  THEME_CSS_LIGHT: "opennovel-theme-css-light",
  THEME_CSS_DARK: "opennovel-theme-css-dark",
} as const
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: {
    defaultTheme?: string
    /** Fallback color scheme when the user has not saved one. Defaults to "system". */
    defaultScheme?: ColorScheme
    onThemeApplied?: (theme: DesktopTheme, mode: "light" | "dark", scheme: ColorScheme) => void
  }) => {
    const themeId = normalize(read(STORAGE_KEYS.THEME_ID) ?? props.defaultTheme) ?? "oc-2"
    const colorScheme = (read(STORAGE_KEYS.COLOR_SCHEME) as ColorScheme | null) ?? props.defaultScheme ?? "system"
    ...
    onMount(() => {
      ...
      const savedScheme = (read(STORAGE_KEYS.COLOR_SCHEME) as ColorScheme | null) ?? props.defaultScheme ?? "system"
