...
const icons = {
  ...
  bookshelf: {
    viewBox: "0 0 16 16",
    body: `<path d="M2.5 2.5H13.5V13.5H2.5V2.5Z" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/><path d="M2.5 8H13.5" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/><path d="M5 8V4.5M7.5 8V4.5M9.6 7.9L11.4 4.6" stroke="currentColor" stroke-linecap="round"/><path d="M8.5 13.5V10M11 13.5V10M6.4 13.4L4.6 10.1" stroke="currentColor" stroke-linecap="round"/>`,
  },
  book: {
    viewBox: "0 0 16 16",
    body: `<path d="M3.5 2.5H12.5V13.5H3.5V2.5Z" stroke="currentColor" stroke-miterlimit="10" stroke-linecap="square"/><path d="M5.5 2.5V13.5" stroke="currentColor" stroke-miterlimit="10"/><path d="M7.5 5.5H10.5" stroke="currentColor" stroke-linecap="round"/>`,
  },
}

const spriteID = "opennovel-v2-icon-sprite"
const symbol = (name: keyof typeof icons) => `opennovel-v2-icon-${name}`
