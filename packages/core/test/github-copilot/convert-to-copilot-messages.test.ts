import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@opennovel-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
