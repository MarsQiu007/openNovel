...
import { Event } from "@opennovel-ai/schema/project-directories"
import { ProjectCopy } from "@opennovel-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/ProjectCopy") {}
