...
import type { EffectDrizzleSqlite } from "@opennovel-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/ProjectDirectories") {}
