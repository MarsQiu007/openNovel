...
import { Entry, FileSystem, FindInput, Match } from "@opennovel-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@opennovel-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/FileSystem") {}
