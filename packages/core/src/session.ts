...
import { ListAnchor } from "@opennovel-ai/schema/session"
...
import { SessionDurable } from "@opennovel-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/Session") {}
