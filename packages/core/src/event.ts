...
import type { Data, Definition, Payload } from "@opennovel-ai/schema/event"
...
import { Durable } from "@opennovel-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@opennovel-ai/schema/event").ID
export type { Data, Definition, Payload } from "@opennovel-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/Event") {}
