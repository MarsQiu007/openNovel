...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@opennovel-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/ToolRegistry") {}
