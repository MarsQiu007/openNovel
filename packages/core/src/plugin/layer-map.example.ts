...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@opennovel/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@opennovel/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@opennovel/example/ConfigServiceMap", {
