...
import { PermissionSaved } from "@opennovel-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/PermissionSaved") {}
