...
import type { Plugin as PluginRuntime } from "@opennovel-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/Plugin") {}
