...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(
  Effect.sync(() => (Flag.OPENNOVEL_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
