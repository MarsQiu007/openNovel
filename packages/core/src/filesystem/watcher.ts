...
import { FileSystemWatcher } from "@opennovel-ai/schema/filesystem-watcher"
...
declare const OPENNOVEL_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENNOVEL_LIBC === "undefined" ? undefined : OPENNOVEL_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@opennovel/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENNOVEL_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.OPENNOVEL_EXPERIMENTAL_FILEWATCHER)) {
