...
class Database extends Context.Service<Database, DatabaseShape>()("@opennovel/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@opennovel/example/UserStore") {
