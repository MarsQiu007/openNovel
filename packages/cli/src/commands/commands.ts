...
declare const OPENNOVEL_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OPENNOVEL_CLI_NAME === "string" ? OPENNOVEL_CLI_NAME : "opennovel", {
  description: "OpenNovel 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
