...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "openNovel Documentation", href: "https://github.com/MarsQiu007/openNovel" },
      { type: "item", label: "Support Forum", href: "https://github.com/MarsQiu007/openNovel/issues" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/MarsQiu007/openNovel/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/MarsQiu007/openNovel/issues/new?template=bug_report.yml",
      },
    ],
  },
]
