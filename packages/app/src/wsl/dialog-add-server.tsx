...
import { showToast } from "@opennovel-ai/ui/toast"
...
import { LoaderV2 } from "@opennovel-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@opennovel-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-opennovel") {
      await run(() => api.installOpenNovel(distro))
      return
    }
