...
import { base64Decode, base64Encode } from "@opennovel-ai/core/util/encode"
...
import { Tooltip, TooltipKeybind } from "@opennovel-ai/ui/tooltip"
import { useTheme } from "@opennovel-ai/ui/theme/context"
import { IconButtonV2 } from "@opennovel-ai/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@opennovel-ai/ui/v2/icon"
import { KeybindV2 } from "@opennovel-ai/ui/v2/keybind-v2"
...
export function useTitlebarRightMount() {
  ...
  onMount(() => setMount(document.getElementById("opennovel-titlebar-right")))
  return mount
}
        ...
        <Match when={useV2Titlebar()}>
          {(_) => {
            ...
            const titlebarNovels = createMemo(() =>
              [...(novelsQuery.data ?? [])].sort((a, b) => b.createdAt - a.createdAt),
            )
            ...
            return (
              ...
              >
                ...
                <Show when={novelDirectory()}>
                  <MenuV2 modal={false} placement="bottom-start">
                    <MenuV2.Trigger
                      as={IconButtonV2}
                      type="button"
                      variant="ghost-muted"
                      size="large"
                      class="!w-9 shrink-0"
                      icon={<IconV2 name="bookshelf" />}
                      aria-label={language.t("novel.bookshelf.title")}
                    />
                    <MenuV2.Portal>
                      <MenuV2.Content>
                        ...
                        >
                          <For each={titlebarNovels()}>
                            {(novel) => (
                              <MenuV2.Item
                                onSelect={() => navigate(`/${base64Encode(novelDirectory())}/novel/${novel.id}`)}
                              >
                                {novel.title}
                              </MenuV2.Item>
                            )}
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="opennovel-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                  </div>
                </div>
                <ChannelIndicator debugTools={props.debugTools} />
              </div>
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="opennovel-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="opennovel-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator(props: { debugTools?: { visible: boolean; toggle: () => void } }) {
  const channel = import.meta.env.VITE_OPENNOVEL_CHANNEL
