...
beforeAll(async () => {
  ...
  mock.module("@opennovel-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opennovel-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opennovel-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@opennovel-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
