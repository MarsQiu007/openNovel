import { withAlpha } from "@opennovel-ai/ui/theme/color"
import { useTheme } from "@opennovel-ai/ui/theme/context"
import { resolveThemeVariant } from "@opennovel-ai/ui/theme/resolve"
import { resolveThemeVariantV2 } from "@opennovel-ai/ui/theme/v2/resolve"
import type { HexColor, ResolvedV2Theme } from "@opennovel-ai/ui/theme/types"
...
export const Terminal = (props: TerminalProps) => {
  ...
  const username = auth?.username ?? "opennovel"
  ...
  onMount(() => {
    const run = async () => {
      ...
      const connectToken = async () => {
        ...
        throw new Error(`PTY connect ticket failed with ${status}`)
      }
