...
beforeAll(async () => {
  ...
  mock.module("@opennovel-ai/sdk/v2/client", () => ({
    createOpenNovelClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@opennovel-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@opennovel-ai/core/util/encode", () => ({
