...
import type { Config, OpenNovelClient, Project, Session } from "@opennovel-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@opennovel-ai/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as OpenNovelClient
