...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: OpenNovelClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: OpenNovelClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: OpenNovelClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => OpenNovelClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, OpenNovelClient>()
