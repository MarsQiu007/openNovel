  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://opennovel.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://opennovel.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://opennovel.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://opennovel.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://opennovel.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://opennovel.example.com"),
      ),
    ).toEqual({
