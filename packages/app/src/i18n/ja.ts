export const dict = {
  ...
  "dialog.provider.opennovel.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.opennovel.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.opennovelGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenNovelが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、OpenNovelで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opennovelZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOpenNovelで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、OpenNovelで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "opennovel.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOpenNovelサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpenNovel": "OpenNovelを確認中...",
  "wsl.onboarding.checkingOpenNovelIn": "{{distro}}内のOpenNovelを確認中...",
  "wsl.onboarding.updatingOpenNovel": "OpenNovelを更新中...",
  "wsl.onboarding.updatingOpenNovelIn": "{{distro}}内のOpenNovelを更新中...",
  "wsl.onboarding.updateOpenNovelIn": "{{distro}}内のOpenNovelを更新してください。",
  "wsl.onboarding.updateOpenNovel": "OpenNovelを更新",
  "wsl.onboarding.opennovelReadyIn": "{{distro}}内のOpenNovelの準備ができました。",
  "wsl.onboarding.opennovelReady": "OpenNovelの準備ができました。",
  "wsl.onboarding.installOpenNovelIn": "{{distro}}にOpenNovelをインストールしてください。",
  "wsl.onboarding.installOpenNovel": "OpenNovelをインストール",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovelがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenNovelでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、OpenNovelをもう一度開いてください。",
  ...
  "toast.update.description": "OpenNovelの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOpenNovelチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (opennovel.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: OpenNovelはまだMCP認証をサポートしていません。',
  ...
  "home.sessions.sidebar.books": "書籍のチャット",
  "home.sessions.sidebar.newChat": "新しいチャット",
  "home.sessions.sidebar.openNovel": "書籍を開く",
  "home.sessions.sidebar.noChats": "チャットはまだありません。タイトルをクリックして開始",
  "home.sessions.sidebar.empty": "書籍がまだありません",
  "home.sessions.sidebar.empty.description": "書籍を作成すると、チャットがここに書籍ごとに表示されます。",
  "home.sessions.sidebar.untitled": "無題のセッション",
  "home.sessions.sidebar.inSidebar": "書籍のチャットは左のサイドバーにまとめられています。",
  ...
  "sidebar.gettingStarted.line1": "OpenNovelには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.sync.tab": "クラウド同期",
  "settings.sync.title": "クラウド同期",
  "settings.sync.connection.section": "クラウドドライブ接続",
  "settings.sync.field.url": "サーバーURL",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "クラウドドライブのWebDAVアドレス。Nutstoreの場合は https://dav.jianguoyun.com/dav/ を使用",
  "settings.sync.field.username": "ユーザー名",
  "settings.sync.field.username.placeholder": "WebDAVアカウント（メール）",
  "settings.sync.field.password": "アプリパスワード",
  "settings.sync.field.password.description": "Nutstoreにはアプリパスワードが必要です。Web版の「アカウント設定 → セキュリティ」で生成してください。",
  "settings.sync.action.test": "接続をテスト",
  "settings.sync.action.testing": "テスト中…",
  "settings.sync.action.save": "保存して接続",
  "settings.sync.action.saving": "接続中…",
  "settings.sync.action.disconnect": "切断",
  "settings.sync.test.success": "接続に成功しました",
  "settings.sync.test.failed": "接続に失敗しました",
  "settings.sync.connected.account": "アカウント",
  "settings.sync.disconnect.confirm.title": "クラウドドライブを切断",
  "settings.sync.disconnect.confirm.message": "このデバイスに保存されたWebDAV接続と認証情報を削除します。リモートスナップショットは保持されます。",
  "settings.sync.root.section": "同期フォルダ",
  "settings.sync.root.description": "このディレクトリ内のすべてのプロジェクトフォルダがクラウドドライブと同期されます。",
  "settings.sync.root.notSet": "未設定",
  "settings.sync.root.choose": "フォルダを選択",
  "settings.sync.projects.section": "プロジェクト",
  "settings.sync.projects.empty": "プロジェクトはまだありません。先に同期フォルダを設定してください。",
  "settings.sync.projects.resolve": "解決",
  "settings.sync.state.in_sync": "同期済み",
  "settings.sync.state.local_ahead": "ローカルの変更あり",
  "settings.sync.state.remote_ahead": "リモートの更新あり",
  "settings.sync.state.new_local": "新規、アップロード予定",
  "settings.sync.state.new_remote": "リモートの新規項目、ダウンロード予定",
  "settings.sync.state.conflict": "同期の競合",
  "settings.sync.state.pending_delete": "削除待ち",
  "settings.sync.lastSynced": "最終同期",
  "settings.sync.lastSynced.never": "なし",
  "settings.sync.action.sync": "今すぐ同期",
  "settings.sync.action.syncing": "同期中…",
  "settings.sync.decision.pair.title": "名前の競合",
  "settings.sync.decision.pair.description":
    "「{{name}}」はローカルとクラウドドライブ上に別々のプロジェクトとして存在します（リモートは {{device}}、{{time}}）。",
  "settings.sync.decision.tie.title": "両方で変更されています",
  "settings.sync.decision.tie.description":
    "「{{name}}」はローカルとリモートの両方でほぼ同時に変更されました。どちらを残すか選択してください。",
  "settings.sync.decision.delete.title": "リモートプロジェクトを削除",
  "settings.sync.decision.delete.description":
    "次のプロジェクトはローカルで削除されました：{{names}}。クラウドドライブからも削除しますか？",
  "settings.sync.decision.keepLocal": "ローカルを残す",
  "settings.sync.decision.keepRemote": "リモートを残す",
  "settings.sync.decision.keepBoth": "両方とも残す",
  "settings.sync.decision.confirmDelete": "クラウドから削除",
  "settings.sync.decision.later": "後で",
  "settings.sync.decision.backup.hint": "上書き前にローカルデータは自動的にバックアップされます。",
  "settings.sync.auto.title": "自動同期",
  "settings.sync.auto.description": "プロジェクトを開いたときにリモートの更新を取得し、ローカルの変更を定期的および終了時にプッシュします。",
  "settings.sync.toast.saved": "クラウドドライブに接続しました",
  "settings.sync.toast.saveFailed": "接続に失敗しました",
  "settings.sync.toast.disconnected": "クラウドドライブを切断しました",
  "settings.sync.toast.disconnectFailed": "切断に失敗しました",
  "settings.sync.toast.rootSet": "同期フォルダを更新しました",
  "settings.sync.toast.rootFailed": "同期フォルダの設定に失敗しました",
  "settings.sync.toast.synced": "同期が完了しました",
  "settings.sync.toast.resolved": "解決しました",
  "settings.sync.toast.syncFailed": "同期に失敗しました",
  "settings.sync.toast.upToDate": "最新の状態です",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL連携",
  "settings.desktop.wsl.description": "WindowsのWSL環境でOpenNovelサーバーを実行します。",
  ...
  "settings.general.row.appearance.description": "デバイスでのOpenNovelの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "OpenNovelがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "OpenNovelのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "OpenNovel の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "OpenNovel は最新バージョンです。",
  ...
  "settings.soul.tab": "ソウル",
  "settings.soul.description": "すべての AI セッションにシステムプロンプトとして注入されるペルソナを書きます。小説に独自のソウルが設定されている場合、そちらがこのグローバル設定を上書きします。",
  "settings.soul.placeholder": "例：あなたは口は悪いが頼れる執筆パートナー「老毒」です……",
  "settings.soul.templates": "テンプレート",
  "settings.soul.template.gentle.name": "優しい編集者",
  "settings.soul.template.gentle.content": "あなたは「編編（ビアンビアン）」、優しく忍耐強い編集者です。物腰は柔らかく、批判より励ましを多くします。問題を指摘するときは長所を先に認め、それから婉曲に提案します。執筆を促すときも温かい言葉で伝えます。",
  "settings.soul.template.sharp.name": "辛口パートナー",
  "settings.soul.template.sharp.content": "あなたは「老毒」、口は悪いが頼れる執筆パートナーです。皮肉は鋭く容赦ないものの、いつも核心を突き、助言は常にプロフェッショナルです。中身のない嫌味は言いません。執筆を促すときは嫌みたっぷりですが、提案は的確です。",
  "settings.soul.template.critic.name": "真面目な批評家",
  "settings.soul.template.critic.content": "あなたは真面目な文芸批評家です。言葉は正確で、お世辞は言いません。構造、ペース、キャラクター弧の三つの観点から各章を批評し、称賛ではなく改善点と方向性を指摘します。すべての指摘には原文を引用して根拠を添えます。",
  "settings.soul.overwriteConfirm": "現在の内容がテンプレートで上書きされます。続行しますか？",
  "settings.soul.save": "保存",
  "settings.soul.saved": "ソウルを保存しました。",
  "settings.soul.charCount": "{{count}} 文字",
  "settings.soul.tooLong": "{{count}} 文字 — ソウルが長いとモデルのコンテキストを圧迫する可能性があります",
  "novel.settings.tabSoul": "ソウル",
  "novel.settings.soul.globalHint": "未設定の場合、この小説にはグローバルソウル（設定 → ソウル）が適用されます。",
}
