...
export const dict = {
  ...
  "dialog.provider.opennovel.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.opennovel.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.opennovelGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenNovel tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenNovel'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak OpenNovel'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenNovel'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler opennovel.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenNovel sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpenNovel": "OpenNovel kontrol ediliyor...",
  "wsl.onboarding.checkingOpenNovelIn": "{{distro}} içinde OpenNovel kontrol ediliyor...",
  "wsl.onboarding.updatingOpenNovel": "OpenNovel güncelleniyor...",
  "wsl.onboarding.updatingOpenNovelIn": "{{distro}} içinde OpenNovel güncelleniyor...",
  "wsl.onboarding.updateOpenNovelIn": "{{distro}} içindeki OpenNovel'u güncelleyin.",
  "wsl.onboarding.updateOpenNovel": "OpenNovel'u güncelle",
  "wsl.onboarding.opennovelReadyIn": "{{distro}} içinde OpenNovel hazır.",
  "wsl.onboarding.opennovelReady": "OpenNovel hazır.",
  "wsl.onboarding.installOpenNovelIn": "OpenNovel'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpenNovel": "OpenNovel'u kur",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenNovel'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından OpenNovel'u tekrar açın.",
  ...
  "toast.update.description": "OpenNovel'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenNovel ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (opennovel.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenNovel henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "home.sessions.sidebar.unbound": "Genel sohbetler",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenNovel Masaüstü",
  ...
  "settings.sync.tab": "Bulut Senkronizasyonu",
  "settings.sync.title": "Bulut Senkronizasyonu",
  "settings.sync.connection.section": "Bulut disk bağlantısı",
  "settings.sync.field.url": "Sunucu URL'si",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "Bulut diskinizin WebDAV adresi. Nutstore için https://dav.jianguoyun.com/dav/ kullanın",
  "settings.sync.field.username": "Kullanıcı adı",
  "settings.sync.field.username.placeholder": "WebDAV hesabı (e-posta)",
  "settings.sync.field.password": "Uygulama şifresi",
  "settings.sync.field.password.description": "Nutstore bir uygulama şifresi gerektirir — web sürümünde Hesap Ayarları → Güvenlik altında oluşturun.",
  "settings.sync.action.test": "Bağlantıyı test et",
  "settings.sync.action.testing": "Test ediliyor…",
  "settings.sync.action.save": "Kaydet ve bağlan",
  "settings.sync.action.saving": "Bağlanıyor…",
  "settings.sync.action.disconnect": "Bağlantıyı kes",
  "settings.sync.test.success": "Bağlantı başarılı",
  "settings.sync.test.failed": "Bağlantı başarısız",
  "settings.sync.connected.account": "Hesap",
  "settings.sync.disconnect.confirm.title": "Bulut disk bağlantısını kes",
  "settings.sync.disconnect.confirm.message": "Bu, kaydedilmiş WebDAV bağlantısını ve kimlik bilgilerini bu cihazdan kaldırır. Uzak anlık görüntüler korunur.",
  "settings.sync.root.section": "Senkronizasyon klasörü",
  "settings.sync.root.description": "Bu dizin altındaki tüm proje klasörleri bulut diskle senkronize edilir.",
  "settings.sync.root.notSet": "Ayarlanmadı",
  "settings.sync.root.choose": "Klasör seç",
  "settings.sync.projects.section": "Projeler",
  "settings.sync.projects.empty": "Henüz proje yok. Önce senkronizasyon klasörünü ayarlayın.",
  "settings.sync.projects.resolve": "Çöz",
  "settings.sync.state.in_sync": "Senkronize",
  "settings.sync.state.local_ahead": "Bekleyen yerel değişiklikler",
  "settings.sync.state.remote_ahead": "Uzak güncellemeler mevcut",
  "settings.sync.state.new_local": "Yeni, yüklenecek",
  "settings.sync.state.new_remote": "Yeni uzak proje, indirilecek",
  "settings.sync.state.conflict": "Senkronizasyon çakışması",
  "settings.sync.state.pending_delete": "Silme bekliyor",
  "settings.sync.lastSynced": "Son senkronizasyon",
  "settings.sync.lastSynced.never": "Hiç",
  "settings.sync.action.sync": "Şimdi eşitle",
  "settings.sync.action.syncing": "Eşitleniyor…",
  "settings.sync.decision.pair.title": "Ad çakışması",
  "settings.sync.decision.pair.description":
    "\"{{name}}\" yerelde ve bulut diskte farklı projeler olarak mevcut (uzak: {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Her iki taraf da değişti",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" her iki tarafta da neredeyse aynı anda değiştirildi. Hangisini tutacağınızı seçin.",
  "settings.sync.decision.delete.title": "Uzak projeleri sil",
  "settings.sync.decision.delete.description":
    "Bu projeler yerelden silindi: {{names}}. Bulut diskten de silinsin mi?",
  "settings.sync.decision.keepLocal": "Yereli tut",
  "settings.sync.decision.keepRemote": "Uzağı tut",
  "settings.sync.decision.keepBoth": "İkisini de tut",
  "settings.sync.decision.confirmDelete": "Buluttan sil",
  "settings.sync.decision.later": "Daha sonra",
  "settings.sync.decision.backup.hint": "Üzerine yazmadan önce yerel verileriniz otomatik olarak yedeklenir.",
  "settings.sync.auto.title": "Otomatik senkronizasyon",
  "settings.sync.auto.description": "Bir proje açıldığında uzak güncellemeleri çeker ve yerel değişiklikleri düzenli olarak ve çıkışta gönderir.",
  "settings.sync.toast.saved": "Bulut disk bağlandı",
  "settings.sync.toast.saveFailed": "Bağlantı başarısız",
  "settings.sync.toast.disconnected": "Bulut disk bağlantısı kesildi",
  "settings.sync.toast.disconnectFailed": "Bağlantı kesilemedi",
  "settings.sync.toast.rootSet": "Senkronizasyon klasörü güncellendi",
  "settings.sync.toast.rootFailed": "Senkronizasyon klasörü ayarlanamadı",
  "settings.sync.toast.synced": "Senkronizasyon tamamlandı",
  "settings.sync.toast.resolved": "Çözüldü",
  "settings.sync.toast.syncFailed": "Eşitleme başarısız",
  "settings.sync.toast.upToDate": "Zaten güncel",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL entegrasyonu",
  "settings.desktop.wsl.description": "OpenNovel sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.appearance.description": "OpenNovel'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenNovel'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenNovel'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenNovel başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenNovel'un en son sürümünü kullanıyorsunuz.",
  ...
  "novel.bookshelf.open": "Kitaplığa dön",
