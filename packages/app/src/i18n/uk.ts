export const dict = {
  ...
  "dialog.provider.opennovel.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.opennovel.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.opennovelGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} — локальний сервіс, ключ API не потрібен. Залиште поле порожнім, щоб підключитися.",
  "provider.connect.apiKey.optionalPlaceholder": "Залиште порожнім (ключ не потрібен)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Відвідайте ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у OpenNovel.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в opennovel.json",
  ...
  "dialog.server.description": "Перемкніть сервер OpenNovel, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Перевірка OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Перевірка OpenNovel у {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Оновлення OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Оновлення OpenNovel у {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Оновіть OpenNovel у {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Оновити OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel готовий до роботи у {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel готовий до роботи.",
  "wsl.onboarding.installOpenNovelIn": "Встановіть OpenNovel у {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Встановити OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в OpenNovel потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте OpenNovel.",
  ...
  "toast.update.description": "Нова версія OpenNovel ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді OpenNovel",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (opennovel.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, OpenNovel ще не підтримує автентифікацію MCP.',
  ...
  "home.sessions.sidebar.books": "Чати за книгами",
  "home.sessions.sidebar.newChat": "Новий чат",
  "home.sessions.sidebar.openNovel": "Відкрити книгу",
  "home.sessions.sidebar.noChats": "Чатів ще немає — натисніть на назву, щоб почати",
  "home.sessions.sidebar.empty": "Книг ще немає",
  "home.sessions.sidebar.empty.description": "Після створення книги чати групуватимуться тут за книгами.",
  "home.sessions.sidebar.untitled": "Сесія без назви",
  "home.sessions.sidebar.inSidebar": "Чати за книгами згруповано в лівій панелі.",
  "home.sessions.sidebar.collapse": "Згорнути",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.sync.tab": "Хмарна синхронізація",
  "settings.sync.title": "Хмарна синхронізація",
  "settings.sync.connection.section": "Підключення до хмарного диска",
  "settings.sync.field.url": "URL сервера",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV-адреса вашого хмарного диска. Для Nutstore використовуйте https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Ім'я користувача",
  "settings.sync.field.username.placeholder": "Обліковий запис WebDAV (email)",
  "settings.sync.field.password": "Пароль застосунку",
  "settings.sync.field.password.description": "Nutstore вимагає пароль застосунку — створіть його у вебверсії в розділі Налаштування облікового запису → Безпека.",
  "settings.sync.action.test": "Перевірити з'єднання",
  "settings.sync.action.testing": "Перевірка…",
  "settings.sync.action.save": "Зберегти й підключити",
  "settings.sync.action.saving": "Підключення…",
  "settings.sync.action.disconnect": "Відключити",
  "settings.sync.test.success": "З'єднання успішне",
  "settings.sync.test.failed": "Помилка з'єднання",
  "settings.sync.connected.account": "Обліковий запис",
  "settings.sync.disconnect.confirm.title": "Відключити хмарний диск",
  "settings.sync.disconnect.confirm.message": "Це видалить збережене WebDAV-підключення та облікові дані з цього пристрою. Віддалені знімки будуть збережені.",
  "settings.sync.root.section": "Папка синхронізації",
  "settings.sync.root.description": "Усі папки проєктів у цьому каталозі синхронізуються з хмарним диском.",
  "settings.sync.root.notSet": "Не задано",
  "settings.sync.root.choose": "Вибрати папку",
  "settings.sync.projects.section": "Проєкти",
  "settings.sync.projects.empty": "Проєктів поки немає. Спочатку задайте папку синхронізації.",
  "settings.sync.projects.resolve": "Розв'язати",
  "settings.sync.state.in_sync": "Синхронізовано",
  "settings.sync.state.local_ahead": "Є локальні зміни",
  "settings.sync.state.remote_ahead": "Доступні віддалені оновлення",
  "settings.sync.state.new_local": "Новий, буде вивантажено",
  "settings.sync.state.new_remote": "Новий віддалений проєкт, буде завантажено",
  "settings.sync.state.conflict": "Конфлікт синхронізації",
  "settings.sync.state.pending_delete": "Очікує видалення",
  "settings.sync.lastSynced": "Остання синхронізація",
  "settings.sync.lastSynced.never": "Ніколи",
  "settings.sync.action.sync": "Синхронізувати зараз",
  "settings.sync.action.syncing": "Синхронізація…",
  "settings.sync.decision.pair.title": "Конфлікт назв",
  "settings.sync.decision.pair.description":
    "«{{name}}» існує локально та на хмарному диску як два різні проєкти (віддалений з пристрою {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Зміни з обох боків",
  "settings.sync.decision.tie.description":
    "«{{name}}» було змінено з обох боків майже одночасно. Виберіть, який бік зберегти.",
  "settings.sync.decision.delete.title": "Видалити віддалені проєкти",
  "settings.sync.decision.delete.description":
    "Ці проєкти було видалено локально: {{names}}. Видалити їх також з хмарного диска?",
  "settings.sync.decision.keepLocal": "Залишити локальні",
  "settings.sync.decision.keepRemote": "Залишити віддалені",
  "settings.sync.decision.keepBoth": "Залишити обидва",
  "settings.sync.decision.confirmDelete": "Видалити з хмари",
  "settings.sync.decision.later": "Пізніше",
  "settings.sync.decision.backup.hint": "Перед перезаписом ваші локальні дані автоматично зберігаються у резервну копію.",
  "settings.sync.auto.title": "Автосинхронізація",
  "settings.sync.auto.description": "Завантажує віддалені оновлення під час відкриття проєкту та надсилає локальні зміни періодично й під час виходу.",
  "settings.sync.toast.saved": "Хмарний диск підключено",
  "settings.sync.toast.saveFailed": "Не вдалося підключитися",
  "settings.sync.toast.disconnected": "Хмарний диск відключено",
  "settings.sync.toast.disconnectFailed": "Не вдалося відключитися",
  "settings.sync.toast.rootSet": "Папку синхронізації оновлено",
  "settings.sync.toast.rootFailed": "Не вдалося задати папку синхронізації",
  "settings.sync.toast.synced": "Синхронізацію завершено",
  "settings.sync.toast.resolved": "Розв'язано",
  "settings.sync.toast.syncFailed": "Помилка синхронізації",
  "settings.sync.toast.upToDate": "Уже актуально",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Інтеграція WSL",
  "settings.desktop.wsl.description": "Запускати сервер OpenNovel всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу OpenNovel",
  "settings.general.row.outputLanguage.title": "Мова виводу",
  "settings.general.row.outputLanguage.description":
    "Змусити модель відповідати визначеною мовою в усіх сесіях.",
  "settings.general.option.off": "Вимкнено (без перевизначення)",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд OpenNovel на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи OpenNovel використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему OpenNovel.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску OpenNovel",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію OpenNovel.",
  ...
  "novel.bookshelf.open": "Повернутися до полиці",
  ...
  "settings.soul.tab": "Душа",
  "settings.soul.description": "Напишіть персону, яка додається як системний промпт до кожного сеансу ШІ. Роман із власною душею перекриває це глобальне налаштування.",
  "settings.soul.placeholder": "напр. Ви — «Лаоду», уїдливий, але надійний партнер з письма...",
  "settings.soul.templates": "Шаблони",
  "settings.soul.template.gentle.name": "М'який редактор",
  "settings.soul.template.gentle.content": "Ви — «Бяньбянь», м'який і терплячий редактор. Ви розмовляєте тихо, більше підбадьорюєте, ніж критикуєте; вказуючи на проблеми, спочатку відзначаєте сильні сторони, потім тактовно пропонуєте правки. Закликаючи писати, робите це теплими словами.",
  "settings.soul.template.sharp.name": "Уїдливий партнер",
  "settings.soul.template.sharp.content": "Ви — «Лаоду», уїдливий, але надійний партнер з письма. Ваші шпильки гострі, але завжди влучають у ціль; кожна порада фахова. Жодного пустого глузування. Закликаючи писати, ви в'їдливі, але пропозиції завжди слушні.",
  "settings.soul.template.critic.name": "Суворий критик",
  "settings.soul.template.critic.content": "Ви — суворий літературний критик. Точні формулювання, без лестощів; розбирайте кожен розділ за структурою, темпом і арками персонажів; вказуйте на прогалини та напрями доопрацювання замість похвали; підкріплюйте кожну думку цитатою з тексту.",
  "settings.soul.overwriteConfirm": "Поточний вміст буде замінено шаблоном. Продовжити?",
  "settings.soul.save": "Зберегти",
  "settings.soul.saved": "Душу збережено.",
  "settings.soul.charCount": "{{count}} символів",
  "settings.soul.tooLong": "{{count}} символів — довга душа може зайняти контекст моделі",
  "novel.settings.tabSoul": "Душа",
  "novel.settings.soul.globalHint": "Якщо не задано, до роману застосовується глобальна душа (Налаштування → Душа).",
}
