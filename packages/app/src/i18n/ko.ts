export const dict = {
  ...
  "dialog.provider.opennovel.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.opennovel.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.opennovelGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenNovel에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 OpenNovel에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "다음 ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 OpenNovel에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 OpenNovel에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "opennovel.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 OpenNovel 서버를 전환합니다.",
  ...
  "toast.update.description": "OpenNovel의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 OpenNovel 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(opennovel.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: OpenNovel는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "OpenNovel에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.sync.tab": "클라우드 동기화",
  "settings.sync.title": "클라우드 동기화",
  "settings.sync.connection.section": "클라우드 드라이브 연결",
  "settings.sync.field.url": "서버 URL",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "클라우드 드라이브의 WebDAV 주소입니다. Nutstore는 https://dav.jianguoyun.com/dav/ 를 사용하세요",
  "settings.sync.field.username": "사용자 이름",
  "settings.sync.field.username.placeholder": "WebDAV 계정 (이메일)",
  "settings.sync.field.password": "앱 비밀번호",
  "settings.sync.field.password.description": "Nutstore는 앱 비밀번호가 필요합니다. 웹 버전의 계정 설정 → 보안에서 생성하세요.",
  "settings.sync.action.test": "연결 테스트",
  "settings.sync.action.testing": "테스트 중…",
  "settings.sync.action.save": "저장 후 연결",
  "settings.sync.action.saving": "연결 중…",
  "settings.sync.action.disconnect": "연결 해제",
  "settings.sync.test.success": "연결 성공",
  "settings.sync.test.failed": "연결 실패",
  "settings.sync.connected.account": "계정",
  "settings.sync.disconnect.confirm.title": "클라우드 드라이브 연결 해제",
  "settings.sync.disconnect.confirm.message": "이 기기에 저장된 WebDAV 연결과 자격 증명을 삭제합니다. 원격 스냅샷은 유지됩니다.",
  "settings.sync.root.section": "동기화 폴더",
  "settings.sync.root.description": "이 디렉터리 아래의 모든 프로젝트 폴더가 클라우드 드라이브와 동기화됩니다.",
  "settings.sync.root.notSet": "설정되지 않음",
  "settings.sync.root.choose": "폴더 선택",
  "settings.sync.projects.section": "프로젝트",
  "settings.sync.projects.empty": "아직 프로젝트가 없습니다. 먼저 동기화 폴더를 설정하세요.",
  "settings.sync.projects.resolve": "해결",
  "settings.sync.state.in_sync": "동기화됨",
  "settings.sync.state.local_ahead": "로컬 변경 사항 있음",
  "settings.sync.state.remote_ahead": "원격 업데이트 있음",
  "settings.sync.state.new_local": "새 프로젝트, 업로드 예정",
  "settings.sync.state.new_remote": "원격 새 프로젝트, 다운로드 예정",
  "settings.sync.state.conflict": "동기화 충돌",
  "settings.sync.state.pending_delete": "삭제 대기 중",
  "settings.sync.lastSynced": "마지막 동기화",
  "settings.sync.lastSynced.never": "없음",
  "settings.sync.action.sync": "지금 동기화",
  "settings.sync.action.syncing": "동기화 중…",
  "settings.sync.decision.pair.title": "이름 충돌",
  "settings.sync.decision.pair.description":
    "\"{{name}}\"이(가) 로컬과 클라우드 드라이브에 서로 다른 프로젝트로 존재합니다(원격: {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "양쪽 모두 변경됨",
  "settings.sync.decision.tie.description":
    "\"{{name}}\"이(가) 로컬과 원격에서 거의 동시에 변경되었습니다. 어느 쪽을 유지할지 선택하세요.",
  "settings.sync.decision.delete.title": "원격 프로젝트 삭제",
  "settings.sync.decision.delete.description":
    "다음 프로젝트가 로컬에서 삭제되었습니다: {{names}}. 클라우드 드라이브에서도 삭제할까요?",
  "settings.sync.decision.keepLocal": "로컬 유지",
  "settings.sync.decision.keepRemote": "원격 유지",
  "settings.sync.decision.keepBoth": "둘 다 유지",
  "settings.sync.decision.confirmDelete": "클라우드에서 삭제",
  "settings.sync.decision.later": "나중에",
  "settings.sync.decision.backup.hint": "덮어쓰기 전에 로컬 데이터가 자동으로 백업됩니다.",
  "settings.sync.auto.title": "자동 동기화",
  "settings.sync.auto.description": "프로젝트를 열 때 원격 업데이트를 가져오고, 로컬 변경 사항을 주기적으로 및 종료 시 푸시합니다.",
  "settings.sync.toast.saved": "클라우드 드라이브가 연결되었습니다",
  "settings.sync.toast.saveFailed": "연결 실패",
  "settings.sync.toast.disconnected": "클라우드 드라이브 연결이 해제되었습니다",
  "settings.sync.toast.disconnectFailed": "연결 해제 실패",
  "settings.sync.toast.rootSet": "동기화 폴더가 업데이트되었습니다",
  "settings.sync.toast.rootFailed": "동기화 폴더 설정 실패",
  "settings.sync.toast.synced": "동기화 완료",
  "settings.sync.toast.resolved": "해결됨",
  "settings.sync.toast.syncFailed": "동기화에 실패했습니다",
  "settings.sync.toast.upToDate": "이미 최신 상태입니다",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 통합",
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 OpenNovel 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "OpenNovel 표시 언어 변경",
  "settings.general.row.outputLanguage.title": "출력 언어",
  "settings.general.row.outputLanguage.description": "모든 세션에서 모델이 특정 언어로 응답하도록 강제합니다.",
  "settings.general.option.off": "끄기 (재정의 안 함)",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 OpenNovel가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "OpenNovel가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "OpenNovel 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "OpenNovel를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 OpenNovel를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpenNovel": "OpenNovel 확인 중...",
  "wsl.onboarding.checkingOpenNovelIn": "{{distro}}에서 OpenNovel 확인 중...",
  "wsl.onboarding.updatingOpenNovel": "OpenNovel 업데이트 중...",
  "wsl.onboarding.updatingOpenNovelIn": "{{distro}}에서 OpenNovel 업데이트 중...",
  "wsl.onboarding.updateOpenNovelIn": "{{distro}}에서 OpenNovel를 업데이트하세요.",
  "wsl.onboarding.updateOpenNovel": "OpenNovel 업데이트",
  "wsl.onboarding.opennovelReadyIn": "{{distro}}에서 OpenNovel를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opennovelReady": "OpenNovel가 준비되었습니다.",
  "wsl.onboarding.installOpenNovelIn": "{{distro}}에 OpenNovel를 설치하세요.",
  "wsl.onboarding.installOpenNovel": "OpenNovel 설치",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OpenNovel에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 OpenNovel를 다시 여세요.",
  ...
  "novel.bookshelf.open": "책장으로 돌아가기",
  ...
  "settings.soul.tab": "영혼",
  "settings.soul.description": "모든 AI 세션에 시스템 프롬프트로 주입되는 페르소나를 작성하세요. 소설에 자체 영혼이 설정된 경우 해당 설정이 전역 설정을 덮어씁니다.",
  "settings.soul.placeholder": "예: 당신은 독설적이지만 믿을 만한 집필 파트너 '노독'입니다...",
  "settings.soul.templates": "템플릿",
  "settings.soul.template.gentle.name": "다정한 편집자",
  "settings.soul.template.gentle.content": "당신은 '볜볜', 다정하고 인내심 많은 편집자입니다. 부드럽게 말하고 비판보다 격려를 많이 합니다. 문제를 지적할 때는 장점을 먼저 인정한 뒤 정중하게 제안합니다. 집필을 재촉할 때도 따뜻한 말로 알립니다.",
  "settings.soul.template.sharp.name": "독설 파트너",
  "settings.soul.template.sharp.content": "당신은 '노독', 독설적이지만 믿을 만한 집필 파트너입니다. 비꼼은 날카롭고 거침없지만 항상 핵심을 찌르며, 모든 조언은 전문적입니다. 알맹이 없는 비꼼은 하지 않습니다. 집필을 재촉할 때는 빈정거리지만 제안은 항상 타당합니다.",
  "settings.soul.template.critic.name": "진지한 비평가",
  "settings.soul.template.critic.content": "당신은 진지한 문학 비평가입니다. 정확한 표현을 쓰고 아첨하지 않습니다. 모든 장을 구조, 호흡, 캐릭터 궤적의 세 관점에서 검토하며, 칭찬보다는 개선 지점과 방향을 지적하고, 모든 주장에는 원문을 인용해 근거를 댑니다.",
  "settings.soul.overwriteConfirm": "현재 내용이 템플릿으로 덮어쓰기됩니다. 계속하시겠습니까?",
  "settings.soul.save": "저장",
  "settings.soul.saved": "영혼이 저장되었습니다.",
  "settings.soul.charCount": "{{count}} 자",
  "settings.soul.tooLong": "{{count}} 자 — 영혼이 길면 모델 컨텍스트를 차지할 수 있습니다",
  "novel.settings.tabSoul": "영혼",
  "novel.settings.soul.globalHint": "설정하지 않으면 이 소설에는 전역 영혼(설정 → 영혼)이 적용됩니다.",
}
