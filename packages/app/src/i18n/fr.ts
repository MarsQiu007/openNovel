export const dict = {
  ...
  "dialog.provider.opennovel.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.opennovel.tagline": "Modèles optimisés et fiables",
  "dialog.provider.opennovelGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} est un service local — aucune clé API requise. Laissez vide pour vous connecter.",
  "provider.connect.apiKey.optionalPlaceholder": "Laissez vide (aucune clé requise)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Visitez ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenNovel.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans opennovel.json",
  ...
  "dialog.server.description": "Changez le serveur OpenNovel auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Vérification d'OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Vérification d'OpenNovel dans {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Mise à jour d'OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Mise à jour d'OpenNovel dans {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Mettez à jour OpenNovel dans {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Mettre à jour OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel est prêt dans {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel est prêt.",
  "wsl.onboarding.installOpenNovelIn": "Installez OpenNovel dans {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Installer OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'OpenNovel puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez OpenNovel.",
  ...
  "toast.update.description":
    "Une nouvelle version d'OpenNovel ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe OpenNovel",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (opennovel.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'OpenNovel ne supporte pas encore l'authentification MCP.",
  ...
  "home.sessions.sidebar.unbound": "Discussions globales",
  ...
  "sidebar.gettingStarted.line1":
    "OpenNovel inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.sync.tab": "Synchronisation cloud",
  "settings.sync.title": "Synchronisation cloud",
  "settings.sync.connection.section": "Connexion au disque cloud",
  "settings.sync.field.url": "URL du serveur",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "Adresse WebDAV de votre disque cloud. Pour Nutstore, utilisez https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Nom d'utilisateur",
  "settings.sync.field.username.placeholder": "Compte WebDAV (e-mail)",
  "settings.sync.field.password": "Mot de passe d'application",
  "settings.sync.field.password.description": "Nutstore exige un mot de passe d'application — générez-en un dans la version web sous Paramètres du compte → Sécurité.",
  "settings.sync.action.test": "Tester la connexion",
  "settings.sync.action.testing": "Test en cours…",
  "settings.sync.action.save": "Enregistrer et connecter",
  "settings.sync.action.saving": "Connexion…",
  "settings.sync.action.disconnect": "Déconnecter",
  "settings.sync.test.success": "Connexion réussie",
  "settings.sync.test.failed": "Échec de la connexion",
  "settings.sync.connected.account": "Compte",
  "settings.sync.disconnect.confirm.title": "Déconnecter le disque cloud",
  "settings.sync.disconnect.confirm.message": "Cela supprime la connexion WebDAV enregistrée et les identifiants de cet appareil. Les instantanés distants sont conservés.",
  "settings.sync.root.section": "Dossier de synchronisation",
  "settings.sync.root.description": "Tous les dossiers de projet sous ce répertoire sont synchronisés avec le disque cloud.",
  "settings.sync.root.notSet": "Non défini",
  "settings.sync.root.choose": "Choisir un dossier",
  "settings.sync.projects.section": "Projets",
  "settings.sync.projects.empty": "Aucun projet pour l'instant. Définissez d'abord le dossier de synchronisation.",
  "settings.sync.projects.resolve": "Résoudre",
  "settings.sync.state.in_sync": "Synchronisé",
  "settings.sync.state.local_ahead": "Modifications locales en attente",
  "settings.sync.state.remote_ahead": "Mises à jour distantes disponibles",
  "settings.sync.state.new_local": "Nouveau, sera téléversé",
  "settings.sync.state.new_remote": "Nouveau projet distant, sera téléchargé",
  "settings.sync.state.conflict": "Conflit de synchronisation",
  "settings.sync.state.pending_delete": "Suppression en attente",
  "settings.sync.lastSynced": "Dernière synchronisation",
  "settings.sync.lastSynced.never": "Jamais",
  "settings.sync.action.sync": "Synchroniser maintenant",
  "settings.sync.action.syncing": "Synchronisation…",
  "settings.sync.decision.pair.title": "Conflit de nom",
  "settings.sync.decision.pair.description":
    "« {{name}} » existe localement et sur le disque cloud comme deux projets différents (distant depuis {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Modifié des deux côtés",
  "settings.sync.decision.tie.description":
    "« {{name}} » a été modifié des deux côtés presque en même temps. Choisissez lequel conserver.",
  "settings.sync.decision.delete.title": "Supprimer les projets distants",
  "settings.sync.decision.delete.description":
    "Ces projets ont été supprimés localement : {{names}}. Les supprimer aussi du disque cloud ?",
  "settings.sync.decision.keepLocal": "Garder le local",
  "settings.sync.decision.keepRemote": "Garder le distant",
  "settings.sync.decision.keepBoth": "Garder les deux",
  "settings.sync.decision.confirmDelete": "Supprimer du cloud",
  "settings.sync.decision.later": "Plus tard",
  "settings.sync.decision.backup.hint": "Vos données locales sont sauvegardées automatiquement avant l'écrasement.",
  "settings.sync.auto.title": "Synchronisation automatique",
  "settings.sync.auto.description": "Récupère les mises à jour distantes à l'ouverture d'un projet et pousse les modifications locales périodiquement et à la fermeture.",
  "settings.sync.toast.saved": "Disque cloud connecté",
  "settings.sync.toast.saveFailed": "Échec de la connexion",
  "settings.sync.toast.disconnected": "Disque cloud déconnecté",
  "settings.sync.toast.disconnectFailed": "Échec de la déconnexion",
  "settings.sync.toast.rootSet": "Dossier de synchronisation mis à jour",
  "settings.sync.toast.rootFailed": "Échec de la définition du dossier de synchronisation",
  "settings.sync.toast.synced": "Synchronisation terminée",
  "settings.sync.toast.resolved": "Résolu",
  "settings.sync.toast.syncFailed": "Échec de la synchronisation",
  "settings.sync.toast.upToDate": "Déjà à jour",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Intégration WSL",
  "settings.desktop.wsl.description": "Exécuter le serveur OpenNovel dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour OpenNovel",
  "settings.general.row.outputLanguage.title": "Langue de sortie",
  "settings.general.row.outputLanguage.description":
    "Forcer le modèle à répondre dans une langue spécifique pour toutes les sessions.",
  "settings.general.option.off": "Désactivé (aucune substitution)",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'OpenNovel sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si OpenNovel suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'OpenNovel.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'OpenNovel",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'OpenNovel.",
  ...
  "novel.bookshelf.open": "Retour à la bibliothèque",
  ...
  "settings.soul.tab": "Âme",
  "settings.soul.description": "Rédigez un persona injecté comme invite système dans chaque session d'IA. Un roman avec sa propre âme remplace cette âme globale.",
  "settings.soul.placeholder": "p. ex. Vous êtes « Laodu », un partenaire d'écriture acerbe mais fiable...",
  "settings.soul.templates": "Modèles",
  "settings.soul.template.gentle.name": "Correcteur doux",
  "settings.soul.template.gentle.content": "Vous êtes « Bianbian », un correcteur doux et patient. Vous parlez doucement, encouragez plus que vous ne critiquez ; en signalant les problèmes, vous affirmez d'abord les points forts, puis proposez des suggestions avec tact. Pour inciter à écrire, vous utilisez des mots chaleureux.",
  "settings.soul.template.sharp.name": "Partenaire acerbe",
  "settings.soul.template.sharp.content": "Vous êtes « Laodu », un partenaire d'écriture acerbe mais fiable. Vos piques sont mordantes mais toujours justes ; chaque conseil est professionnel. Jamais de sarcasme sans substance. Pour inciter à écrire, vous êtes sardonique mais vos suggestions sont toujours pertinentes.",
  "settings.soul.template.critic.name": "Critique sérieux",
  "settings.soul.template.critic.content": "Vous êtes un critique littéraire sérieux. Formulation précise, pas de flatterie ; examinez chaque chapitre selon la structure, le rythme et les arcs de personnage ; signalez les lacunes et les axes d'amélioration plutôt que les éloges ; citez le texte pour étayer chaque point.",
  "settings.soul.overwriteConfirm": "Le contenu actuel sera remplacé par le modèle. Continuer ?",
  "settings.soul.save": "Enregistrer",
  "settings.soul.saved": "Âme enregistrée.",
  "settings.soul.charCount": "{{count}} caractères",
  "settings.soul.tooLong": "{{count}} caractères — une âme longue peut encombrer le contexte du modèle",
  "novel.settings.tabSoul": "Âme",
  "novel.settings.soul.globalHint": "Si elle n'est pas définie, l'âme globale (Paramètres → Âme) s'applique à ce roman.",
}
