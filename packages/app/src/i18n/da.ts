export const dict = {
  ...
  "dialog.provider.opennovel.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.opennovel.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.opennovelGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenNovel.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Besøg ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenNovel.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i opennovel.json",
  ...
  "dialog.server.description": "Skift hvilken OpenNovel-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Tjekker OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Tjekker OpenNovel i {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Opdaterer OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Opdaterer OpenNovel i {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Opdater OpenNovel i {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Opdater OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før OpenNovel kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenNovel igen.",
  ...
  "toast.update.description": "En ny version af OpenNovel ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenNovel-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (opennovel.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenNovel understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenNovel inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.sync.tab": "Cloudsynkronisering",
  "settings.sync.title": "Cloudsynkronisering",
  "settings.sync.connection.section": "Forbindelse til clouddrev",
  "settings.sync.field.url": "Server-URL",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV-adressen på dit clouddrev. Til Nutstore bruges https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Brugernavn",
  "settings.sync.field.username.placeholder": "WebDAV-konto (e-mail)",
  "settings.sync.field.password": "App-adgangskode",
  "settings.sync.field.password.description": "Nutstore kræver en app-adgangskode — opret en i webversionen under Kontoindstillinger → Sikkerhed.",
  "settings.sync.action.test": "Test forbindelse",
  "settings.sync.action.testing": "Tester…",
  "settings.sync.action.save": "Gem og opret forbindelse",
  "settings.sync.action.saving": "Opretter forbindelse…",
  "settings.sync.action.disconnect": "Afbryd",
  "settings.sync.test.success": "Forbindelse oprettet",
  "settings.sync.test.failed": "Forbindelse mislykkedes",
  "settings.sync.connected.account": "Konto",
  "settings.sync.disconnect.confirm.title": "Afbryd clouddrev",
  "settings.sync.disconnect.confirm.message": "Dette fjerner den gemte WebDAV-forbindelse og legitimationsoplysninger fra denne enhed. Eksterne snapshots bevares.",
  "settings.sync.root.section": "Synkroniseringsmappe",
  "settings.sync.root.description": "Alle projektmapper under denne mappe synkroniseres med clouddrevet.",
  "settings.sync.root.notSet": "Ikke angivet",
  "settings.sync.root.choose": "Vælg mappe",
  "settings.sync.projects.section": "Projekter",
  "settings.sync.projects.empty": "Ingen projekter endnu. Angiv synkroniseringsmappen først.",
  "settings.sync.projects.resolve": "Løs",
  "settings.sync.state.in_sync": "Synkroniseret",
  "settings.sync.state.local_ahead": "Lokale ændringer afventer",
  "settings.sync.state.remote_ahead": "Eksterne opdateringer tilgængelige",
  "settings.sync.state.new_local": "Nyt, uploades",
  "settings.sync.state.new_remote": "Nyt eksternt projekt, downloades",
  "settings.sync.state.conflict": "Synkroniseringskonflikt",
  "settings.sync.state.pending_delete": "Afventer sletning",
  "settings.sync.lastSynced": "Senest synkroniseret",
  "settings.sync.lastSynced.never": "Aldrig",
  "settings.sync.action.sync": "Synkroniser nu",
  ...
  "settings.sync.decision.pair.description":
    "\"{{name}}\" findes lokalt og på clouddrevet som to forskellige projekter (eksternt fra {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Begge sider ændret",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" blev ændret på begge sider næsten samtidig. Vælg, hvilken side der skal beholdes.",
  "settings.sync.decision.delete.title": "Slet eksterne projekter",
  "settings.sync.decision.delete.description":
    "Disse projekter blev slettet lokalt: {{names}}. Skal de også slettes fra clouddrevet?",
  ...
  "settings.sync.decision.confirmDelete": "Slet fra skyen",
  "settings.sync.decision.later": "Senere",
  "settings.sync.decision.backup.hint": "Dine lokale data sikkerhedskopieres automatisk før overskrivning.",
  "settings.sync.auto.title": "Automatisk synkronisering",
  "settings.sync.auto.description": "Henter eksterne opdateringer, når et projekt åbnes, og uploader lokale ændringer periodisk og ved afslutning.",
  "settings.sync.toast.saved": "Clouddrev tilsluttet",
  "settings.sync.toast.saveFailed": "Tilslutning mislykkedes",
  "settings.sync.toast.disconnected": "Clouddrev afbrudt",
  "settings.sync.toast.disconnectFailed": "Afbrydelse mislykkedes",
  "settings.sync.toast.rootSet": "Synkroniseringsmappe opdateret",
  "settings.sync.toast.rootFailed": "Kunne ikke angive synkroniseringsmappe",
  "settings.sync.toast.synced": "Synkronisering fuldført",
  "settings.sync.toast.resolved": "Løst",
  "settings.sync.toast.syncFailed": "Synkronisering mislykkedes",
  "settings.sync.toast.upToDate": "Allerede opdateret",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Kør OpenNovel-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan OpenNovel ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenNovel følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenNovel er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenNovel starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenNovel.",
