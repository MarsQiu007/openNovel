export const dict = {
  ...
  "dialog.provider.opennovel.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.opennovel.tagline": "Надежные оптимизированные модели",
  "dialog.provider.opennovelGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} — это локальный сервис, API-ключ не требуется. Оставьте поле пустым, чтобы подключиться.",
  "provider.connect.apiKey.optionalPlaceholder": "Оставьте пустым (ключ не требуется)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Посетите ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в OpenNovel.",
  ...
  "dialog.plugins.empty": "Плагины настроены в opennovel.json",
  ...
  "dialog.server.description": "Переключите сервер OpenNovel к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Проверка OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Проверка OpenNovel в {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Обновление OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Обновление OpenNovel в {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Обновите OpenNovel в {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Обновить OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel в {{distro}} готов к работе.",
  "wsl.onboarding.opennovelReady": "OpenNovel готов к работе.",
  "wsl.onboarding.installOpenNovelIn": "Установите OpenNovel в {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Установить OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в OpenNovel требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте OpenNovel.",
  ...
  "toast.update.description": "Новая версия OpenNovel ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде OpenNovel",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (opennovel.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что OpenNovel пока не поддерживает MCP авторизацию.',
  ...
  "home.sessions.sidebar.unbound": "Глобальные чаты",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.sync.tab": "Облачная синхронизация",
  "settings.sync.title": "Облачная синхронизация",
  "settings.sync.connection.section": "Подключение к облачному диску",
  "settings.sync.field.url": "URL сервера",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV-адрес вашего облачного диска. Для Nutstore используйте https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Имя пользователя",
  "settings.sync.field.username.placeholder": "Учётная запись WebDAV (email)",
  "settings.sync.field.password": "Пароль приложения",
  "settings.sync.field.password.description": "Nutstore требует пароль приложения — создайте его в веб-версии в разделе Настройки аккаунта → Безопасность.",
  "settings.sync.action.test": "Проверить подключение",
  "settings.sync.action.testing": "Проверка…",
  "settings.sync.action.save": "Сохранить и подключить",
  "settings.sync.action.saving": "Подключение…",
  "settings.sync.action.disconnect": "Отключить",
  "settings.sync.test.success": "Подключение успешно",
  "settings.sync.test.failed": "Ошибка подключения",
  "settings.sync.connected.account": "Аккаунт",
  "settings.sync.disconnect.confirm.title": "Отключить облачный диск",
  "settings.sync.disconnect.confirm.message": "Сохранённое WebDAV-подключение и учётные данные будут удалены с этого устройства. Удалённые снимки сохранятся.",
  "settings.sync.root.section": "Папка синхронизации",
  "settings.sync.root.description": "Все папки проектов в этом каталоге синхронизируются с облачным диском.",
  "settings.sync.root.notSet": "Не задана",
  "settings.sync.root.choose": "Выбрать папку",
  "settings.sync.projects.section": "Проекты",
  "settings.sync.projects.empty": "Проектов пока нет. Сначала задайте папку синхронизации.",
  "settings.sync.projects.resolve": "Разрешить",
  "settings.sync.state.in_sync": "Синхронизировано",
  "settings.sync.state.local_ahead": "Есть локальные изменения",
  "settings.sync.state.remote_ahead": "Доступны удалённые обновления",
  "settings.sync.state.new_local": "Новый, будет загружен",
  "settings.sync.state.new_remote": "Новый удалённый проект, будет скачан",
  "settings.sync.state.conflict": "Конфликт синхронизации",
  "settings.sync.state.pending_delete": "Ожидает удаления",
  "settings.sync.lastSynced": "Последняя синхронизация",
  "settings.sync.lastSynced.never": "Никогда",
  "settings.sync.action.sync": "Синхронизировать сейчас",
  "settings.sync.action.syncing": "Синхронизация…",
  "settings.sync.decision.pair.title": "Конфликт имён",
  "settings.sync.decision.pair.description":
    "«{{name}}» существует локально и на облачном диске как разные проекты (удалённый с {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Изменения с обеих сторон",
  "settings.sync.decision.tie.description":
    "«{{name}}» был изменён локально и удалённо почти одновременно. Выберите, какую сторону сохранить.",
  "settings.sync.decision.delete.title": "Удалить удалённые проекты",
  "settings.sync.decision.delete.description":
    "Эти проекты были удалены локально: {{names}}. Удалить их также с облачного диска?",
  "settings.sync.decision.keepLocal": "Оставить локальные",
  "settings.sync.decision.keepRemote": "Оставить удалённые",
  "settings.sync.decision.keepBoth": "Оставить обе",
  "settings.sync.decision.confirmDelete": "Удалить из облака",
  "settings.sync.decision.later": "Позже",
  "settings.sync.decision.backup.hint": "Перед перезаписью локальные данные автоматически сохраняются в резервную копию.",
  "settings.sync.auto.title": "Автосинхронизация",
  "settings.sync.auto.description": "Загружает удалённые обновления при открытии проекта и отправляет локальные изменения периодически и при выходе.",
  "settings.sync.toast.saved": "Облачный диск подключён",
  "settings.sync.toast.saveFailed": "Не удалось подключиться",
  "settings.sync.toast.disconnected": "Облачный диск отключён",
  "settings.sync.toast.disconnectFailed": "Не удалось отключиться",
  "settings.sync.toast.rootSet": "Папка синхронизации обновлена",
  "settings.sync.toast.rootFailed": "Не удалось задать папку синхронизации",
  "settings.sync.toast.synced": "Синхронизация завершена",
  "settings.sync.toast.resolved": "Разрешено",
  "settings.sync.toast.syncFailed": "Ошибка синхронизации",
  "settings.sync.toast.upToDate": "Уже актуально",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Интеграция с WSL",
  "settings.desktop.wsl.description": "Запускать сервер OpenNovel внутри WSL на Windows.",
  ...
  "settings.general.row.appearance.description": "Настройте как OpenNovel выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли OpenNovel системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление OpenNovel.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске OpenNovel",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию OpenNovel.",
  ...
  "novel.bookshelf.open": "Вернуться на полку",
  ...
  "settings.soul.description": "Напишите персону, которая добавляется как системный промпт в каждый сеанс ИИ. Роман с собственной душой переопределяет эту глобальную настройку.",
  "settings.soul.placeholder": "напр. Вы — «Лаоду», язвительный, но надёжный партнёр по письму...",
  "settings.soul.templates": "Шаблоны",
  "settings.soul.template.gentle.name": "Мягкий редактор",
  "settings.soul.template.gentle.content": "Вы — «Бяньбянь», мягкий и терпеливый редактор. Вы говорите тихо, больше подбадриваете, чем критикуете; указывая на проблемы, сначала отмечаете сильные стороны, затем тактично предлагаете правки. Призывая писать, делаете это тёплыми словами.",
  "settings.soul.template.sharp.name": "Язвительный партнёр",
  "settings.soul.template.sharp.content": "Вы — «Лаоду», язвительный, но надёжный партнёр по письму. Ваши колкости остры, но всегда по делу; каждый совет профессионален. Никаких пустых насмешек. Призывая писать, вы язвите, но предложения всегда дельные.",
  "settings.soul.template.critic.name": "Строгий критик",
  "settings.soul.template.critic.content": "Вы — строгий литературный критик. Точные формулировки, без лести; разбирайте каждую главу по структуре, темпу и аркам персонажей; указывайте на пробелы и направления доработки вместо похвалы; подкрепляйте каждое замечание цитатой из текста.",
  "settings.soul.overwriteConfirm": "Текущее содержимое будет заменено шаблоном. Продолжить?",
  "settings.soul.save": "Сохранить",
  "settings.soul.saved": "Душа сохранена.",
  "settings.soul.charCount": "{{count}} символов",
  "settings.soul.tooLong": "{{count}} символов — длинная душа может занять контекст модели",
  "novel.settings.tabSoul": "Душа",
  "novel.settings.soul.globalHint": "Если не задано, к роману применяется глобальная душа (Настройки → Душа).",
}
