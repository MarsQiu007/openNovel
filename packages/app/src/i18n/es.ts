export const dict = {
  ...
  "dialog.provider.opennovel.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.opennovel.tagline": "Modelos optimizados y fiables",
  "dialog.provider.opennovelGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} es un servicio local — no se necesita clave API. Déjalo vacío para conectar.",
  "provider.connect.apiKey.optionalPlaceholder": "Déjalo vacío (no se necesita clave)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.opennovelZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.opennovelZen.visit.prefix": "Visita ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenNovel.",
  ...
  "dialog.plugins.empty": "Plugins configurados en opennovel.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de OpenNovel se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Comprobando OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Comprobando OpenNovel en {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Actualizando OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Actualizando OpenNovel en {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Actualiza OpenNovel en {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Actualizar OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel está listo en {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel está listo.",
  "wsl.onboarding.installOpenNovelIn": "Instala OpenNovel en {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Instalar OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que OpenNovel pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenNovel.",
  ...
  "toast.update.description": "Una nueva versión de OpenNovel ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de OpenNovel",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (opennovel.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, OpenNovel no soporta autenticación MCP todavía.',
  ...
  "home.sessions.sidebar.unbound": "Chats globales",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.sync.tab": "Sincronización en la nube",
  "settings.sync.title": "Sincronización en la nube",
  "settings.sync.connection.section": "Conexión con el disco en la nube",
  "settings.sync.field.url": "URL del servidor",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "Dirección WebDAV de tu disco en la nube. Para Nutstore usa https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Nombre de usuario",
  "settings.sync.field.username.placeholder": "Cuenta WebDAV (correo electrónico)",
  "settings.sync.field.password": "Contraseña de aplicación",
  "settings.sync.field.password.description": "Nutstore requiere una contraseña de aplicación: genera una en la versión web en Configuración de cuenta → Seguridad.",
  "settings.sync.action.test": "Probar conexión",
  "settings.sync.action.testing": "Probando…",
  "settings.sync.action.save": "Guardar y conectar",
  "settings.sync.action.saving": "Conectando…",
  "settings.sync.action.disconnect": "Desconectar",
  "settings.sync.test.success": "Conexión correcta",
  "settings.sync.test.failed": "Error de conexión",
  "settings.sync.connected.account": "Cuenta",
  "settings.sync.disconnect.confirm.title": "Desconectar disco en la nube",
  "settings.sync.disconnect.confirm.message": "Esto elimina la conexión WebDAV guardada y la credencial de este dispositivo. Las instantáneas remotas se conservan.",
  "settings.sync.root.section": "Carpeta de sincronización",
  "settings.sync.root.description": "Todas las carpetas de proyecto bajo este directorio se sincronizan con el disco en la nube.",
  "settings.sync.root.notSet": "Sin definir",
  "settings.sync.root.choose": "Elegir carpeta",
  "settings.sync.projects.section": "Proyectos",
  "settings.sync.projects.empty": "Aún no hay proyectos. Define primero la carpeta de sincronización.",
  "settings.sync.projects.resolve": "Resolver",
  "settings.sync.state.in_sync": "Sincronizado",
  "settings.sync.state.local_ahead": "Cambios locales pendientes",
  "settings.sync.state.remote_ahead": "Actualizaciones remotas disponibles",
  "settings.sync.state.new_local": "Nuevo, se subirá",
  "settings.sync.state.new_remote": "Nuevo proyecto remoto, se descargará",
  "settings.sync.state.conflict": "Conflicto de sincronización",
  "settings.sync.state.pending_delete": "Eliminación pendiente",
  "settings.sync.lastSynced": "Última sincronización",
  "settings.sync.lastSynced.never": "Nunca",
  "settings.sync.action.sync": "Sincronizar ahora",
  "settings.sync.action.syncing": "Sincronizando…",
  "settings.sync.decision.pair.title": "Conflicto de nombre",
  "settings.sync.decision.pair.description":
    "«{{name}}» existe localmente y en el disco en la nube como proyectos distintos (remoto desde {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Ambos lados cambiaron",
  "settings.sync.decision.tie.description":
    "«{{name}}» se modificó en ambos lados casi al mismo tiempo. Elige cuál conservar.",
  "settings.sync.decision.delete.title": "Eliminar proyectos remotos",
  "settings.sync.decision.delete.description":
    "Estos proyectos se eliminaron localmente: {{names}}. ¿Eliminarlos también del disco en la nube?",
  "settings.sync.decision.keepLocal": "Conservar local",
  "settings.sync.decision.keepRemote": "Conservar remoto",
  "settings.sync.decision.keepBoth": "Conservar ambos",
  "settings.sync.decision.confirmDelete": "Eliminar de la nube",
  "settings.sync.decision.later": "Más tarde",
  "settings.sync.decision.backup.hint": "Tus datos locales se respaldan automáticamente antes de sobrescribirlos.",
  "settings.sync.auto.title": "Sincronización automática",
  "settings.sync.auto.description": "Descarga actualizaciones remotas al abrir un proyecto y sube los cambios locales periódicamente y al salir.",
  "settings.sync.toast.saved": "Disco en la nube conectado",
  "settings.sync.toast.saveFailed": "Error al conectar",
  "settings.sync.toast.disconnected": "Disco en la nube desconectado",
  "settings.sync.toast.disconnectFailed": "Error al desconectar",
  "settings.sync.toast.rootSet": "Carpeta de sincronización actualizada",
  "settings.sync.toast.rootFailed": "Error al definir la carpeta de sincronización",
  "settings.sync.toast.synced": "Sincronización completada",
  "settings.sync.toast.resolved": "Resuelto",
  "settings.sync.toast.syncFailed": "Error al sincronizar",
  "settings.sync.toast.upToDate": "Ya está actualizado",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integración con WSL",
  "settings.desktop.wsl.description": "Ejecutar el servidor OpenNovel dentro de WSL en Windows.",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve OpenNovel en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si OpenNovel sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de OpenNovel.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia OpenNovel",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de OpenNovel.",
  ...
  "novel.bookshelf.open": "Volver a la estantería",
  ...
  "settings.soul.description": "Escribe una persona inyectada como prompt del sistema en cada sesión de IA. Una novela con su propio alma anula esta alma global.",
  "settings.soul.placeholder": "p. ej. Eres «Laodu», un compañero de escritura mordaz pero confiable...",
  "settings.soul.templates": "Plantillas",
  "settings.soul.template.gentle.name": "Editor amable",
  "settings.soul.template.gentle.content": "Eres «Bianbian», un editor amable y paciente. Hablas con suavidad, animas más que criticas; al señalar problemas, primero afirmas los puntos fuertes y luego ofreces sugerencias con tacto. Al instar a escribir, lo haces con palabras cálidas.",
  "settings.soul.template.sharp.name": "Compañero mordaz",
  "settings.soul.template.sharp.content": "Eres «Laodu», un compañero de escritura mordaz pero confiable. Tus pullas son afiladas pero siempre dan en el blanco; cada consejo es profesional. Nunca sarcasmo sin sustancia. Al instar a escribir, eres sardónico pero tus sugerencias siempre son sólidas.",
  "settings.soul.template.critic.name": "Crítico serio",
  "settings.soul.template.critic.content": "Eres un crítico literario serio. Palabras precisas, sin halagos; revisa cada capítulo en estructura, ritmo y arcos de personaje; señala lagunas y vías de mejora en lugar de elogios; cita el texto para respaldar cada punto.",
  "settings.soul.overwriteConfirm": "El contenido actual será reemplazado por la plantilla. ¿Continuar?",
  "settings.soul.save": "Guardar",
  "settings.soul.saved": "Alma guardada.",
  "settings.soul.charCount": "{{count}} caracteres",
  "settings.soul.tooLong": "{{count}} caracteres — un alma larga puede ocupar el contexto del modelo",
  "novel.settings.tabSoul": "Alma",
  "novel.settings.soul.globalHint": "Si no se define, se aplica el alma global (Ajustes → Alma) a esta novela.",
}
