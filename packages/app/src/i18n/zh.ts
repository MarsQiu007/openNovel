...
export const dict = {
  ...
  "settings.sync.decision.pair.description":
    "本地和云盘上的「{{name}}」是两个不同的项目（远端来自 {{device}}，{{time}}）。",
  ...
  "novel.reader.addAnnotation": "添加批注",
  "novel.reader.annotationComment": "批注内容（必填）",
  "novel.reader.annotationSuggestion": "替换建议（可选）",
  "novel.reader.annotationOverlap": "该区域已有批注，可编辑现有批注补充说明",
  "novel.reader.annotationWarning": "该章节有 {count} 条未处理批注，建议先处理后修改正文",
  ...
  "novel.panel.characters.writeOutConfirm":
    "确定要让角色「{{name}}」退场吗？退场后后续章节不再安排出场，但历史章节中的提及仍然有效。",
  ...
  "novel.annotations.edit": "编辑",
  "novel.annotations.save": "保存",
  "novel.annotations.editComment": "批注内容",
  "novel.annotations.editSuggestion": "替换建议（可选）",
  "novel.annotations.tab.current": "当前",
  ...
  "novel.annotations.reactivate": "重新激活",
  "novel.annotations.manual": "手动处理",
  ...
  "settings.soul.description":
    "写一段人格文本，作为系统提示词注入所有 AI 会话；小说设定了自己的灵魂时会覆盖它。单本书的灵魂在「小说工作区 → 左侧设定 → 灵魂」中设置。",
  ...
  "settings.soul.template.gentle.content":
    "你是「编编」，一位温柔耐心的责编。说话轻声细语，多鼓励少批评；指出问题时先肯定优点，再委婉给出修改建议；催稿也只是温言提醒。",
  "settings.soul.template.sharp.name": "毒舌搭档",
  "settings.soul.template.sharp.content":
    "你是「老毒」，一个毒舌但靠谱的写作搭档。吐槽犀利、从不客气，但每条吐槽都切中要害；建议永远专业，绝不无的放矢；催稿时阴阳怪气但要点明确。",
  "settings.soul.template.critic.name": "严肃评论家",
  "settings.soul.template.critic.content":
    "你是一位严肃的文学评论家。用词精确，不苟言笑；从结构、节奏、人物弧光三个维度评审每一章；不夸奖，只指出差距与改进方向；引用原文佐证每个观点。",
