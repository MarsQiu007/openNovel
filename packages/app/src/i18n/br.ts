export const dict = {
  ...
  "dialog.provider.opennovel.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.opennovel.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.opennovelGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no OpenNovel.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Visite ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no OpenNovel.",
  ...
  // Local / self-hosted OpenAI-compatible provider (Ollama / LM Studio) fields
  "provider.connect.field.baseURL.label": "Base URL",
  "provider.connect.field.baseURL.placeholder": "http://localhost:11434/v1",
  "provider.connect.field.baseURL.description": "OpenAI-compatible endpoint of your local server. Ollama defaults to http://localhost:11434/v1.",
  ...
  "dialog.plugins.empty": "Plugins configurados em opennovel.json",
  ...
  "dialog.server.description": "Trocar para qual servidor OpenNovel este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Verificando o OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Verificando o OpenNovel em {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Atualizando o OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Atualizando o OpenNovel em {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Atualize o OpenNovel em {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Atualizar o OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "O OpenNovel está pronto em {{distro}}.",
  "wsl.onboarding.opennovelReady": "O OpenNovel está pronto.",
  "wsl.onboarding.installOpenNovelIn": "Instale o OpenNovel em {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Instalar o OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o OpenNovel possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O OpenNovel não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o OpenNovel novamente.",
  ...
  "toast.update.description": "Uma nova versão do OpenNovel ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do OpenNovel",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (opennovel.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: OpenNovel ainda não suporta autenticação MCP.',
  ...
  "home.sessions.sidebar.books": "Conversas por livro",
  "home.sessions.sidebar.newChat": "Nova conversa",
  "home.sessions.sidebar.openNovel": "Abrir livro",
  "home.sessions.sidebar.noChats": "Ainda não há conversas — clique no título para começar",
  "home.sessions.sidebar.empty": "Ainda não há livros",
  "home.sessions.sidebar.empty.description": "As conversas serão agrupadas por livro aqui quando você criar um.",
  "home.sessions.sidebar.untitled": "Sessão sem título",
  "home.sessions.sidebar.inSidebar": "As conversas de livros estão agrupadas na barra lateral esquerda.",
  "home.sessions.sidebar.collapse": "Recolher",
  "home.sessions.sidebar.archiveTitle": "Arquivar sessão",
  "home.sessions.sidebar.archiveWithChildren": "Esta sessão contém {{count}} sessão(ões) de subagente. Elas serão arquivadas juntas. Continuar?",
  "home.sessions.sidebar.subagent": "Sessão de subagente",
  "home.sessions.sidebar.unbound": "Conversas globais",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.sync.tab": "Sincronização na nuvem",
  "settings.sync.title": "Sincronização na nuvem",
  "settings.sync.connection.section": "Conexão com o drive na nuvem",
  "settings.sync.field.url": "URL do servidor",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "Endereço WebDAV do seu drive na nuvem. Para o Nutstore, use https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Nome de usuário",
  "settings.sync.field.username.placeholder": "Conta WebDAV (e-mail)",
  "settings.sync.field.password": "Senha de aplicativo",
  "settings.sync.field.password.description": "O Nutstore exige uma senha de aplicativo — gere uma na versão web em Configurações da conta → Segurança.",
  "settings.sync.action.test": "Testar conexão",
  "settings.sync.action.testing": "Testando…",
  "settings.sync.action.save": "Salvar e conectar",
  "settings.sync.action.saving": "Conectando…",
  "settings.sync.action.disconnect": "Desconectar",
  "settings.sync.test.success": "Conexão bem-sucedida",
  "settings.sync.test.failed": "Falha na conexão",
  "settings.sync.connected.account": "Conta",
  "settings.sync.disconnect.confirm.title": "Desconectar drive na nuvem",
  "settings.sync.disconnect.confirm.message": "Isso remove a conexão WebDAV salva e a credencial deste dispositivo. Os snapshots remotos são mantidos.",
  "settings.sync.root.section": "Pasta de sincronização",
  "settings.sync.root.description": "Todas as pastas de projeto neste diretório são sincronizadas com o drive na nuvem.",
  "settings.sync.root.notSet": "Não definida",
  "settings.sync.root.choose": "Escolher pasta",
  "settings.sync.projects.section": "Projetos",
  "settings.sync.projects.empty": "Ainda não há projetos. Defina primeiro a pasta de sincronização.",
  "settings.sync.projects.resolve": "Resolver",
  "settings.sync.state.in_sync": "Sincronizado",
  "settings.sync.state.local_ahead": "Alterações locais pendentes",
  "settings.sync.state.remote_ahead": "Atualizações remotas disponíveis",
  "settings.sync.state.new_local": "Novo, será enviado",
  "settings.sync.state.new_remote": "Novo projeto remoto, será baixado",
  "settings.sync.state.conflict": "Conflito de sincronização",
  "settings.sync.state.pending_delete": "Exclusão pendente",
  "settings.sync.lastSynced": "Última sincronização",
  "settings.sync.lastSynced.never": "Nunca",
  "settings.sync.action.sync": "Sincronizar agora",
  "settings.sync.action.syncing": "Sincronizando…",
  "settings.sync.decision.pair.title": "Conflito de nome",
  "settings.sync.decision.pair.description":
    "\"{{name}}\" existe localmente e no drive na nuvem como projetos diferentes (remoto de {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Ambos os lados foram alterados",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" foi alterado nos dois lados quase ao mesmo tempo. Escolha qual manter.",
  "settings.sync.decision.delete.title": "Excluir projetos remotos",
  "settings.sync.decision.delete.description":
    "Estes projetos foram excluídos localmente: {{names}}. Excluí-los também do drive na nuvem?",
  "settings.sync.decision.keepLocal": "Manter local",
  "settings.sync.decision.keepRemote": "Manter remoto",
  "settings.sync.decision.keepBoth": "Manter ambos",
  "settings.sync.decision.confirmDelete": "Excluir da nuvem",
  "settings.sync.decision.later": "Mais tarde",
  "settings.sync.decision.backup.hint": "Seus dados locais são copiados automaticamente antes da substituição.",
  "settings.sync.auto.title": "Sincronização automática",
  "settings.sync.auto.description": "Baixa atualizações remotas ao abrir um projeto e envia alterações locais periodicamente e ao sair.",
  "settings.sync.toast.saved": "Drive na nuvem conectado",
  "settings.sync.toast.saveFailed": "Falha ao conectar",
  "settings.sync.toast.disconnected": "Drive na nuvem desconectado",
  "settings.sync.toast.disconnectFailed": "Falha ao desconectar",
  "settings.sync.toast.rootSet": "Pasta de sincronização atualizada",
  "settings.sync.toast.rootFailed": "Falha ao definir a pasta de sincronização",
  "settings.sync.toast.synced": "Sincronização concluída",
  "settings.sync.toast.resolved": "Resolvido",
  "settings.sync.toast.syncFailed": "Falha ao sincronizar",
  "settings.sync.toast.upToDate": "Já está atualizado",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integração com WSL",
  "settings.desktop.wsl.description": "Executar o servidor OpenNovel dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do OpenNovel",
  "settings.general.row.outputLanguage.title": "Idioma de saída",
  "settings.general.row.outputLanguage.description":
    "Forçar o modelo a responder em um idioma específico em todas as sessões.",
  "settings.general.option.off": "Desligado (sem substituição)",
  ...
  "settings.general.row.appearance.description": "Personalize como o OpenNovel aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o OpenNovel segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o OpenNovel é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o OpenNovel iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do OpenNovel.",
  ...
  "novel.bookshelf.open": "Voltar à estante",
  ...
  "settings.soul.tab": "Alma",
  "settings.soul.description": "Escreva uma persona injetada como prompt de sistema em cada sessão de IA. Um romance com a sua própria alma substitui esta alma global.",
  "settings.soul.placeholder": "p. ex. Você é o «Laodu», um parceiro de escrita ácido, mas confiável...",
  "settings.soul.templates": "Modelos",
  "settings.soul.template.gentle.name": "Editor gentil",
  "settings.soul.template.gentle.content": "Você é «Bianbian», um editor gentil e paciente. Você fala suavemente, incentiva mais do que critica; ao apontar problemas, primeiro afirma os pontos fortes e depois oferece sugestões com tato. Ao motivar a escrita, fá-lo com palavras calorosas.",
  "settings.soul.template.sharp.name": "Parceiro ácido",
  "settings.soul.template.sharp.content": "Você é «Laodu», um parceiro de escrita ácido, mas confiável. Suas alfinetadas são cortantes, mas sempre certeiras; cada conselho é profissional. Nunca zomba sem substância. Ao motivar a escrita, você é sardônico, mas suas sugestões são sempre sólidas.",
  "settings.soul.template.critic.name": "Crítico sério",
  "settings.soul.template.critic.content": "Você é um crítico literário sério. Palavras precisas, sem bajulação; analise cada capítulo quanto a estrutura, ritmo e arcos de personagem; aponte lacunas e direções de melhoria em vez de elogios; cite o texto para embasar cada ponto.",
  "settings.soul.overwriteConfirm": "O conteúdo atual será substituído pelo modelo. Continuar?",
  "settings.soul.save": "Salvar",
  "settings.soul.saved": "Alma salva.",
  "settings.soul.charCount": "{{count}} caracteres",
  "settings.soul.tooLong": "{{count}} caracteres — uma alma longa pode ocupar o contexto do modelo",
  "novel.settings.tabSoul": "Alma",
  "novel.settings.soul.globalHint": "Se não definida, aplica-se a alma global (Configurações → Alma) a este romance.",
}
