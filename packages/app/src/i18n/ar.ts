export const dict = {
  ...
  "dialog.provider.opennovel.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.opennovel.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.opennovelGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenNovel.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "قم بزيارة ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في OpenNovel.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في opennovel.json",
  ...
  "dialog.server.description": "تبديل خادم OpenNovel الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpenNovel": "جارٍ التحقق من OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "جارٍ التحقق من OpenNovel في {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "جارٍ تحديث OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "جارٍ تحديث OpenNovel في {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "حدّث OpenNovel في {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "تحديث OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel جاهز في {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel جاهز.",
  "wsl.onboarding.installOpenNovelIn": "ثبّت OpenNovel في {{distro}}.",
  "wsl.onboarding.installOpenNovel": "تثبيت OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن OpenNovel من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على OpenNovel التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح OpenNovel.",
  ...
  "toast.update.description": "نسخة جديدة من OpenNovel ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق OpenNovel",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (opennovel.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن OpenNovel لا يدعم مصادقة MCP بعد.',
  ...
  "home.sessions.sidebar.books": "محادثات الكتب",
  "home.sessions.sidebar.newChat": "محادثة جديدة",
  "home.sessions.sidebar.openNovel": "فتح الكتاب",
  "home.sessions.sidebar.noChats": "لا توجد محادثات بعد — انقر على العنوان للبدء",
  "home.sessions.sidebar.empty": "لا توجد كتب بعد",
  "home.sessions.sidebar.empty.description": "سيتم تجميع المحادثات حسب الكتاب هنا بمجرد إنشائك واحداً.",
  "home.sessions.sidebar.untitled": "جلسة بدون عنوان",
  "home.sessions.sidebar.inSidebar": "محادثات الكتب مجمعة في الشريط الجانبي الأيسر.",
  ...
  "home.sessions.sidebar.unbound": "محادثات عامة",
  ...
  "sidebar.gettingStarted.line1": "يتضمن OpenNovel نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.sync.tab": "المزامنة السحابية",
  "settings.sync.title": "المزامنة السحابية",
  "settings.sync.connection.section": "الاتصال بالقرص السحابي",
  "settings.sync.field.url": "عنوان الخادم",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "عنوان WebDAV الخاص بقرصك السحابي. بالنسبة إلى Nutstore استخدم https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "اسم المستخدم",
  "settings.sync.field.username.placeholder": "حساب WebDAV (البريد الإلكتروني)",
  "settings.sync.field.password": "كلمة مرور التطبيق",
  "settings.sync.field.password.description": "يتطلب Nutstore كلمة مرور تطبيق — أنشئ واحدة في النسخة الويب ضمن إعدادات الحساب ← الأمان.",
  "settings.sync.action.test": "اختبار الاتصال",
  "settings.sync.action.testing": "جارٍ الاختبار…",
  "settings.sync.action.save": "حفظ والاتصال",
  "settings.sync.action.saving": "جارٍ الاتصال…",
  "settings.sync.action.disconnect": "قطع الاتصال",
  "settings.sync.test.success": "تم الاتصال بنجاح",
  "settings.sync.test.failed": "فشل الاتصال",
  "settings.sync.connected.account": "الحساب",
  "settings.sync.disconnect.confirm.title": "قطع الاتصال بالقرص السحابي",
  "settings.sync.disconnect.confirm.message": "سيؤدي هذا إلى إزالة اتصال WebDAV المحفوظ وبيانات الاعتماد من هذا الجهاز. تبقى اللقطات البعيدة محفوظة.",
  "settings.sync.root.section": "مجلد المزامنة",
  "settings.sync.root.description": "تتم مزامنة جميع مجلدات المشاريع الموجودة ضمن هذا الدليل مع القرص السحابي.",
  "settings.sync.root.notSet": "غير مُعيَّن",
  "settings.sync.root.choose": "اختيار مجلد",
  "settings.sync.projects.section": "المشاريع",
  "settings.sync.projects.empty": "لا توجد مشاريع بعد. عيّن مجلد المزامنة أولًا.",
  "settings.sync.projects.resolve": "معالجة",
  "settings.sync.state.in_sync": "متزامن",
  "settings.sync.state.local_ahead": "توجد تغييرات محلية معلقة",
  "settings.sync.state.remote_ahead": "توجد تحديثات بعيدة متاحة",
  "settings.sync.state.new_local": "جديد، سيتم رفعه",
  "settings.sync.state.new_remote": "مشروع بعيد جديد، سيتم تنزيله",
  "settings.sync.state.conflict": "تعارض في المزامنة",
  "settings.sync.state.pending_delete": "بانتظار الحذف",
  "settings.sync.lastSynced": "آخر مزامنة",
  "settings.sync.lastSynced.never": "أبدًا",
  "settings.sync.action.sync": "مزامنة الآن",
  "settings.sync.action.syncing": "جارٍ المزامنة…",
  "settings.sync.decision.pair.title": "تعارض في الاسم",
  "settings.sync.decision.pair.description":
    "«{{name}}» موجود محليًا وعلى القرص السحابي كمشروعين مختلفين (البعيد من {{device}}، {{time}}).",
  "settings.sync.decision.tie.title": "تغيّر كلا الجانبين",
  "settings.sync.decision.tie.description":
    "تم تعديل «{{name}}» على كلا الجانبين في وقت متقارب. اختر أي جانب تريد الاحتفاظ به.",
  "settings.sync.decision.delete.title": "حذف المشاريع البعيدة",
  "settings.sync.decision.delete.description":
    "تم حذف هذه المشاريع محليًا: {{names}}. هل تريد حذفها من القرص السحابي أيضًا؟",
  "settings.sync.decision.keepLocal": "الاحتفاظ بالمحلي",
  "settings.sync.decision.keepRemote": "الاحتفاظ بالبعيد",
  "settings.sync.decision.keepBoth": "الاحتفاظ بكليهما",
  "settings.sync.decision.confirmDelete": "الحذف من السحابة",
  "settings.sync.decision.later": "لاحقًا",
  "settings.sync.decision.backup.hint": "يتم نسخ بياناتك المحلية احتياطيًا تلقائيًا قبل الكتابة فوقها.",
  "settings.sync.auto.title": "المزامنة التلقائية",
  "settings.sync.auto.description": "سحب التحديثات البعيدة عند فتح مشروع، ودفع التغييرات المحلية دوريًا وعند الخروج.",
  "settings.sync.toast.saved": "تم الاتصال بالقرص السحابي",
  "settings.sync.toast.saveFailed": "فشل الاتصال",
  "settings.sync.toast.disconnected": "تم قطع الاتصال بالقرص السحابي",
  "settings.sync.toast.disconnectFailed": "فشل قطع الاتصال",
  "settings.sync.toast.rootSet": "تم تحديث مجلد المزامنة",
  "settings.sync.toast.rootFailed": "فشل تعيين مجلد المزامنة",
  "settings.sync.toast.synced": "اكتملت المزامنة",
  "settings.sync.toast.resolved": "تمت المعالجة",
  "settings.sync.toast.syncFailed": "فشلت المزامنة",
  "settings.sync.toast.upToDate": "محدّث بالفعل",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "تكامل WSL",
  "settings.desktop.wsl.description": "تشغيل خادم OpenNovel داخل WSL على Windows.",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور OpenNovel على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان OpenNovel يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة OpenNovel.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل OpenNovel",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من OpenNovel.",
  ...
  "novel.relations.empty": "No relationships yet.",
  ...
  "novel.map.tab": "Map",
  "novel.map.title": "Map",
  "novel.map.comingSoon": "The map is coming soon.",
