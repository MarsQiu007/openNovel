...
export const dict = {
  ...
  "dialog.provider.opennovel.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.opennovel.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.opennovelGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenNovel zu nutzen.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} ist ein lokaler Dienst — kein API-Schlüssel erforderlich. Leer lassen, um zu verbinden.",
  "provider.connect.apiKey.optionalPlaceholder": "Leer lassen (kein Schlüssel erforderlich)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in OpenNovel zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in OpenNovel zu nutzen.",
  ...
  "dialog.plugins.empty": "In opennovel.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den OpenNovel-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpenNovel": "OpenNovel wird geprüft...",
  "wsl.onboarding.checkingOpenNovelIn": "OpenNovel in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpenNovel": "OpenNovel wird aktualisiert...",
  "wsl.onboarding.updatingOpenNovelIn": "OpenNovel in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpenNovelIn": "Aktualisieren Sie OpenNovel in {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "OpenNovel aktualisieren",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel ist in {{distro}} bereit.",
  "wsl.onboarding.opennovelReady": "OpenNovel ist bereit.",
  "wsl.onboarding.installOpenNovelIn": "Installieren Sie OpenNovel in {{distro}}.",
  "wsl.onboarding.installOpenNovel": "OpenNovel installieren",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenNovel einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenNovel erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenNovel ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem OpenNovel-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (opennovel.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenNovel unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "OpenNovel enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.sync.connection.section": "Cloud-Laufwerk-Verbindung",
  "settings.sync.field.url": "Server-URL",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV-Adresse deines Cloud-Laufwerks. Für Nutstore: https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Benutzername",
  "settings.sync.field.username.placeholder": "WebDAV-Konto (E-Mail)",
  "settings.sync.field.password": "App-Passwort",
  "settings.sync.field.password.description": "Nutstore erfordert ein App-Passwort — erstelle eines in der Web-Version unter Kontoeinstellungen → Sicherheit.",
  "settings.sync.action.test": "Verbindung testen",
  "settings.sync.action.testing": "Wird getestet…",
  "settings.sync.action.save": "Speichern und verbinden",
  "settings.sync.action.saving": "Wird verbunden…",
  "settings.sync.action.disconnect": "Trennen",
  "settings.sync.test.success": "Verbindung erfolgreich",
  "settings.sync.test.failed": "Verbindung fehlgeschlagen",
  "settings.sync.connected.account": "Konto",
  "settings.sync.disconnect.confirm.title": "Cloud-Laufwerk trennen",
  "settings.sync.disconnect.confirm.message": "Dadurch werden die gespeicherte WebDAV-Verbindung und die Zugangsdaten von diesem Gerät entfernt. Remote-Snapshots bleiben erhalten.",
  "settings.sync.root.section": "Synchronisierungsordner",
  "settings.sync.root.description": "Alle Projektordner in diesem Verzeichnis werden mit dem Cloud-Laufwerk synchronisiert.",
  "settings.sync.root.notSet": "Nicht festgelegt",
  "settings.sync.root.choose": "Ordner wählen",
  "settings.sync.projects.section": "Projekte",
  "settings.sync.projects.empty": "Noch keine Projekte. Lege zuerst den Synchronisierungsordner fest.",
  "settings.sync.projects.resolve": "Auflösen",
  "settings.sync.state.in_sync": "Synchronisiert",
  "settings.sync.state.local_ahead": "Lokale Änderungen ausstehend",
  "settings.sync.state.remote_ahead": "Remote-Updates verfügbar",
  "settings.sync.state.new_local": "Neu, wird hochgeladen",
  "settings.sync.state.new_remote": "Neu auf Remote, wird heruntergeladen",
  "settings.sync.state.conflict": "Sync-Konflikt",
  "settings.sync.state.pending_delete": "Löschung ausstehend",
  "settings.sync.lastSynced": "Zuletzt synchronisiert",
  "settings.sync.lastSynced.never": "Nie",
  "settings.sync.action.sync": "Jetzt synchronisieren",
  "settings.sync.action.syncing": "Wird synchronisiert…",
  "settings.sync.decision.pair.title": "Namenskonflikt",
  "settings.sync.decision.pair.description":
    "„{{name}}“ existiert lokal und auf dem Cloud-Laufwerk als unterschiedliche Projekte (Remote von {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Beide Seiten geändert",
  "settings.sync.decision.tie.description":
    "„{{name}}“ wurde auf beiden Seiten fast gleichzeitig geändert. Wähle, welche Seite behalten werden soll.",
  "settings.sync.decision.delete.title": "Remote-Projekte löschen",
  "settings.sync.decision.delete.description":
    "Diese Projekte wurden lokal gelöscht: {{names}}. Sollen sie auch vom Cloud-Laufwerk gelöscht werden?",
  "settings.sync.decision.keepLocal": "Lokal behalten",
  "settings.sync.decision.keepRemote": "Remote behalten",
  "settings.sync.decision.keepBoth": "Beide behalten",
  "settings.sync.decision.confirmDelete": "Aus der Cloud löschen",
  "settings.sync.decision.later": "Später",
  "settings.sync.decision.backup.hint": "Deine lokalen Daten werden vor dem Überschreiben automatisch gesichert.",
  "settings.sync.auto.title": "Automatische Synchronisation",
  "settings.sync.auto.description": "Lädt Remote-Updates beim Öffnen eines Projekts und pusht lokale Änderungen regelmäßig sowie beim Beenden.",
  "settings.sync.toast.saved": "Cloud-Laufwerk verbunden",
  "settings.sync.toast.saveFailed": "Verbindung fehlgeschlagen",
  "settings.sync.toast.disconnected": "Cloud-Laufwerk getrennt",
  "settings.sync.toast.disconnectFailed": "Trennen fehlgeschlagen",
  "settings.sync.toast.rootSet": "Synchronisierungsordner aktualisiert",
  "settings.sync.toast.rootFailed": "Synchronisierungsordner konnte nicht festgelegt werden",
  "settings.sync.toast.synced": "Synchronisierung abgeschlossen",
  "settings.sync.toast.resolved": "Aufgelöst",
  "settings.sync.toast.syncFailed": "Synchronisierung fehlgeschlagen",
  "settings.sync.toast.upToDate": "Bereits aktuell",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-Integration",
  "settings.desktop.wsl.description": "OpenNovel-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenNovel ändern",
  "settings.general.row.outputLanguage.title": "Ausgabesprache",
  "settings.general.row.outputLanguage.description":
    "Das Modell zwingen, in allen Sitzungen in einer bestimmten Sprache zu antworten.",
  "settings.general.option.off": "Aus (keine Überschreibung)",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenNovel auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenNovel dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenNovel anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenNovel automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von OpenNovel.",
  ...
  "novel.bookshelf.open": "Zurück zum Bücherregal",
  ...
  "settings.soul.tab": "Seele",
  "settings.soul.description": "Verfasse eine Persönlichkeit, die als System-Prompt in jede KI-Sitzung injiziert wird. Ein Roman mit einer eigenen Seele überschreibt diese globale Einstellung.",
  "settings.soul.placeholder": "z. B. Du bist „Laodu“, ein scharfzüngiger, aber verlässlicher Schreibpartner ...",
  "settings.soul.templates": "Vorlagen",
  "settings.soul.template.gentle.name": "Sanfter Lektor",
  "settings.soul.template.gentle.content": "Du bist „Bianbian“, ein sanfter und geduldiger Lektor. Du sprichst leise, ermutigst mehr als dass du kritisierst; wenn du auf Probleme hinweist, bestätigst du zuerst die Stärken und gibst dann taktvoll Vorschläge. Wenn du zum Schreiben animierst, tust du dies mit warmen Worten.",
  "settings.soul.template.sharp.name": "Scharfzüngiger Partner",
  "settings.soul.template.sharp.content": "Du bist „Laodu“, ein scharfzüngiger, aber verlässlicher Schreibpartner. Deine Seitenhiebe sind bissig, treffen aber immer den Kern; jeder Ratschlag ist professionell. Du stänkerst nie ohne Substanz. Wenn du zum Schreiben animierst, bist du sardonisch, aber deine Vorschläge sind immer fundiert.",
  "settings.soul.template.critic.name": "Ernster Kritiker",
  "settings.soul.template.critic.content": "Du bist ein ernster Literaturkritiker. Präzise Wortwahl, keine Schmeicheleien; beurteile jedes Kapitel nach Struktur, Tempo und Charakterentwicklung; zeige Lücken und Verbesserungsrichtungen auf, statt zu loben; belege jeden Punkt mit Zitaten aus dem Text.",
  "settings.soul.overwriteConfirm": "Der aktuelle Inhalt wird durch die Vorlage ersetzt. Fortfahren?",
  "settings.soul.save": "Speichern",
  "settings.soul.saved": "Seele gespeichert.",
  "settings.soul.charCount": "{{count}} Zeichen",
  "settings.soul.tooLong": "{{count}} Zeichen — lange Seelen können den Modellkontext überfüllen",
  "novel.settings.tabSoul": "Seele",
  "novel.settings.soul.globalHint": "Wenn nicht festgelegt, gilt für diesen Roman die globale Seele (Einstellungen → Seele).",
