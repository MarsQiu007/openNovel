export const dict = {
  ...
  "dialog.provider.opennovel.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.opennovel.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.opennovelGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenNovel-u.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} je lokalna usluga — nije potreban API ključ. Ostavi prazno za povezivanje.",
  "provider.connect.apiKey.optionalPlaceholder": "Ostavi prazno (ključ nije potreban)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Posjeti ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenNovel-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenNovel-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u opennovel.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenNovel server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Provjera OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Provjera OpenNovel u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Ažuriranje OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Ažuriranje OpenNovel u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Ažuriraj OpenNovel u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Ažuriraj OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel je spreman.",
  "wsl.onboarding.installOpenNovelIn": "Instaliraj OpenNovel u distribuciji {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Instaliraj OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi OpenNovel mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenNovel.",
  ...
  "toast.update.description": "Nova verzija OpenNovel-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenNovel timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (opennovel.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenNovel još ne podržava MCP autentifikaciju.',
  ...
  "home.sessions.sidebar.unbound": "Globalni razgovori",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.sync.tab": "Sinhronizacija u oblaku",
  "settings.sync.title": "Sinhronizacija u oblaku",
  "settings.sync.connection.section": "Veza s diskom u oblaku",
  "settings.sync.field.url": "URL servera",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV adresa vašeg diska u oblaku. Za Nutstore koristite https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Korisničko ime",
  "settings.sync.field.username.placeholder": "WebDAV račun (e-pošta)",
  "settings.sync.field.password": "Lozinka aplikacije",
  "settings.sync.field.password.description": "Nutstore zahtijeva lozinku aplikacije — generišite je u web verziji pod Postavke računa → Sigurnost.",
  "settings.sync.action.test": "Testiraj vezu",
  "settings.sync.action.testing": "Testiranje…",
  "settings.sync.action.save": "Sačuvaj i poveži",
  "settings.sync.action.saving": "Povezivanje…",
  "settings.sync.action.disconnect": "Prekini vezu",
  "settings.sync.test.success": "Veza uspješna",
  "settings.sync.test.failed": "Veza nije uspjela",
  "settings.sync.connected.account": "Račun",
  "settings.sync.disconnect.confirm.title": "Prekini vezu s diskom u oblaku",
  "settings.sync.disconnect.confirm.message": "Ovo uklanja sačuvanu WebDAV vezu i kredencijale s ovog uređaja. Udaljeni snimci se zadržavaju.",
  "settings.sync.root.section": "Mapa sinhronizacije",
  "settings.sync.root.description": "Sve mape projekata u ovom direktoriju sinhroniziraju se s diskom u oblaku.",
  "settings.sync.root.notSet": "Nije postavljeno",
  "settings.sync.root.choose": "Odaberi mapu",
  "settings.sync.projects.section": "Projekti",
  "settings.sync.projects.empty": "Još nema projekata. Prvo postavite mapu sinhronizacije.",
  "settings.sync.projects.resolve": "Riješi",
  "settings.sync.state.in_sync": "Sinhronizirano",
  "settings.sync.state.local_ahead": "Lokalne izmjene na čekanju",
  "settings.sync.state.remote_ahead": "Dostupna udaljena ažuriranja",
  "settings.sync.state.new_local": "Novo, bit će poslano",
  "settings.sync.state.new_remote": "Novi udaljeni projekt, bit će preuzet",
  "settings.sync.state.conflict": "Sukob sinhronizacije",
  "settings.sync.state.pending_delete": "Čeka brisanje",
  "settings.sync.lastSynced": "Zadnja sinhronizacija",
  "settings.sync.lastSynced.never": "Nikad",
  "settings.sync.action.sync": "Sinhroniziraj odmah",
  "settings.sync.action.syncing": "Sinhronizacija u toku…",
  "settings.sync.decision.pair.title": "Sukob naziva",
  "settings.sync.decision.pair.description":
    "\"{{name}}\" postoji lokalno i na disku u oblaku kao različiti projekti (udaljeni s uređaja {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Obje strane izmijenjene",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" je izmijenjen na obje strane gotovo istovremeno. Odaberite koju stranu zadržati.",
  "settings.sync.decision.delete.title": "Izbriši udaljene projekte",
  "settings.sync.decision.delete.description":
    "Ovi projekti su lokalno izbrisani: {{names}}. Izbrisati ih i s diska u oblaku?",
  "settings.sync.decision.keepLocal": "Zadrži lokalno",
  "settings.sync.decision.keepRemote": "Zadrži udaljeno",
  "settings.sync.decision.keepBoth": "Zadrži oboje",
  "settings.sync.decision.confirmDelete": "Izbriši iz oblaka",
  "settings.sync.decision.later": "Kasnije",
  "settings.sync.decision.backup.hint": "Vaši lokalni podaci se automatski sigurnosno kopiraju prije prepisivanja.",
  "settings.sync.auto.title": "Automatska sinhronizacija",
  "settings.sync.auto.description": "Preuzima udaljena ažuriranja pri otvaranju projekta i periodično te pri izlazu šalje lokalne izmjene.",
  "settings.sync.toast.saved": "Disk u oblaku povezan",
  "settings.sync.toast.saveFailed": "Povezivanje nije uspjelo",
  "settings.sync.toast.disconnected": "Veza s diskom u oblaku prekinuta",
  "settings.sync.toast.disconnectFailed": "Prekid veze nije uspio",
  "settings.sync.toast.rootSet": "Mapa sinhronizacije ažurirana",
  "settings.sync.toast.rootFailed": "Postavljanje mape sinhronizacije nije uspjelo",
  "settings.sync.toast.synced": "Sinhronizacija završena",
  "settings.sync.toast.resolved": "Riješeno",
  "settings.sync.toast.syncFailed": "Sinhronizacija nije uspjela",
  "settings.sync.toast.upToDate": "Već je ažurno",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integracija",
  "settings.desktop.wsl.description": "Pokreni OpenNovel server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako OpenNovel izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenNovel prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenNovel-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenNovel pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenNovel-a.",
