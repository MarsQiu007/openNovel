export const dict = {
  ...
  "novel.reader.addAnnotation": "Add annotation",
  "novel.reader.annotationComment": "Comment (required)",
  "novel.reader.annotationSuggestion": "Suggested replacement (optional)",
  "novel.reader.annotationOverlap": "This area already has an annotation. Edit the existing one to add details.",
  "novel.reader.annotationWarning": "This chapter has {count} unresolved annotations. Consider resolving them before editing.",
  ...
  "novel.panel.structure": "Structure",
  "novel.panel.annotations": "Annotations",
  "novel.panel.canvas": "Canvas",

  "novel.chapter.label": "Ch.{{order}}",
  "novel.common.completed": "Completed",

  "novel.structure.arcType.narrative": "Main Plot",
  "novel.structure.arcType.character": "Character Arc",
  "novel.structure.arcType.subplot": "Subplot",
  "novel.structure.arcStatus.planned": "Planned",
  "novel.structure.arcStatus.active": "Active",
  "novel.structure.arcStatus.completed": "Completed",
  "novel.structure.arcStatus.abandoned": "Abandoned",
  "novel.structure.beatKind.setup": "Setup",
  "novel.structure.beatKind.rising": "Rising",
  "novel.structure.beatKind.turn": "Turn",
  "novel.structure.beatKind.midpoint": "Midpoint",
  "novel.structure.beatKind.crisis": "Crisis",
  "novel.structure.beatKind.climax": "Climax",
  "novel.structure.beatKind.resolution": "Resolution",
  "novel.structure.beatKind.note": "Note",
  "novel.structure.editorial": "Editorial",
  "novel.structure.editorial.run": "Run Review",
  "novel.structure.editorial.recommendations": "{{count}} recommendations",
  "novel.structure.arcs": "Story Arcs",
  "novel.structure.arcs.add": "+ New",
  "novel.structure.arcs.create": "Create",
  "novel.structure.arcs.titlePlaceholder": "Arc title",
  "novel.structure.arcs.empty": "No arcs yet. Click + New to start planning.",
  "novel.structure.arcs.planned": "Planned: Ch.{{start}}-{{end}}",
  "novel.structure.beat.titlePlaceholder": "Beat title",
  "novel.structure.beat.add": "Add",
  "novel.structure.beat.addToArc": "+ Add Beat",
  "novel.structure.review.title": "{{title}} - Retrospective",
  "novel.structure.review.round": "Round {{round}}",
  "novel.structure.review.strengths": "Strengths:",
  "novel.structure.review.weaknesses": "Weaknesses:",

  "novel.annotations.status.open": "Open",
  "novel.annotations.status.resolved": "Resolved",
  "novel.annotations.status.wontfix": "Won't Fix",
  "novel.annotations.status.applied": "Applied",
  "novel.annotations.filter.all": "All",
  "novel.annotations.empty": "No annotations yet",
  "novel.annotations.polish": "Polish",
  "novel.annotations.suggestion": "Suggestion:",
  "novel.annotations.apply": "Apply",
  "novel.annotations.resolve": "Resolve",
  "novel.annotations.dismiss": "Dismiss",
  "novel.annotations.reopen": "Reopen",
  "novel.annotations.edit": "Edit",
  "novel.annotations.save": "Save",
  "novel.annotations.editComment": "Comment",
  "novel.annotations.editSuggestion": "Suggested replacement (optional)",
  "novel.annotations.tab.current": "Current",
  ...
  "novel.annotations.reactivate": "Reactivate",
  "novel.annotations.manual": "Manual",

  "novel.canvas.title": "Outline Canvas",
  "novel.canvas.reset": "Reset Layout",
