...
export const dict = {
  ...
  "dialog.provider.opennovel.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.opennovel.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.opennovelGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} er en lokal tjeneste — ingen API-nøkkel nødvendig. La feltet stå tomt for å koble til.",
  "provider.connect.apiKey.optionalPlaceholder": "La feltet stå tomt (ingen nøkkel nødvendig)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Besøk ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenNovel.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i opennovel.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenNovel-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenNovel ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenNovel-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (opennovel.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenNovel ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenNovel inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.sync.tab": "Skysynkronisering",
  "settings.sync.title": "Skysynkronisering",
  "settings.sync.connection.section": "Tilkobling til skydisk",
  "settings.sync.field.url": "Server-URL",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "WebDAV-adressen til skydisken din. For Nutstore bruker du https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Brukernavn",
  "settings.sync.field.username.placeholder": "WebDAV-konto (e-post)",
  "settings.sync.field.password": "App-passord",
  "settings.sync.field.password.description": "Nutstore krever et app-passord — generer ett i nettversjonen under Kontoinnstillinger → Sikkerhet.",
  "settings.sync.action.test": "Test tilkobling",
  "settings.sync.action.testing": "Tester…",
  "settings.sync.action.save": "Lagre og koble til",
  "settings.sync.action.saving": "Kobler til…",
  "settings.sync.action.disconnect": "Koble fra",
  "settings.sync.test.success": "Tilkobling vellykket",
  "settings.sync.test.failed": "Tilkobling mislyktes",
  "settings.sync.connected.account": "Konto",
  "settings.sync.disconnect.confirm.title": "Koble fra skydisk",
  "settings.sync.disconnect.confirm.message": "Dette fjerner den lagrede WebDAV-tilkoblingen og legitimasjonen fra denne enheten. Eksterne øyeblikksbilder beholdes.",
  "settings.sync.root.section": "Synkroniseringsmappe",
  "settings.sync.root.description": "Alle prosjektmapper under denne katalogen synkroniseres med skydisken.",
  "settings.sync.root.notSet": "Ikke angitt",
  "settings.sync.root.choose": "Velg mappe",
  "settings.sync.projects.section": "Prosjekter",
  "settings.sync.projects.empty": "Ingen prosjekter ennå. Angi synkroniseringsmappen først.",
  "settings.sync.projects.resolve": "Løs",
  "settings.sync.state.in_sync": "Synkronisert",
  "settings.sync.state.local_ahead": "Lokale endringer venter",
  "settings.sync.state.remote_ahead": "Eksterne oppdateringer tilgjengelig",
  "settings.sync.state.new_local": "Nytt, lastes opp",
  "settings.sync.state.new_remote": "Nytt eksternt prosjekt, lastes ned",
  "settings.sync.state.conflict": "Synkroniseringskonflikt",
  "settings.sync.state.pending_delete": "Venter på sletting",
  "settings.sync.lastSynced": "Sist synkronisert",
  "settings.sync.lastSynced.never": "Aldri",
  "settings.sync.action.sync": "Synkroniser nå",
  "settings.sync.action.syncing": "Synkroniserer…",
  "settings.sync.decision.pair.title": "Navnekonflikt",
  "settings.sync.decision.pair.description":
    "\"{{name}}\" finnes lokalt og på skydisken som to forskjellige prosjekter (eksternt fra {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Begge sider endret",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" ble endret på begge sider nesten samtidig. Velg hvilken side som skal beholdes.",
  "settings.sync.decision.delete.title": "Slett eksterne prosjekter",
  "settings.sync.decision.delete.description":
    "Disse prosjektene ble slettet lokalt: {{names}}. Vil du også slette dem fra skydisken?",
  "settings.sync.decision.keepLocal": "Behold lokal",
  "settings.sync.decision.keepRemote": "Behold ekstern",
  "settings.sync.decision.keepBoth": "Behold begge",
  "settings.sync.decision.confirmDelete": "Slett fra skyen",
  "settings.sync.decision.later": "Senere",
  "settings.sync.decision.backup.hint": "De lokale dataene dine sikkerhetskopieres automatisk før overskriving.",
  "settings.sync.auto.title": "Automatisk synkronisering",
  "settings.sync.auto.description": "Henter eksterne oppdateringer når et prosjekt åpnes, og pusher lokale endringer periodisk og ved avslutning.",
  "settings.sync.toast.saved": "Skydisk tilkoblet",
  "settings.sync.toast.saveFailed": "Tilkobling mislyktes",
  "settings.sync.toast.disconnected": "Skydisk frakoblet",
  "settings.sync.toast.disconnectFailed": "Frakobling mislyktes",
  "settings.sync.toast.rootSet": "Synkroniseringsmappe oppdatert",
  "settings.sync.toast.rootFailed": "Kunne ikke angi synkroniseringsmappe",
  "settings.sync.toast.synced": "Synkronisering fullført",
  "settings.sync.toast.resolved": "Løst",
  "settings.sync.toast.syncFailed": "Synkronisering mislyktes",
  "settings.sync.toast.upToDate": "Allerede oppdatert",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integrasjon",
  "settings.desktop.wsl.description": "Kjør OpenNovel-serveren i WSL på Windows.",
  ...
  "settings.general.row.colorScheme.description": "Velg om OpenNovel skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenNovel er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenNovel starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenNovel.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Sjekker OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Sjekker OpenNovel i {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Oppdaterer OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Oppdaterer OpenNovel i {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Oppdater OpenNovel i {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Oppdater OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel er klar i {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel er klar.",
  "wsl.onboarding.installOpenNovelIn": "Installer OpenNovel i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før OpenNovel kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenNovel på nytt.",
  ...
  "novel.bookshelf.open": "Tilbake til bokhyllen",
