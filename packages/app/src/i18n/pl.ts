export const dict = {
  ...
  "dialog.provider.opennovel.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.opennovel.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.opennovelGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenNovel.",
  ...
  "provider.connect.apiKey.optionalDescription":
    "{{provider}} to usługa lokalna — klucz API nie jest wymagany. Pozostaw puste, aby połączyć.",
  "provider.connect.apiKey.optionalPlaceholder": "Pozostaw puste (klucz nie jest wymagany)",
  "provider.connect.opennovelZen.line1":
    "OpenNovel Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.opennovelZen.visit.prefix": "Odwiedź ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenNovel.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenNovel.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w opennovel.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenNovel, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpenNovel": "Sprawdzanie OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "Sprawdzanie OpenNovel w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "Aktualizowanie OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "Aktualizowanie OpenNovel w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "Zaktualizuj OpenNovel w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "Zaktualizuj OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opennovelReady": "OpenNovel jest gotowy.",
  "wsl.onboarding.installOpenNovelIn": "Zainstaluj OpenNovel w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpenNovel": "Zainstaluj OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "OpenNovel nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenNovel będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenNovel.",
  ...
  "toast.update.description": "Nowa wersja OpenNovel ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenNovel",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (opennovel.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenNovel nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "home.sessions.sidebar.subagent": "Sesja subagenta",
  "home.sessions.sidebar.unbound": "Czaty globalne",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.sync.tab": "Synchronizacja w chmurze",
  "settings.sync.title": "Synchronizacja w chmurze",
  "settings.sync.connection.section": "Połączenie z dyskiem w chmurze",
  "settings.sync.field.url": "Adres URL serwera",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "Adres WebDAV Twojego dysku w chmurze. Dla Nutstore użyj https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "Nazwa użytkownika",
  "settings.sync.field.username.placeholder": "Konto WebDAV (e-mail)",
  "settings.sync.field.password": "Hasło aplikacji",
  "settings.sync.field.password.description": "Nutstore wymaga hasła aplikacji — wygeneruj je w wersji internetowej w Ustawieniach konta → Bezpieczeństwo.",
  "settings.sync.action.test": "Testuj połączenie",
  "settings.sync.action.testing": "Testowanie…",
  "settings.sync.action.save": "Zapisz i połącz",
  "settings.sync.action.saving": "Łączenie…",
  "settings.sync.action.disconnect": "Rozłącz",
  "settings.sync.test.success": "Połączenie udane",
  "settings.sync.test.failed": "Połączenie nieudane",
  "settings.sync.connected.account": "Konto",
  "settings.sync.disconnect.confirm.title": "Rozłącz dysk w chmurze",
  "settings.sync.disconnect.confirm.message": "Spowoduje to usunięcie zapisanego połączenia WebDAV i poświadczeń z tego urządzenia. Zdalne migawki zostaną zachowane.",
  "settings.sync.root.section": "Folder synchronizacji",
  "settings.sync.root.description": "Wszystkie foldery projektów w tym katalogu są synchronizowane z dyskiem w chmurze.",
  "settings.sync.root.notSet": "Nie ustawiono",
  "settings.sync.root.choose": "Wybierz folder",
  "settings.sync.projects.section": "Projekty",
  "settings.sync.projects.empty": "Brak projektów. Najpierw ustaw folder synchronizacji.",
  "settings.sync.projects.resolve": "Rozwiąż",
  "settings.sync.state.in_sync": "Zsynchronizowano",
  "settings.sync.state.local_ahead": "Oczekujące zmiany lokalne",
  "settings.sync.state.remote_ahead": "Dostępne aktualizacje zdalne",
  "settings.sync.state.new_local": "Nowy, zostanie przesłany",
  "settings.sync.state.new_remote": "Nowy zdalny projekt, zostanie pobrany",
  "settings.sync.state.conflict": "Konflikt synchronizacji",
  "settings.sync.state.pending_delete": "Oczekuje na usunięcie",
  "settings.sync.lastSynced": "Ostatnia synchronizacja",
  "settings.sync.lastSynced.never": "Nigdy",
  "settings.sync.action.sync": "Synchronizuj teraz",
  "settings.sync.action.syncing": "Synchronizowanie…",
  "settings.sync.decision.pair.title": "Konflikt nazw",
  "settings.sync.decision.pair.description":
    "„{{name}}” istnieje lokalnie i na dysku w chmurze jako dwa różne projekty (zdalny z urządzenia {{device}}, {{time}}).",
  "settings.sync.decision.tie.title": "Zmiany po obu stronach",
  "settings.sync.decision.tie.description":
    "„{{name}}” został zmieniony po obu stronach niemal w tym samym czasie. Wybierz, którą stronę zachować.",
  "settings.sync.decision.delete.title": "Usuń zdalne projekty",
  "settings.sync.decision.delete.description":
    "Te projekty zostały usunięte lokalnie: {{names}}. Usunąć je również z dysku w chmurze?",
  "settings.sync.decision.keepLocal": "Zachowaj lokalne",
  "settings.sync.decision.keepRemote": "Zachowaj zdalne",
  "settings.sync.decision.keepBoth": "Zachowaj oba",
  "settings.sync.decision.confirmDelete": "Usuń z chmury",
  "settings.sync.decision.later": "Później",
  "settings.sync.decision.backup.hint": "Twoje dane lokalne są automatycznie zapisywane jako kopia zapasowa przed nadpisaniem.",
  "settings.sync.auto.title": "Automatyczna synchronizacja",
  "settings.sync.auto.description": "Pobiera zdalne aktualizacje przy otwarciu projektu oraz przesyła zmiany lokalne okresowo i przy wyjściu.",
  "settings.sync.toast.saved": "Dysk w chmurze połączony",
  "settings.sync.toast.saveFailed": "Nie udało się połączyć",
  "settings.sync.toast.disconnected": "Dysk w chmurze rozłączony",
  "settings.sync.toast.disconnectFailed": "Nie udało się rozłączyć",
  "settings.sync.toast.rootSet": "Folder synchronizacji zaktualizowany",
  "settings.sync.toast.rootFailed": "Nie udało się ustawić folderu synchronizacji",
  "settings.sync.toast.synced": "Synchronizacja zakończona",
  "settings.sync.toast.resolved": "Rozwiązano",
  "settings.sync.toast.syncFailed": "Synchronizacja nie powiodła się",
  "settings.sync.toast.upToDate": "Już aktualne",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Integracja z WSL",
  "settings.desktop.wsl.description": "Uruchamiaj serwer OpenNovel wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenNovel na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenNovel ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenNovel.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenNovel",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenNovel.",
  ...
  "novel.bookshelf.open": "Wróć do półki",
  ...
  "settings.soul.tab": "Dusza",
  "settings.soul.description": "Napisz personę wstrzykiwaną jako prompt systemowy do każdej sesji AI. Powieść z własną duszą nadpisuje to globalne ustawienie.",
  "settings.soul.placeholder": "np. Jesteś „Laodu”, złośliwy, ale wiarygodny partner do pisania...",
  "settings.soul.templates": "Szablony",
  "settings.soul.template.gentle.name": "Łagodny redaktor",
  "settings.soul.template.gentle.content": "Jesteś „Bianbian”, łagodnym i cierpliwym redaktorem. Mówisz cicho, bardziej zachęcasz niż krytykujesz; wskazując problemy, najpierw dostrzegasz zalety, a potem taktownie proponujesz sugestie. Namawiając do pisania, używasz ciepłych słów.",
  "settings.soul.template.sharp.name": "Złośliwy partner",
  "settings.soul.template.sharp.content": "Jesteś „Laodu”, złośliwym, ale wiarygodnym partnerem do pisania. Twoje przytyki są cięte, ale zawsze trafne; każda rada jest profesjonalna. Nigdy nie kpisz bez powodu. Namawiając do pisania, jesteś sardoniczny, ale Twoje sugestie są zawsze rzeczowe.",
  "settings.soul.template.critic.name": "Poważny krytyk",
  "settings.soul.template.critic.content": "Jesteś poważnym krytykiem literackim. Precyzyjne słowa, bez pochlebstw; oceniaj każdy rozdział pod kątem struktury, tempa i łuków postaci; wskazuj luki i kierunki poprawy zamiast chwalenia; przytaczaj tekst na poparcie każdego punktu.",
  "settings.soul.overwriteConfirm": "Bieżąca treść zostanie zastąpiona szablonem. Kontynuować?",
  "settings.soul.save": "Zapisz",
  "settings.soul.saved": "Duszę zapisano.",
  "settings.soul.charCount": "{{count}} znaków",
  "settings.soul.tooLong": "{{count}} znaków — długa dusza może zapełniać kontekst modelu",
  "novel.settings.tabSoul": "Dusza",
  "novel.settings.soul.globalHint": "Jeśli nie ustawiono, do tej powieści stosowana jest globalna dusza (Ustawienia → Dusza).",
}
