...
export const dict = {
  ...
  "dialog.provider.opennovel.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.opennovel.tagline": "可靠的優化模型",
  "dialog.provider.opennovelGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.viewMoreProviders": "查看另外 70+ 家服務商",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenNovel 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OpenNovel 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opennovelZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OpenNovel 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 OpenNovel 中使用 {{provider}} 模型。",
  ...
  // 本地 provider fetch /api/tags 狀態回饋 + 匯入全部
  "provider.connect.field.fetchStatus.fetching": "正在連接本地服務...",
  "provider.connect.field.fetchStatus.fetched": "已拉取 {{count}} 個模型",
  "provider.connect.field.fetchStatus.failed": "拉取失敗，請檢查 Base URL。",
  "provider.connect.field.importAll": "匯入全部",
  "provider.connect.toast.importAllSuccess.title": "已匯入 {{count}} 個模型",
  "provider.connect.toast.importAllSuccess.description": "現在可以在模型選擇器裡使用 {{provider}} 的已匯入模型。",
  ...
  "dialog.plugins.empty": "在 opennovel.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 OpenNovel 伺服器。",
  ...
  "wsl.onboarding.checkingOpenNovel": "正在檢查 OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "正在檢查 {{distro}} 中的 OpenNovel...",
  ...
  "wsl.onboarding.opennovelReadyIn": "{{distro}} 中的 OpenNovel 已就緒。",
  "wsl.onboarding.opennovelReady": "OpenNovel 已就緒。",
  "wsl.onboarding.installOpenNovelIn": "在 {{distro}} 中安裝 OpenNovel。",
  "wsl.onboarding.installOpenNovel": "安裝 OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "未安裝 OpenNovel",
  ...
  "wsl.onboarding.wslUnavailable.description": "OpenNovel 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 OpenNovel。",
  ...
  "toast.update.description": "OpenNovel 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OpenNovel 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (opennovel.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: OpenNovel 暫不支援 MCP 認證。',
  ...
  "home.sessions.sidebar.unbound": "全域對話",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel 提供免費模型，你可以立即開始使用。",
  ...
  "settings.sync.tab": "雲盤同步",
  "settings.sync.title": "雲盤同步",
  "settings.sync.connection.section": "雲盤連線",
  "settings.sync.field.url": "伺服器位址",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "雲盤的 WebDAV 位址，堅果雲為 https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "使用者名稱",
  "settings.sync.field.username.placeholder": "WebDAV 帳號（電子郵件）",
  "settings.sync.field.password": "應用程式密碼",
  "settings.sync.field.password.description": "堅果雲需要在網頁版「帳戶設定 → 安全設定」中產生應用程式密碼。",
  "settings.sync.action.test": "測試連線",
  "settings.sync.action.testing": "測試中…",
  "settings.sync.action.save": "儲存並連線",
  "settings.sync.action.saving": "連線中…",
  "settings.sync.action.disconnect": "中斷連線",
  "settings.sync.test.success": "連線成功",
  "settings.sync.test.failed": "連線失敗",
  "settings.sync.connected.account": "帳號",
  "settings.sync.disconnect.confirm.title": "中斷雲盤連線",
  "settings.sync.disconnect.confirm.message": "將移除本裝置儲存的 WebDAV 連線與憑證，遠端快照會保留。",
  "settings.sync.root.section": "同步資料夾",
  "settings.sync.root.description": "此目錄下的所有專案資料夾都會與雲盤同步。",
  "settings.sync.root.notSet": "未設定",
  "settings.sync.root.choose": "選擇目錄",
  "settings.sync.projects.section": "專案",
  "settings.sync.projects.empty": "尚無專案。請先設定同步資料夾。",
  "settings.sync.projects.resolve": "處理",
  "settings.sync.state.in_sync": "已同步",
  "settings.sync.state.local_ahead": "本機有更新",
  "settings.sync.state.remote_ahead": "遠端有更新",
  "settings.sync.state.new_local": "新專案，待上傳",
  "settings.sync.state.new_remote": "遠端新專案，待下載",
  "settings.sync.state.conflict": "同步衝突",
  "settings.sync.state.pending_delete": "待刪除",
  "settings.sync.lastSynced": "上次同步",
  "settings.sync.lastSynced.never": "從未同步",
  "settings.sync.action.sync": "立即同步",
  "settings.sync.action.syncing": "同步中…",
  "settings.sync.decision.pair.title": "同名專案衝突",
  "settings.sync.decision.pair.description":
    "本機和雲盤上的「{{name}}」是兩個不同的專案（遠端來自 {{device}}，{{time}}）。",
  "settings.sync.decision.tie.title": "雙方都有改動",
  "settings.sync.decision.tie.description": "「{{name}}」在本機和遠端幾乎同時被修改，請選擇保留哪一邊。",
  "settings.sync.decision.delete.title": "刪除遠端專案",
  "settings.sync.decision.delete.description": "以下專案已在本機刪除：{{names}}。是否同時從雲盤刪除？",
  "settings.sync.decision.keepLocal": "保留本機",
  "settings.sync.decision.keepRemote": "保留遠端",
  "settings.sync.decision.keepBoth": "兩者都留",
  "settings.sync.decision.confirmDelete": "從雲盤刪除",
  "settings.sync.decision.later": "稍後",
  "settings.sync.decision.backup.hint": "覆蓋前會自動備份本機資料。",
  "settings.sync.auto.title": "自動同步",
  "settings.sync.auto.description": "開啟專案時自動拉取遠端更新，並定期及離開時推送本機更改。",
  "settings.sync.toast.saved": "雲盤已連線",
  "settings.sync.toast.saveFailed": "連線失敗",
  "settings.sync.toast.disconnected": "已中斷雲盤連線",
  "settings.sync.toast.disconnectFailed": "中斷連線失敗",
  "settings.sync.toast.rootSet": "同步目錄已更新",
  "settings.sync.toast.rootFailed": "設定同步目錄失敗",
  "settings.sync.toast.synced": "同步完成",
  "settings.sync.toast.resolved": "已處理",
  "settings.sync.toast.syncFailed": "同步失敗",
  "settings.sync.toast.upToDate": "已是最新",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 整合",
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 OpenNovel 伺服器。",
  ...
  "settings.general.row.language.description": "變更 OpenNovel 的顯示語言",
  "settings.general.row.outputLanguage.title": "輸出語言",
  "settings.general.row.outputLanguage.description": "強制模型喺所有會話中用指定語言回覆。",
  "settings.general.option.off": "關閉（不覆蓋）",
  ...
  "settings.general.row.appearance.description": "自訂 OpenNovel 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 OpenNovel 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OpenNovel 的主題。",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "在行動裝置上將標題列和書籍分頁置於畫面底部",
  ...
  "settings.updates.row.startup.description": "在 OpenNovel 啟動時自動檢查更新",
  ...
  "common.time.minutesAgo": "{{count}}分鐘前",
  "common.time.hoursAgo": "{{count}}小時前",
  ...
  "novel.bookshelf.sort.newest": "最新優先",
  "novel.bookshelf.sort.oldest": "最早優先",
  "novel.bookshelf.sort.title": "標題 A-Z",
  ...
  "novel.wizard.step.details": "詳細資訊",
  "novel.wizard.step.confirm": "確認資訊",
  "novel.wizard.name": "小說名稱",
  "novel.wizard.namePlaceholder": "請輸入小說名稱",
  "novel.wizard.genre": "題材",
  "novel.wizard.genrePlaceholder": "請選擇題材",
  "novel.wizard.description": "簡介",
  "novel.wizard.descriptionPlaceholder": "寫下你的小說簡介，讓讀者先睹為快",
  "novel.wizard.genres.玄幻": "玄幻",
  "novel.wizard.genres.都市": "都市",
  "novel.wizard.genres.仙侠": "仙俠",
  "novel.wizard.genres.历史": "歷史",
  "novel.wizard.genres.科幻": "科幻",
  "novel.wizard.genres.悬疑": "懸疑",
  "novel.wizard.genres.言情": "言情",
  "novel.wizard.genres.游戏": "遊戲",
  "novel.genre.玄幻": "玄幻",
  "novel.genre.都市": "都市",
  "novel.genre.仙侠": "仙俠",
  "novel.genre.历史": "歷史",
  ...
  "novel.genre.言情": "言情",
  "novel.genre.游戏": "遊戲",
  "novel.wizard.confirm.title": "確認小說資訊",
  "novel.wizard.confirm.description": "請確認以下資訊無誤",
  "novel.wizard.validation.nameRequired": "請輸入小說名稱",
  ...
  "novel.workspace.tabs.editor": "編輯器",
  "novel.workspace.tabs.panels": "面板",
  "novel.workspace.status.saving": "儲存中...",
  "novel.workspace.status.saved": "已儲存",
  "novel.workspace.pendingApproval": "待審批",
  "novel.workspace.export": "導出",
  "novel.workspace.exporting": "導出中...",
  "novel.workspace.cancelGeneration": "取消生成",
  "novel.workspace.cancelling": "取消中...",
  "novel.workspace.exportHint": "將全書導出為 Markdown 下載",
  "novel.style.tone": "語氣，如：詼諧、嚴肅",
  "novel.style.pov": "視角，如：第一人稱、第三人稱",
  "novel.style.tense": "時態，如：過去時、現在時",
  "novel.style.rulesHint": "風格規則，每行一條，格式 鍵: 值",
  ...
  "novel.workspace.modeChapters": "章節管理",
  "novel.workspace.modeOutlines": "大綱管理",
  "novel.workspace.modeSettings": "設定",
  "novel.workspace.auditingInProgress": "審計中...",
  "novel.workspace.loading": "載入中...",
  "novel.workspace.notFound": "作品不存在",
  "novel.workspace.waitingApproval": "等待審批",
  ...
  "novel.chapter.status.planned": "計劃中",
  "novel.chapter.status.drafting": "寫作中",
  "novel.chapter.status.audited": "審核中",
  "novel.chapter.status.revised": "修改中",
  "novel.chapter.status.final": "已完成",
  "novel.chapter.status.rejected": "已退回",
  "novel.chapter.status.published": "已發佈",
  "novel.chapter.status.draft": "草稿",
  "novel.chapter.status.outline": "大綱中",
  "novel.chapter.status.pending_review": "待審批",
  "novel.chapter.status.failed": "失敗",
  "novel.chapter.status.none": "無",
  "novel.chapter.new": "新建章節",
  "novel.chapter.newPlaceholder": "章節標題",
  "novel.volume.new": "新建分卷",
  "novel.volume.newPlaceholder": "分卷標題",
  "novel.volume.rename": "重命名分卷",
  "novel.volume.confirmDelete": "刪除分卷？卷內章節將變為未分組。",
  "novel.chapter.add": "新增章節",
  "novel.chapter.delete": "刪除章節",
  "novel.chapter.confirmDelete": "確定要刪除此章節嗎？",
  "novel.chapter.edit": "編輯章節",
  "novel.chapter.moveUp": "上移",
  "novel.chapter.moveDown": "下移",
  "novel.chapter.moveToVolume": "移動到分卷",
  "novel.chapter.ungrouped": "未分組",
  "novel.search.placeholder": "搜索章節內容...",
  "novel.search.noResults": "無匹配結果",
  "novel.chapter.empty": "暫無章節",

  "novel.reader.title": "閱讀器",
  "novel.reader.empty": "請選擇章節",
  "novel.outline.empty": "請選擇大綱項",
  "novel.outline.noContent": "暫無內容",
  "novel.reader.prev": "上一章",
  "novel.reader.next": "下一章",
  "novel.reader.wordCount": "{{count}} 字",
  "novel.reader.addAnnotation": "添加批註",
  "novel.reader.annotationComment": "批註內容（必填）",
  "novel.reader.annotationSuggestion": "替換建議（可選）",
  "novel.reader.annotationOverlap": "該區域已有批註，可編輯現有批註補充說明",
  "novel.reader.annotationWarning": "該章節有 {count} 條未處理批註，建議先處理後修改正文",
  "novel.reader.scrollToTop": "回到頂部",
  "novel.reader.fontSize": "字型大小",
  "novel.reader.dayMode": "日間模式",
  "novel.reader.nightMode": "夜間模式",

  "novel.approval.title": "審核",
  "novel.approval.approve": "通過",
  "novel.approval.reject": "退回",
  "novel.approval.edit": "編輯後重新提交",
  "novel.approval.pending": "待審核",
  "novel.approval.viewReview": "查看審核詳情（跳轉會話）",
  "novel.review.loading": "評審載入中…",
  "novel.review.empty": "暫無評審記錄，運行寫作流水線後生成。",
  "novel.review.round": "第 {{round}} 輪",
  "novel.review.counts": "{{pass}} 通過 · {{warn}} 警告 · {{fail}} 未過",
  "novel.review.overall.PASS": "通過",
  "novel.review.overall.WARN": "警告",
  "novel.review.overall.FAIL": "未通過",
  "novel.review.source.deterministic": "確定性檢查",
  "novel.review.source.auditor": "審計員深審",
  "novel.review.source.human": "人工",
  "novel.review.stale": "當前內容已在最近評審之後修改，評審詳情可能已過期。",
  "novel.review.category.character": "角色連續性",
  "novel.review.category.relationship": "關係連續性",
  "novel.review.category.timeline": "時間線",
  "novel.review.category.location": "地點",
  "novel.review.category.plot": "劇情",
  "novel.review.category.worldview": "世界觀",
  "novel.review.category.style": "風格",
  "novel.review.category.logic": "邏輯",
  "novel.review.category.detail": "細節",
  "novel.review.passCount": "{{count}} 項通過",
  "novel.review.evidence": "證據",
  "novel.review.showPass": "查看通過項（{{count}}）",
  "novel.review.hidePass": "收起通過項",
  "novel.review.humanNotes": "人工批註",
  "novel.review.noComment": "（無批註）",
  "novel.review.expand": "評審詳情",
  "novel.review.collapse": "收起詳情",
  "novel.approval.commentCancel": "取消",
  "novel.approval.commentConfirm": "確認駁回",
  "novel.approval.confirmed": "已通過",
  "novel.approval.history": "審核歷史",
  "novel.approval.noHistory": "暫無審核記錄",
  "novel.approval.comment": "審核意見",
  "novel.approval.commentPlaceholder": "駁回理由（可選）— 將作為人工批註留給寫手",
  ...
  "novel.mode.switchToAuto": "切換為自動",
  "novel.mode.switchHint": "點擊切換寫作模式。目前：{{current}}",
  "novel.mode.setupLabel": "初始化模式",
  "novel.mode.setupInteractive": "確認",
  "novel.mode.setupAuto": "自動",
  "novel.mode.setupInteractiveDesc": "確認模式：先與用戶討論並呈現方案，確認後才落庫",
  "novel.mode.setupAutoDesc": "自動模式：無需確認，直接落庫",
  "novel.mode.switchToSetupInteractive": "切換為確認",
  "novel.mode.switchToSetupAuto": "切換為自動",
  "novel.mode.setupSwitchHint": "點擊切換初始化模式。目前：{{current}}",
  "novel.mode.error.updateFailed": "模式切換失敗，請稍後重試",

  "novel.panel.title": "創作面板",
  "novel.relations.tab": "關係",
  "novel.relations.title": "關係",
  "novel.relations.global": "全域關係",
  "novel.relations.globalCount": "共 {{count}} 條關係",
  "novel.relations.empty": "暫無人物關係。可在右側人物面板中新增關係。",
  "novel.relations.directCount": "{{count}} 個直接關係",
  "novel.relations.noDirectRelations": "該角色暫無直接關係",
  "novel.relations.resetView": "重設視圖",
  ...
  "novel.map.tab": "地圖",
  "novel.map.title": "地圖",
  "novel.map.comingSoon": "地圖功能正在規劃中，後續將支援地點與世界視圖。",
  "novel.panel.characters": "人物",
  "novel.panel.characters.back": "← 返回列表",
  "novel.panel.characters.count": "{{count}} 個人物",
  "novel.panel.characters.detail": "人物詳情",
  "novel.panel.characters.description": "描述",
  "novel.panel.characters.empty": "尚無人物",
  "novel.panel.characters.loading": "正在載入人物...",
  "novel.panel.characters.relationships": "人物關係",
  "novel.panel.characters.states.empty": "暫無狀態記錄",
  "novel.panel.characters.state.place": "所在地",
  "novel.panel.characters.state.mood": "心情",
  "novel.panel.characters.state.summary": "狀態摘要",
  "novel.panel.characters.state.active": "活躍（點擊歸檔）",
  "novel.panel.characters.state.inactive": "已歸檔（點擊激活）",
  "novel.panel.characters.relationships.empty": "暫無人際關係",
  "novel.panel.characters.rel.target": "選擇角色",
  "novel.panel.characters.rel.typePlaceholder": "關係類型，如：師徒、宿敵",
  "novel.panel.characters.rel.description": "關係描述",
  "novel.panel.characters.role": "角色",
  "novel.panel.characters.search": "搜尋人物",
  "novel.panel.characters.states": "人物狀態",
  "novel.panel.characters.add": "添加角色",
  "novel.panel.characters.edit": "編輯",
  "novel.panel.characters.delete": "刪除",
  "novel.panel.characters.name": "姓名",
  "novel.panel.characters.save": "儲存",
  "novel.panel.characters.cancel": "取消",
  "novel.relations.resetLayout": "重置佈局",
  "novel.relations.viewList": "列表",
  "novel.relations.viewGraph": "圖譜",
  "novel.relations.emptyGraph": "添加角色後即可查看關係圖。",
  "novel.relations.graphCount": "{{characters}} 個角色 · {{relationships}} 條關係",
  "novel.panel.characters.deleteConfirm": "確定要刪除角色「{{name}}」嗎？此操作不可逆。",
  "novel.panel.characters.writeOut": "退場",
  "novel.panel.characters.writeOutConfirm":
    "確定讓角色「{{name}}」退場嗎？該角色將不再出現於未來章節,但已有章節中的提及仍然有效。",
  "novel.panel.characters.restore": "恢復",
  "novel.panel.characters.departed": "已退場",
  "novel.panel.characters.protagonistProtect": "主角不能退場或刪除。如需更換主角,請先創建新主角並切換角色。",
  "novel.panel.characters.deleteRefusedAppeared": "此角色已在章節中出現,無法刪除。建議改用「退場」。",
  "novel.panel.characters.state.deleteConfirm": "確定要刪除此角色狀態嗎？此操作不可逆。",
  "novel.panel.characters.rel.deleteConfirm": "確定要刪除此關係嗎？此操作不可逆。",
  "novel.panel.foreshadow.deleteConfirm": "確定要刪除此伏筆嗎？此操作不可逆。",
  "novel.panel.threads.deleteConfirm": "確定要刪除此劇情線索嗎？此操作不可逆。",
  "novel.panel.tension.deleteConfirm": "確定要刪除此張力點嗎？此操作不可逆。",
  "novel.panel.plot": "情節",
  "novel.panel.foreshadow": "伏筆",
  "novel.panel.world": "世界觀",
  "novel.panel.outline": "大綱",
  "novel.panel.outline.edit": "編輯",
  ...
  "novel.panel.tension.level": "等級",
  "novel.panel.tension.delete": "刪除",
  "novel.panel.tension.empty": "暫無節奏數據，可在下方新增第一個節點",
  "novel.panel.addCharacter": "添加角色",
  "novel.panel.addPlot": "添加情節",
  "novel.panel.addForeshadow": "添加伏筆",
  "novel.panel.threads.empty": "暫無情節線",
  "novel.panel.threads.open": "進行中",
  "novel.panel.threads.closed": "已完成",
  "novel.panel.threads.high": "高",
  "novel.panel.threads.medium": "中",
  "novel.panel.threads.low": "低",
  "novel.panel.foreshadow.empty": "暫無伏筆",
  "novel.panel.foreshadow.plantedIn": "埋於第{{chapter}}章",
  "novel.panel.foreshadow.resolvedIn": "揭曉於第{{chapter}}章",
  "novel.panel.foreshadow.planted": "已埋下",
  "novel.panel.foreshadow.hinted": "已暗示",
  "novel.panel.foreshadow.resolved": "已揭曉",
  "novel.panel.foreshadow.abandoned": "已廢棄",
  "novel.panel.world.empty": "暫無世界觀條目",
  "novel.panel.world.search": "搜尋世界觀",
  "novel.panel.world.uncategorized": "未分類",
  "novel.panel.foreshadow.add": "添加",
  "novel.panel.foreshadow.delete": "刪除",
  "novel.panel.currentChapter": "當前章節：第{{chapter}}章",
  "novel.panel.threads.add": "添加線索",
  "novel.panel.threads.delete": "刪除",
  "novel.panel.threads.close": "關閉",
  "novel.panel.threads.title": "標題",
  "novel.panel.threads.priority": "優先級",
  "novel.panel.threads.description": "描述",
  "novel.panel.world.add": "添加條目",
  "novel.panel.world.delete": "刪除",
  "novel.panel.world.category": "分類",
  "novel.panel.world.title": "標題",
  "novel.panel.world.content": "內容",
  "novel.panel.world.deleteConfirm": "確定要刪除此世界觀條目嗎？此操作不可逆。",

  "novel.panel.structure": "結構",
  "novel.panel.annotations": "批註",
  "novel.panel.canvas": "畫布",

  "novel.chapter.label": "第{{order}}章",
  "novel.common.completed": "已完成",

  "novel.structure.arcType.narrative": "主線",
  "novel.structure.arcType.character": "角色弧",
  "novel.structure.arcType.subplot": "支線",
  "novel.structure.arcStatus.planned": "規劃中",
  "novel.structure.arcStatus.active": "進行中",
  "novel.structure.arcStatus.completed": "已完成",
  "novel.structure.arcStatus.abandoned": "已棄用",
  "novel.structure.beatKind.setup": "開場",
  "novel.structure.beatKind.rising": "升溫",
  "novel.structure.beatKind.turn": "轉折",
  "novel.structure.beatKind.midpoint": "中點",
  "novel.structure.beatKind.crisis": "危機",
  "novel.structure.beatKind.climax": "高潮",
  "novel.structure.beatKind.resolution": "結局",
  "novel.structure.beatKind.note": "備註",
  "novel.structure.editorial": "主編視角",
  "novel.structure.editorial.run": "運行檢查",
  "novel.structure.editorial.recommendations": "{{count}} 條建議",
  "novel.structure.arcs": "結構線",
  "novel.structure.arcs.add": "+ 新增",
  "novel.structure.arcs.create": "創建",
  "novel.structure.arcs.titlePlaceholder": "結構線標題",
  "novel.structure.arcs.empty": "暫無結構線，點擊新增開始規劃。",
  "novel.structure.arcs.planned": "規劃：第{{start}}-{{end}}章",
  "novel.structure.beat.titlePlaceholder": "節點標題",
  "novel.structure.beat.add": "添加",
  "novel.structure.beat.addToArc": "+ 添加節點",
  "novel.structure.review.title": "{{title}} - 復盤",
  "novel.structure.review.round": "第 {{round}} 輪",
  "novel.structure.review.strengths": "優點：",
  "novel.structure.review.weaknesses": "不足：",

  "novel.annotations.status.open": "待處理",
  "novel.annotations.status.resolved": "已解決",
  "novel.annotations.status.wontfix": "不處理",
  "novel.annotations.status.applied": "已採納",
  "novel.annotations.filter.all": "全部",
  "novel.annotations.empty": "暫無批註",
  "novel.annotations.polish": "潤色",
  "novel.annotations.suggestion": "建議：",
  "novel.annotations.apply": "採納",
  "novel.annotations.resolve": "解決",
  "novel.annotations.dismiss": "忽略",
  "novel.annotations.reopen": "重新打開",
  "novel.annotations.edit": "編輯",
  "novel.annotations.save": "保存",
  "novel.annotations.editComment": "批註內容",
  "novel.annotations.editSuggestion": "替代建議（可選）",
  "novel.annotations.tab.current": "當前",
  ...
  "novel.annotations.manual": "手動處理",

  "novel.canvas.title": "大綱畫布",
  "novel.canvas.reset": "重置佈局",

  "novel.settings.tabEntries": "世界觀條目",
  "novel.settings.tabStyle": "寫作風格",
  "novel.settings.selectEntry": "請選擇一條世界觀條目查看或編輯",
  "novel.settings.entryNotFound": "該條目已被刪除。",
  "novel.settings.entry.edit": "編輯",
  "novel.settings.entry.save": "儲存",
  "novel.settings.entry.saving": "儲存中...",
  "novel.settings.entry.cancel": "取消",
  "novel.settings.entry.delete": "刪除",
  "novel.settings.entry.deleteConfirm": "確定要刪除「{{title}}」嗎？此操作不可逆。",
  "novel.settings.style.saved": "風格已儲存。",

  "novel.editor.save": "儲存",
  "novel.editor.saved": "已儲存",
  "novel.editor.saving": "儲存中...",
  "novel.editor.target": "每日目標",
  "novel.editor.shortcut": "快速鍵",
  "novel.editor.autoSave": "自動儲存",
  "novel.editor.charCount": "{{count}} / {{target}} 字",
  "novel.editor.wordCount": "字數統計",
  "novel.editor.exit": "退出編輯器",
  "novel.editor.history": "歷史版本",
  "novel.editor.noVersions": "暫無歷史版本",
  "novel.editor.preview": "查看",
  "novel.editor.restore": "恢復",
  "novel.editor.restoreSuccess": "已恢復到該版本",
  "novel.editor.autoSaved": "已自動保存 {{time}}",
  "novel.editor.saveSuccess": "章節已儲存",

  "novel.status.planned": "計劃中",
  "novel.status.drafting": "寫作中",
  "novel.status.audited": "審核中",
  ...
  "novel.foreshadow.resolved": "已揭曉",
  "novel.foreshadow.abandoned": "已廢棄",

  "novel.error.notFound": "小說未找到",
  "novel.error.loadFailed": "載入小說失敗",
  "novel.error.saveFailed": "儲存失敗",
  "novel.error.createFailed": "建立小說失敗",
  "novel.error.deleteFailed": "刪除失敗",
  "novel.error.networkError": "網路錯誤",
  "settings.soul.tab": "靈魂",
  "settings.soul.description": "寫一段人格文本，作為系統提示詞注入所有 AI 會話；小說設定了自己的靈魂時會覆蓋它。",
  "settings.soul.placeholder": "例：你是「老毒」，一個毒舌但靠谱的寫作搭檔……",
  "settings.soul.templates": "模板",
  "settings.soul.template.gentle.name": "溫柔責編",
  "settings.soul.template.gentle.content":
    "你是「編編」，一位溫柔耐心的責編。說話輕聲細語，多鼓勵少批評；指出問題時先肯定優點，再委婉給出修改建議；催稿也只是溫言提醒。",
  "settings.soul.template.sharp.name": "毒舌搭檔",
  "settings.soul.template.sharp.content":
    "你是「老毒」，一個毒舌但靠谱的寫作搭檔。吐槽犀利、從不客氣，但每條吐槽都切中要害；建議永遠專業，絕不無的放矢；催稿時陰陽怪氣但要點明確。",
  "settings.soul.template.critic.name": "嚴肅評論家",
  "settings.soul.template.critic.content":
    "你是一位嚴肅的文學評論家。用詞精確，不苟言笑；從結構、節奏、人物弧光三個維度評審每一章；不誇獎，只指出差距與改進方向；引用原文佐證每個觀點。",
  "settings.soul.overwriteConfirm": "當前內容將被模板覆蓋，確定繼續？",
  "settings.soul.save": "儲存",
  "settings.soul.saved": "靈魂已儲存。",
  "settings.soul.charCount": "{{count}} 字",
  "settings.soul.tooLong": "{{count}} 字——內容較長，可能排擠模型上下文",
  "novel.settings.tabSoul": "靈魂",
  "novel.settings.soul.globalHint": "未設定時，本書使用全域靈魂（設定 → 靈魂）。",
