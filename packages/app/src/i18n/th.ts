export const dict = {
  ...
  "dialog.provider.opennovel.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.opennovel.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.opennovelGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย OpenNovel",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenNovel",
  ...
  "provider.connect.opennovelZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.opennovelZen.visit.link": "opennovel.ai/zen",
  "provider.connect.opennovelZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenNovel",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน OpenNovel",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน opennovel.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ OpenNovel ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpenNovel": "กำลังตรวจสอบ OpenNovel...",
  "wsl.onboarding.checkingOpenNovelIn": "กำลังตรวจสอบ OpenNovel ใน {{distro}}...",
  "wsl.onboarding.updatingOpenNovel": "กำลังอัปเดต OpenNovel...",
  "wsl.onboarding.updatingOpenNovelIn": "กำลังอัปเดต OpenNovel ใน {{distro}}...",
  "wsl.onboarding.updateOpenNovelIn": "อัปเดต OpenNovel ใน {{distro}}.",
  "wsl.onboarding.updateOpenNovel": "อัปเดต OpenNovel",
  "wsl.onboarding.opennovelReadyIn": "OpenNovel พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opennovelReady": "OpenNovel พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installOpenNovelIn": "ติดตั้ง OpenNovel ใน {{distro}}.",
  "wsl.onboarding.installOpenNovel": "ติดตั้ง OpenNovel",
  ...
  "wsl.onboarding.distroStatus.opennovelMissing": "ยังไม่ได้ติดตั้ง OpenNovel",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ OpenNovel จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "OpenNovel ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด OpenNovel อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ OpenNovel ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม OpenNovel",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (opennovel.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า OpenNovel ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "home.sessions.sidebar.unbound": "แชททั่วไป",
  ...
  "sidebar.gettingStarted.line1": "OpenNovel รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.sync.tab": "ซิงก์คลาวด์",
  "settings.sync.title": "ซิงก์คลาวด์",
  "settings.sync.connection.section": "การเชื่อมต่อไดรฟ์คลาวด์",
  "settings.sync.field.url": "URL เซิร์ฟเวอร์",
  "settings.sync.field.url.placeholder": "https://dav.jianguoyun.com/dav/",
  "settings.sync.field.url.description": "ที่อยู่ WebDAV ของไดรฟ์คลาวด์ของคุณ สำหรับ Nutstore ใช้ https://dav.jianguoyun.com/dav/",
  "settings.sync.field.username": "ชื่อผู้ใช้",
  "settings.sync.field.username.placeholder": "บัญชี WebDAV (อีเมล)",
  "settings.sync.field.password": "รหัสผ่านแอป",
  "settings.sync.field.password.description": "Nutstore ต้องใช้รหัสผ่านแอป — สร้างได้ในเวอร์ชันเว็บที่ การตั้งค่าบัญชี → ความปลอดภัย",
  "settings.sync.action.test": "ทดสอบการเชื่อมต่อ",
  "settings.sync.action.testing": "กำลังทดสอบ…",
  "settings.sync.action.save": "บันทึกและเชื่อมต่อ",
  "settings.sync.action.saving": "กำลังเชื่อมต่อ…",
  "settings.sync.action.disconnect": "ยกเลิกการเชื่อมต่อ",
  "settings.sync.test.success": "เชื่อมต่อสำเร็จ",
  "settings.sync.test.failed": "เชื่อมต่อไม่สำเร็จ",
  "settings.sync.connected.account": "บัญชี",
  "settings.sync.disconnect.confirm.title": "ยกเลิกการเชื่อมต่อไดรฟ์คลาวด์",
  "settings.sync.disconnect.confirm.message": "การดำเนินการนี้จะลบการเชื่อมต่อ WebDAV และข้อมูลรับรองที่บันทึกไว้จากอุปกรณ์นี้ สแนปช็อตระยะไกลจะยังคงอยู่",
  "settings.sync.root.section": "โฟลเดอร์ซิงก์",
  "settings.sync.root.description": "โฟลเดอร์โปรเจกต์ทั้งหมดภายใต้ไดเรกทอรีนี้จะถูกซิงก์กับไดรฟ์คลาวด์",
  "settings.sync.root.notSet": "ยังไม่ได้ตั้งค่า",
  "settings.sync.root.choose": "เลือกโฟลเดอร์",
  "settings.sync.projects.section": "โปรเจกต์",
  "settings.sync.projects.empty": "ยังไม่มีโปรเจกต์ โปรดตั้งค่าโฟลเดอร์ซิงก์ก่อน",
  "settings.sync.projects.resolve": "จัดการ",
  "settings.sync.state.in_sync": "ซิงก์แล้ว",
  "settings.sync.state.local_ahead": "มีการเปลี่ยนแปลงในเครื่อง",
  "settings.sync.state.remote_ahead": "มีอัปเดตจากระยะไกล",
  "settings.sync.state.new_local": "โปรเจกต์ใหม่ รออัปโหลด",
  "settings.sync.state.new_remote": "โปรเจกต์ใหม่จากระยะไกล รอดาวน์โหลด",
  "settings.sync.state.conflict": "การซิงก์ขัดแย้ง",
  "settings.sync.state.pending_delete": "รอลบ",
  "settings.sync.lastSynced": "ซิงก์ล่าสุด",
  "settings.sync.lastSynced.never": "ไม่เคย",
  "settings.sync.action.sync": "ซิงก์ตอนนี้",
  "settings.sync.action.syncing": "กำลังซิงก์…",
  "settings.sync.decision.pair.title": "ชื่อโปรเจกต์ขัดแย้ง",
  "settings.sync.decision.pair.description":
    "\"{{name}}\" มีอยู่ทั้งในเครื่องและบนไดรฟ์คลาวด์เป็นคนละโปรเจกต์กัน (ระยะไกลจาก {{device}}, {{time}})",
  "settings.sync.decision.tie.title": "ทั้งสองฝั่งมีการเปลี่ยนแปลง",
  "settings.sync.decision.tie.description":
    "\"{{name}}\" ถูกแก้ไขทั้งในเครื่องและระยะไกลในเวลาใกล้เคียงกัน เลือกว่าจะเก็บฝั่งใด",
  "settings.sync.decision.delete.title": "ลบโปรเจกต์ระยะไกล",
  "settings.sync.decision.delete.description":
    "โปรเจกต์เหล่านี้ถูกลบในเครื่องแล้ว: {{names}} ต้องการลบออกจากไดรฟ์คลาวด์ด้วยหรือไม่",
  "settings.sync.decision.keepLocal": "เก็บของในเครื่อง",
  "settings.sync.decision.keepRemote": "เก็บของระยะไกล",
  "settings.sync.decision.keepBoth": "เก็บทั้งสองฝั่ง",
  "settings.sync.decision.confirmDelete": "ลบจากคลาวด์",
  "settings.sync.decision.later": "ภายหลัง",
  "settings.sync.decision.backup.hint": "ข้อมูลในเครื่องของคุณจะถูกสำรองโดยอัตโนมัติก่อนเขียนทับ",
  "settings.sync.auto.title": "ซิงก์อัตโนมัติ",
  "settings.sync.auto.description": "ดึงอัปเดตระยะไกลเมื่อเปิดโปรเจกต์ และส่งการเปลี่ยนแปลงในเครื่องเป็นระยะและเมื่อออก",
  "settings.sync.toast.saved": "เชื่อมต่อไดรฟ์คลาวด์แล้ว",
  "settings.sync.toast.saveFailed": "เชื่อมต่อไม่สำเร็จ",
  "settings.sync.toast.disconnected": "ยกเลิกการเชื่อมต่อไดรฟ์คลาวด์แล้ว",
  "settings.sync.toast.disconnectFailed": "ยกเลิกการเชื่อมต่อไม่สำเร็จ",
  "settings.sync.toast.rootSet": "อัปเดตโฟลเดอร์ซิงก์แล้ว",
  "settings.sync.toast.rootFailed": "ตั้งค่าโฟลเดอร์ซิงก์ไม่สำเร็จ",
  "settings.sync.toast.synced": "ซิงก์เสร็จสิ้น",
  "settings.sync.toast.resolved": "จัดการแล้ว",
  "settings.sync.toast.syncFailed": "ซิงก์ไม่สำเร็จ",
  "settings.sync.toast.upToDate": "เป็นเวอร์ชันล่าสุดแล้ว",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "การรวม WSL",
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ OpenNovel ภายใน WSL บน Windows",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ OpenNovel มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ OpenNovel ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ OpenNovel มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ OpenNovel เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน OpenNovel เวอร์ชันล่าสุด",
  ...
  "novel.bookshelf.open": "กลับไปที่ชั้นหนังสือ",
