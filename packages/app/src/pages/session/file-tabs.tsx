...
import type { FileSearchHandle } from "@opennovel-ai/session-ui/file"
import { useFileComponent } from "@opennovel-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@opennovel-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@opennovel-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@opennovel-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@opennovel-ai/core/util/encode"
import { normalize, text } from "@opennovel-ai/session-ui/session-diff"
import { DropdownMenu } from "@opennovel-ai/ui/dropdown-menu"
import { IconButton } from "@opennovel-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@opennovel-ai/ui/v2/line-comment-v2"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--opennovel-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
