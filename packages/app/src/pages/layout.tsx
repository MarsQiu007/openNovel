...
import { Session } from "@opennovel-ai/sdk/v2/client"
...
import { toaster } from "@opennovel-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@opennovel-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://opennovel.ai/desktop-feedback")}
      renderPanel={() =>
