...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENNOVEL.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/opennovel/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/opennovel (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/opennovel/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/opennovel/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENNOVEL_DB|OPENNOVEL_DB|OPENNOVEL_DEV|Global\\.Path\\.data|data =" in packages/opennovel/src (115 matches)',
  },
] as const
