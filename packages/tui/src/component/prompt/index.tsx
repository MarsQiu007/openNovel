...
import { registerOpenNovelSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@opennovel-ai/sdk/v2"
...
import { OPENNOVEL_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpenNovelKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.OPENNOVEL_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  const placeholderText = createMemo(() => {
    ...
    return `开始创作… "${list()[store.placeholder % list().length]}"`
  })
