...
import { useBindings, useOpenNovelModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useOpenNovelModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.OPENNOVEL_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
