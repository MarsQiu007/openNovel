...
import defaultSoundPath from "@opennovel-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@opennovel-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@opennovel-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@opennovel-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@opennovel-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@opennovel-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "opennovel"
const DEFAULT_PACK_ID = "opennovel.default"
