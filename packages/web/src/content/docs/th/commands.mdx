...
สร้าง `.opennovel/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenNovel:
...
- ระดับผู้ใช้ (Global): `~/.config/opennovel/commands/`
- ระดับโปรเจ็กต์: `.opennovel/commands/`
...
OpenNovel มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
