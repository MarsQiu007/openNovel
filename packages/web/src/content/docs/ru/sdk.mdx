---
title: SDK
description: Типобезопасный JS-клиент для сервера opennovel.
---
...
Вы можете передать объект конфигурации для настройки поведения. Экземпляр по-прежнему получает ваш `opennovel.json`, но вы можете переопределить или добавить встроенную конфигурацию:
...
Если у вас уже есть работающий экземпляр opennovel, вы можете создать экземпляр клиента для подключения к нему:
