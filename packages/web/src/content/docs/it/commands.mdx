...
Crea `.opennovel/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OpenNovel o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenNovel:
...
- Globale: `~/.config/opennovel/commands/`
- Per progetto: `.opennovel/commands/`
...
opennovel include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
