---
title: Zen
description: Lista curata di modelli fornita da OpenNovel.
---
...
OpenNovel Zen è un elenco di modelli testati e verificati forniti dal team di OpenNovel.

Zen funziona come qualsiasi altro provider in OpenNovel. Accedi a OpenNovel Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenNovel.
:::
...
OpenNovel Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenNovel Zen funziona come qualsiasi altro provider in OpenNovel.

1. Accedi a **<a href={console}>OpenNovel Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenNovel Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenNovel
usa il formato `opennovel/<model-id>`. Per esempio, per GPT 5.5, useresti
`opennovel/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su OpenNovel per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su OpenNovel per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su OpenNovel per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su OpenNovel per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su OpenNovel per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenNovel Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con OpenNovel.
