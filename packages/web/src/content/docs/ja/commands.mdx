...
`.opennovel/commands/test.md` を作成します。
...
カスタムコマンドは、OpenNovel 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

OpenNovel [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/opennovel/commands/`
- プロジェクトごと: `.opennovel/commands/`
...
OpenNovel には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
