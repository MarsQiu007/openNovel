...
Utwórz `.opennovel/commands/test.md`:
...
Możesz zdefiniować polecenia w `opennovel.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji opennovel:
...
- Globalnie: `~/.config/opennovel/commands/`
- Na projekt: `.opennovel/commands/`
...
opennovel zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
