---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenNovel.
---
...
OpenNovel Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenNovel.

Zen działa jak każdy inny dostawca w OpenNovel. Logujesz się do OpenNovel Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OpenNovel.
:::
...
OpenNovel Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OpenNovel Zen działa jak każdy inny dostawca w OpenNovel.

1. Logujesz się do **<a href={console}>OpenNovel Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenNovel Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OpenNovel używa formatu
`opennovel/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`opennovel/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w OpenNovel przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w OpenNovel przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w OpenNovel przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w OpenNovel przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OpenNovel przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy OpenNovel Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OpenNovel także dowolnego innego dostawcy.
