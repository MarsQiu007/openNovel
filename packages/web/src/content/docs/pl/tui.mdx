---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala opennovel.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

opennovel zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie opennovel uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI opennovel, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do opennovel. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij opennovel. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `opennovel.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OpenNovel czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `opennovel.default`.
