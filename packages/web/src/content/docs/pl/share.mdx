---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące opennovel.
---

Funkcja udostępniania opennovel umożliwia tworzenie publicznych linków do konwersacji opennovel, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, opennovel:
...
opennovel obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie opennovel korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `opennovel.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu opennovel w Twojej organizacji.
