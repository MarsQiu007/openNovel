---
title: TUI
description: Korištenje korisničkog interfejsa OpenNovel terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenNovel pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenNovel pokreće TUI za trenutni direktorij.
...
Kada koristite OpenNovel TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenNovel. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenNovel. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `opennovel.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OpenNovel čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `opennovel.default`.
