---
title: LSP serveri
description: OpenNovel se integriše sa vašim LSP serverima.
---

OpenNovel se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

OpenNovel dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `OPENNOVEL_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i opennovel otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj opennovel konfiguraciji.
