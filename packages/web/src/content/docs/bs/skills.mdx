...
Agent skills omogucavaju OpenNovel da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
OpenNovel pretrazuje ove lokacije:

- Konfiguracija projekta: `.opennovel/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/opennovel/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, OpenNovel ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.opennovel/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/opennovel/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.opennovel/skills/git-release/SKILL.md` ovako:
...
OpenNovel navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `opennovel.json`:
...
**Za ugradene agente** (u `opennovel.json`):
