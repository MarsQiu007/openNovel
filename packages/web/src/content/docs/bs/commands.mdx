...
Kreiraj `.opennovel/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenNovel konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenNovel [config](/docs/config):
...
- Globalno: `~/.config/opennovel/commands/`
- Po projektu: `.opennovel/commands/`
...
OpenNovel uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
