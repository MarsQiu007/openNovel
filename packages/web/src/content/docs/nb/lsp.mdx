---
title: LSP-servere
description: opennovel integreres med LSP-serverne dine.
---

OpenNovel kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenNovel kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENNOVEL_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og opennovel åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenNovel-konfigurasjonen.
