...
Agentferdigheter lar OpenNovel oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
opennovel søker etter disse stedene:

- Prosjektkonfigurasjon: `.opennovel/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/opennovel/skills/<name>/SKILL.md`
...
For prosjektlokale stier går opennovel opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.opennovel/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/opennovel/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.opennovel/skills/git-release/SKILL.md` slik:
...
opennovel viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `opennovel.json`:
...
**For innebygde agenter** (i `opennovel.json`):
