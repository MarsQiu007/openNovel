...
Opprett `.opennovel/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenNovel-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenNovel [config](/docs/config):
...
- Per prosjekt: `.opennovel/commands/`
...
OpenNovel inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
