...
Erstellen Sie `.opennovel/commands/test.md`:

```md title=".opennovel/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenNovel-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenNovel [config](/docs/config):

```json title="opennovel.jsonc" {4-12}
{
...
- Global: `~/.config/opennovel/commands/`
- Pro Projekt: `.opennovel/commands/`

```markdown title="~/.config/opennovel/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".opennovel/commands/component.md"
---
...
```md title=".opennovel/commands/create-file.md"
---
...
```md title=".opennovel/commands/analyze-coverage.md"
---
...
```md title=".opennovel/commands/review-changes.md"
---
...
```md title=".opennovel/commands/review-component.md"
---
...
OpenNovel enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
