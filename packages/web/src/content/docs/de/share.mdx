---
title: Teilen
description: Teile OpenNovel-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenNovel-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenNovel Folgendes:
...
OpenNovel hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenNovel den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`opennovel.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du opennovel in deiner Organisation einsetzt.
