---
title: Zen
description: Kuratierte Modellliste direkt von OpenNovel.
---
...
OpenNovel Zen ist eine Liste von getesteten und verifizierten Modellen, die vom OpenNovel-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in OpenNovel. Du meldest dich bei OpenNovel Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um OpenNovel zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit OpenNovel funktionieren.
:::
...
OpenNovel Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

OpenNovel Zen funktioniert wie jeder andere Provider in OpenNovel.

1. Du meldest dich bei **<a href={console}>OpenNovel Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst OpenNovel Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenNovel-Konfiguration verwendet das Format `opennovel/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opennovel/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf OpenNovel verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf OpenNovel verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf OpenNovel verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf OpenNovel verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf OpenNovel verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OpenNovel Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit OpenNovel auch jeden anderen Provider zu verwenden.
