---
title: SDK
description: Typsicherer JS-Client fuer den opennovel-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das opennovel JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und opennovel programmatisch steuern.
...
Erstelle eine opennovel-Instanz:
...
`opennovel.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn opennovel bereits laeuft, kannst du nur einen Client erstellen und verbinden:
