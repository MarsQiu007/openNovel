...
Opret `.opennovel/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem OpenNovel-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenNovel [config](/docs/config):
...
- Globalt: `~/.config/opennovel/commands/`
- Pr. projekt: `.opennovel/commands/`
...
opennovel indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
