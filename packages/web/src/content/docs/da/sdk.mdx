...
Brug den til at bygge integrasjoner og kontrollere opennovel programmatisk.
...
Opret en forekomst av opennovel:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `opennovel.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av opennovel, kan du oprete en klientforekomst for at koble til den:
