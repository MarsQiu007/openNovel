...
Agentferdigheter lar OpenNovel oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OpenNovel opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenNovel viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `opennovel.json`:
