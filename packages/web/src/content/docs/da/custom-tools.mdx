...
description: Opret værktøjer, som LLM kan kalde opennovel ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med opennovels [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.opennovel/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/opennovel/tools/`.
