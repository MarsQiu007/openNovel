...
Her er alle de innebygde verktøyene som er tilgængelige i OpenNovel.
...
:::note
Dette verktøyet er bare tilgængelig når `OPENNOVEL_EXPERIMENTAL_LSP_TOOL=true` (eller `OPENNOVEL_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger OpenNovel-leverandøren eller når miljøvariabelen `OPENNOVEL_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
