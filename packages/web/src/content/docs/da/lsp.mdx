---
title: LSP-servere
description: OpenNovel integreres med dine LSP-servere.
---

OpenNovel kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenNovel leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENNOVEL_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og opennovel åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din opennovel-konfiguration.
