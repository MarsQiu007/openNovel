...
Med OpenNovel kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger OpenNovel vårt eget `opennovel`-tema.
...
OpenNovel støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/opennovel/themes/*.json` eller `$XDG_CONFIG_HOME/opennovel/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.opennovel/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.opennovel/themes/*.json`
