---
title: Zen
description: Udvalgt liste over modeller leveret af OpenNovel.
---
...
OpenNovel Zen er en liste over testede og verificerede modeller leveret af OpenNovel-teamet.

Zen fungerer som enhver anden udbyder i OpenNovel. Du logger ind på OpenNovel Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med OpenNovel.
:::
...
OpenNovel Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OpenNovel Zen fungerer som enhver anden udbyder i OpenNovel.

1. Du logger ind på **<a href={console}>OpenNovel Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger OpenNovel Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din OpenNovel-konfiguration
bruger formatet `opennovel/<model-id>`. For eksempel ville du for GPT 5.5
bruge `opennovel/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på OpenNovel i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på OpenNovel i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på OpenNovel i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på OpenNovel i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på OpenNovel i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte OpenNovel Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med OpenNovel også.
