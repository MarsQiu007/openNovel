...
description: opennovel dile özgü biçimlendiriciler kullanır.
---

opennovel, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

opennovel, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, opennovel bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

opennovel bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri opennovel yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
