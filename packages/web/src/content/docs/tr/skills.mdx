...
Ajan becerileri, opennovel'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
opennovel su konumlari tarar:

- Proje konfigurasyonu: `.opennovel/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/opennovel/skills/<name>/SKILL.md`
...
Proje yerel yollarinda opennovel, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.opennovel/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/opennovel/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.opennovel/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
opennovel, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`opennovel.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`opennovel.json` icinde):
