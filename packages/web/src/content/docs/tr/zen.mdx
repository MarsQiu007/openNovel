---
title: Zen
description: opennovel tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenNovel Zen, OpenNovel ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, OpenNovel'daki diğer sağlayıcılar gibi çalışır. OpenNovel Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve OpenNovel kullanmak için buna ihtiyacınız yoktur.
...
:::tip
OpenNovel ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OpenNovel Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

OpenNovel Zen, OpenNovel'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>OpenNovel Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, OpenNovel Zen'i seçin ve API anahtarınızı yapıştırın.
...
OpenNovel yapılandırmanızdaki [model id](/docs/config/#models) `opennovel/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opennovel/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için OpenNovel'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için OpenNovel'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için OpenNovel'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için OpenNovel'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için OpenNovel'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
OpenNovel Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca OpenNovel ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
