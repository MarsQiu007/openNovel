---
title: Özel Araçlar
description: LLM'un opennovel'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. opennovel'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.opennovel/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/opennovel/tools/` içine yerleştirerek.
