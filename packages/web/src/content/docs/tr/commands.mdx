...
`.opennovel/commands/test.md` oluştur:
...
opennovel işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

opennovel [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/opennovel/commands/`
- Proje başına: `.opennovel/commands/`
...
opennovel, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
