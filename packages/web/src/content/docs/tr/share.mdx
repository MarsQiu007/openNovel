---
title: Paylasim
description: opennovel konusmalarini genel baglantilarla paylasin.
---

opennovel'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda opennovel:
...
opennovel, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak opennovel manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `opennovel.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda opennovel kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
