...
Las habilidades del agente permiten a OpenNovel descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
OpenNovel busca estas ubicaciones:

- Configuración del proyecto: `.opennovel/skills/<name>/SKILL.md`
- Configuración global: `~/.config/opennovel/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, OpenNovel sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.opennovel/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/opennovel/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.opennovel/skills/git-release/SKILL.md` así:
...
OpenNovel enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `opennovel.json`:
...
**Para agentes integrados** (en `opennovel.json`):
