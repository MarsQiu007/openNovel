...
Crear `.opennovel/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenNovel o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenNovel [config](/docs/config):
...
- Por proyecto: `.opennovel/commands/`
...
opennovel incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
