...
Con OpenNovel puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, OpenNovel usa nuestro propio tema `opennovel`.
...
OpenNovel viene con varios temas integrados.
...
- Quiere que OpenNovel coincida con la apariencia de su terminal
...
OpenNovel admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/opennovel/themes/*.json` o `$XDG_CONFIG_HOME/opennovel/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.opennovel/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.opennovel/themes/*.json`
