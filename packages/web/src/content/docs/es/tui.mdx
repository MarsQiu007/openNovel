---
title: TUI
description: Usando la interfaz de usuario del terminal OpenNovel.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenNovel proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenNovel se inicia TUI para el directorio actual.
...
Cuando utilice OpenNovel TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenNovel. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenNovel. _Alias_: `/quit`, `/q`
...
Esto es independiente de `opennovel.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera OpenNovel después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `opennovel.default`.
