---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor opennovel.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK opennovel JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar opennovel mediante programación.
...
Cree una instancia de opennovel:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `opennovel.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de opennovel, puede crear una instancia de cliente para conectarse a ella:
