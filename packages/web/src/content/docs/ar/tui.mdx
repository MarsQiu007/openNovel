---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenNovel.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenNovel واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenNovel إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenNovel في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenNovel. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenNovel. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `opennovel.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار OpenNovel بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `opennovel.default`.
