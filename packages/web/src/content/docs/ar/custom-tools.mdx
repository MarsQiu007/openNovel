...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في opennovel.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في opennovel مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.opennovel/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/opennovel/tools/`.
