...
import { IconOpenNovel } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "opennovel/session/message-v2"
import type { Message } from "opennovel/session/message"
import type { Session } from "opennovel/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.opennovel_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.opennovel_name}>
                    <IconOpenNovel width={16} height={16} />
                  </div>
