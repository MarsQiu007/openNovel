...
import { isSessionNotFoundError, isUnauthorizedError, OpenNovel } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = OpenNovel.make({ baseUrl: "http://localhost:3000" })
