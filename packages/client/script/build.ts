...
import { compile, emitEffectImported, emitPromise, write } from "@opennovel-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "OpenNovelEventEncoded",
              import: 'import type { OpenNovelEventEncoded } from "@opennovel-ai/protocol/groups/event"',
            },
          },
        }),
