...
import { EventManifest } from "@opennovel-ai/schema/event-manifest"
import { Location } from "@opennovel-ai/schema/location"
import type { Definition } from "@opennovel-ai/schema/event"
...
export const OpenNovelEvent = event.schema
export type OpenNovelEvent = typeof OpenNovelEvent.Type
export type OpenNovelEventEncoded = typeof OpenNovelEvent.Encoded
