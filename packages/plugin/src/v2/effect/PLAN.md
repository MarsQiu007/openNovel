...
- Effect plugins import `@opennovel-ai/plugin/v2/effect`, not `@opennovel-ai/core`.
- Public domain values use generated `@opennovel-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@opennovel-ai/plugin/v2/effect`.
