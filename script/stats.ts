...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/MarsQiu007/openNovel/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for MarsQiu007/openNovel...\n")
...
console.log("Fetching npm all-time downloads for opennovel-ai...\n")
const npmDownloads = await fetchNpmDownloads("opennovel-ai")
