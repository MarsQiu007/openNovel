      ...
      >
        ...
        <div>
          ...
          >
            ...
            <div style={{ color: c.white }}>opennovel.ai/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
