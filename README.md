...
# Terminal 1 — backend (port 4096)
cd packages/opennovel
bun run --conditions=browser ./src/index.ts serve --port 4096

# Terminal 2 — web UI (port 4444)
cd packages/app
bun dev -- --port 4444
```

Open <http://localhost:4444>, add the project folder, and create your first novel from the bookshelf.

The UI is available in English, 简体中文, and 繁體中文.
