...
- [ ] 6.1 按影响范围拆分 Conventional Commits，每个非 merge commit 绑定 `OpenSpec-Change: repair-ci-checks`，并通过 `git log --format=%B` 检查 footer。
- [ ] 6.2 在 OpenSpec 中记录实现提交，运行完成度审查并确认所有任务完成。
